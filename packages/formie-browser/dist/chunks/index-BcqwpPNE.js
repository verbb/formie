...
const bi = {
  ...
  "address-finder": () => import("./address-finder-BjMuEiwF.js").then((e) => e.addressFinderModule),
  "google-address": () => import("./google-address-Bmjp01pH.js").then((e) => e.googleAddressModule),
  loqate: () => import("./loqate-BdNGv93o.js").then((e) => e.loqateModule),
  "place-kit": () => import("./place-kit-CX7tamAg.js").then((e) => e.placeKitModule)
}, yi = {
  ...
  "captcha-eu": () => import("./captcha-eu-CterYFok.js").then((e) => e.captchaEuModule),
  "friendly-captcha-v1": () => import("./friendly-captcha-v1-EDFac33c.js").then((e) => e.friendlyCaptchaV1Module),
  "friendly-captcha-v2": () => import("./friendly-captcha-v2-BDpSvFGR.js").then((e) => e.friendlyCaptchaV2Module),
  hcaptcha: () => import("./hcaptcha-BTQ6An6g.js").then((e) => e.hcaptchaModule),
  "recaptcha-enterprise": () => import("./recaptcha-enterprise-DxF6cW95.js").then((e) => e.recaptchaEnterpriseModule),
  "recaptcha-v2-checkbox": () => import("./recaptcha-v2-checkbox-R9EfbZ4k.js").then((e) => e.recaptchaV2CheckboxModule),
  "recaptcha-v2-invisible": () => import("./recaptcha-v2-invisible-DV9hswAp.js").then((e) => e.recaptchaV2InvisibleModule),
  "recaptcha-v3": () => import("./recaptcha-v3-V0xc-Edh.js").then((e) => e.recaptchaV3Module),
  snaptcha: () => import("./snaptcha-DV7p6J9k.js").then((e) => e.snaptchaModule),
  turnstile: () => import("./turnstile-CId90tRr.js").then((e) => e.turnstileModule)
}, vi = {
  ...
  calculations: () => import("./calculations-DlGSkQ3W.js").then((e) => e.calculationsModule),
  "checkbox-radio": () => import("./checkbox-radio-CBvgk3hR.js").then((e) => e.checkboxRadioModule),
  conditions: () => import("./conditions-DYy1-Hwt.js").then((e) => e.conditionsModule),
  "date-picker": () => import("./date-picker-BlD--zfe.js").then((e) => e.datePickerModule),
  "file-upload": () => import("./file-upload-CIgHrXfp.js").then((e) => e.fileUploadModule),
  hidden: () => import("./hidden-DbPdOxKb.js").then((e) => e.hiddenModule),
  "phone-country": () => import("./phone-country-DPMiqk4L.js").then((e) => e.phoneCountryModule),
  repeater: () => import("./repeater-DKUT6TGI.js").then((e) => e.repeaterModule),
  "rich-text": () => import("./rich-text-SH7KiaKH.js").then((e) => e.richTextModule),
  signature: () => import("./signature-BA3tQsGT.js").then((e) => e.signatureModule),
  summary: () => import("./summary-Dq2i9TQk.js").then((e) => e.summaryModule),
  table: () => import("./table-Cu4WfVcw.js").then((e) => e.tableModule),
  "text-limit": () => import("./text-limit-2ycmB-Ae.js").then((e) => e.textLimitModule)
}, Ei = {
  ...
  bpoint: () => import("./bpoint-KudsBCo2.js").then((e) => e.bpointModule),
  eway: () => import("./eway-qwc-B5Us.js").then((e) => e.ewayModule),
  "go-cardless": () => import("./go-cardless-DuDMVsnz.js").then((e) => e.goCardlessModule),
  mollie: () => import("./mollie-DFOjTuGX.js").then((e) => e.mollieModule),
  moneris: () => import("./moneris-BbFfl-EL.js").then((e) => e.monerisModule),
  opayo: () => import("./opayo-CmgYa9ya.js").then((e) => e.opayoModule),
  paddle: () => import("./paddle-BUi7w1_o.js").then((e) => e.paddleModule),
  paypal: () => import("./paypal-A-ePfh6k.js").then((e) => e.paypalModule),
  payway: () => import("./payway-BqFCbhyo.js").then((e) => e.paywayModule),
  square: () => import("./square-Bs-ndqYK.js").then((e) => e.squareModule),
  stripe: () => import("./stripe-DkZAHxtn.js").then((e) => e.stripeModule)
}, Si = {
  ...vi,
  ...bi,
  ...yi,
