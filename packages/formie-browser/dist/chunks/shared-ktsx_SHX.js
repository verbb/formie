import { r as e } from "./event-names-BzJlD9YG.js";
...
function u(e, t) {
	...
	if (t) {
		let i = [
			e.querySelector(`template[data-formie-template-id="${r(t)}"]`),
			e.querySelector(`script[data-formie-template-id="${r(t)}"]`),
			n.querySelector(`template[data-formie-template-id="${r(t)}"]`),
			n.querySelector(`script[data-formie-template-id="${r(t)}"]`),
			n.getElementById(t)
		];
		for (let e of i) if (e instanceof HTMLTemplateElement || e instanceof HTMLScriptElement) return e;
	}
	return null;
}
function d(e) {
...
//#endregion
export { u as a, s as c, a as i, r as n, d as o, i as r, c as s, f as t };
