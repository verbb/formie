...
import { a as n, r } from "./event-names-BCI2FLD8.js";
import { t as i } from "./debug-BV0DvdHx.js";
import { t as a } from "./http-D-JExro7.js";
import { t as o } from "./styles-BfoIZwJp.js";
import { c as s, l as c, t as l } from "./shared-Bx9s0i0P.js";
//#region ../../node_modules/@uppy/utils/lib/NetworkError.js
...
function p(e, t = {}) {
	let { body: n = null, headers: r = {}, method: i = "GET", onBeforeRequest: a = f, onUploadProgress: o = f, shouldRetry: s = () => !0, onAfterResponse: c = f, onTimeout: l = f, responseType: p, retries: m = 3, signal: h = null, timeout: g = 3e4, withCredentials: _ = !1 } = t, v = (e) => .3 * 2 ** (e - 1) * 1e3, y = new d(g, l);
	function b(t = 0) {
		return new Promise(async (l, d) => {
			...
			f.open(i, e, !0), f.withCredentials = _, p && (f.responseType = p), f.onload = async () => {
				...
				f.status >= 200 && f.status < 300 ? (y.done(), l(f)) : s(f) && t < m ? setTimeout(() => {
					b(t + 1).then(l, d);
				}, v(t)) : (y.done(), d(new u(f.statusText, f)));
			}, f.onerror = () => g(new u(f.statusText, f)), f.upload.onprogress = (e) => {
				y.progress(), o(e);
...
var m = (e) => "error" in e && !!e.error, h = (e) => e.progress.uploadComplete;
function g(e) {
	return e.filter((e) => !m(e) && !h(e));
}
function _(e) {
...
function b(e) {
	...
	let t = e.name ? v(e.name).extension?.toLowerCase() : null;
	return t && t in y ? y[t] : "application/octet-stream";
}
//#endregion
...
function S(e) {
	let t = "";
	return e.replace(/[^A-Z0-9]/gi, (e) => (t += `-${x(e)}`, "/")) + t;
}
function C(e, t) {
	let n = t || "uppy";
	return typeof e.name == "string" && (n += `-${S(e.name.toLowerCase())}`), e.type !== void 0 && (n += `-${e.type}`), e.meta && typeof e.meta.relativePath == "string" && (n += `-${S(e.meta.relativePath.toLowerCase())}`), e.data?.size !== void 0 && (n += `-${e.data.size}`), e.data.lastModified !== void 0 && (n += `-${e.data.lastModified}`), n;
}
function w(e) {
...
function O() {
	...
	return `${D(e.getHours())}:${D(e.getMinutes())}:${D(e.getSeconds())}`;
}
//#endregion
...
function j(e, t) {
	...
	for (let e of Object.keys(t)) if (e !== "_") {
		let i = t[e];
		typeof i == "string" && (i = n[Symbol.replace](i, "$$$$")), r = ee(r, RegExp(`%\\{${e}\\}`, "g"), i);
	}
	return r;
}
var te = (e) => {
	...
	locale;
	constructor(e, { onMissingKey: t = te } = {}) {
		this.locale = {
			strings: {},
			pluralize(e) {
				return e === 1 ? 0 : 1;
	...
	debug: () => {},
	warn: () => {},
	error: (...e) => console.error(`[Uppy] [${O()}]`, ...e)
}, re = {
	debug: (...e) => console.debug(`[Uppy] [${O()}]`, ...e),
	warn: (...e) => console.warn(`[Uppy] [${O()}]`, ...e),
	error: (...e) => console.error(`[Uppy] [${O()}]`, ...e)
}, ie = /* @__PURE__ */ t(((e, t) => {
...
})), F = /* @__PURE__ */ e(ie(), 1), se = /* @__PURE__ */ e(oe(), 1), ce = {
	maxFileSize: null,
	minFileSize: null,
	...
	validateAggregateRestrictions(e, t) {
		...
		if (r && e.filter((e) => !e.isGhost).length + t.length > r) throw new I(`${this.getI18n()("youCanOnlyUploadX", { smart_count: r })}`);
		if (n) {
			let r = [...e, ...t].reduce((e, t) => e + (t.size ?? 0), 0);
			if (r > n) throw new I(this.getI18n()("aggregateExceedsSize", {
				sizeAllowed: (0, F.default)(n),
				size: (0, F.default)(r)
			}));
		}
	}
	validateSingleFile(e) {
		...
		if (r && !r.some((t) => t.includes("/") ? e.type ? (0, se.default)(e.type.replace(/;.*?$/, ""), t) : !1 : t[0] === "." && e.extension ? e.extension.toLowerCase() === t.slice(1).toLowerCase() : !1)) {
			let t = r.join(", ");
			throw new I(this.getI18n()("youCanOnlyUploadFileTypes", { types: t }), { file: e });
		}
		if (t && e.size != null && e.size > t) throw new I(this.getI18n()("exceedsSize", {
			size: (0, F.default)(t),
			file: e.name ?? this.getI18n()("unnamed")
		}), { file: e });
		if (n && e.size != null && e.size < n) throw new I(this.getI18n()("inferiorSize", { size: (0, F.default)(n) }), { file: e });
	}
	validate(e, t) {
		t.forEach((e) => {
	...
	validateMinNumberOfFiles(e) {
		...
		if (t && Object.keys(e).length < t) throw new I(this.getI18n()("youHaveToAtLeastSelectX", { smart_count: t }));
	}
	getMissingRequiredMetaFields(e) {
		let t = new I(this.getI18n()("missingRequiredMetaFieldOnFile", { fileName: e.name ?? this.getI18n()("unnamed") })), { requiredMetaFields: n } = this.getOpts().restrictions, r = [];
	...
	var n = _e(), r = Object.prototype, i = r.hasOwnProperty, a = r.toString, o = n ? n.toStringTag : void 0;
	function s(e) {
	...
	var n = _e(), r = ve(), i = ye(), a = "[object Null]", o = "[object Undefined]", s = n ? n.toStringTag : void 0;
	function c(e) {
	...
	var n = be(), r = xe(), i = "[object Symbol]";
	function a(e) {
		return typeof e == "symbol" || r(e) && n(e) == i;
	}
	t.exports = a;
})), Ce = /* @__PURE__ */ t(((e, t) => {
	var n = ge(), r = L(), i = Se(), a = NaN, o = /^[-+]0x[0-9a-f]+$/i, s = /^0b[01]+$/i, c = /^0o[0-7]+$/i, l = parseInt;
	function u(e) {
	...
	var n = L(), r = me(), i = Ce(), a = "Expected a function", o = Math.max, s = Math.min;
	function c(e, t, c) {
	...
	var n = we(), r = L(), i = "Expected a function";
	function a(e, t, a) {
		var o = !0, s = !0;
...
})), De = "useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict", Oe = (e = 21) => {
	let t = "", n = e | 0;
	for (; n--;) t += De[Math.random() * 64 | 0];
	return t;
}, ke = {
	name: "@uppy/core",
...
var Ne = /* @__PURE__ */ e(Te(), 1), Pe = /* @__PURE__ */ e(Ee(), 1), R = {
	totalProgress: 0,
	allowNewUpload: !0,
	error: null,
	recoveredState: null
	...
	constructor(t) {
		...
		this.opts = {
		...
		}, t?.logger && t.debug ? this.log("You are using a custom `logger`, but also set `debug: true`, which uses built-in logger to output logs to console. Ignoring `debug: true` and using your custom `logger`.", "warning") : t?.debug && (this.opts.logger = re), this.log(`Using Core v${e.VERSION}`), this.i18nInit(), this.store = this.opts.store, this.setState({
			...R,
			plugins: {},
			files: {},
			currentUploads: {},
			...
			meta: { ...this.opts.meta },
			info: []
		}), this.#t = new le(() => this.opts, () => this.i18n), this.#n = this.store.subscribe((e, t, n) => {
	...
	i18nInit() {
		let e = new M([this.defaultLocale, this.opts.locale], { onMissingKey: (e) => this.log(`Missing i18n string: ${e}`, "error") });
	...
	#u(e) {
		...
		if (t === !1) {
			let t = new I(this.i18n("noMoreFilesAllowed"), { file: e });
			throw this.#s([t]), t;
		}
	}
	...
	#d(e) {
		let t = e instanceof File ? {
			...
			source: void 0,
			preview: void 0
		} : e, n = b(t), r = Ae(n, t), i = v(r).extension, a = T(t, this.getID()), o = {
			...t.meta,
			name: r,
			type: n
	...
	#p(e) {
		...
		for (let a of e) try {
			...
			if (t = this.getState().files, n = {
				...t,
				...n
			}, !s && this.checkIfFileAlreadyExists(e.id)) throw new I(this.i18n("noDuplicates", { fileName: e.name ?? this.i18n("unnamed") }), { file: e });
			if (s === !1 && !o) throw new I("Cannot add the file because onBeforeFileAdded returned false.", {
				isUserFacing: !1,
				file: e
			});
	...
	cancelAll() {
		...
		t.length && this.removeFiles(t), this.setState(R);
	}
	retryUpload(e) {
		this.setFileState(e, {
			error: null,
	...
	async upload() {
		...
		try {
			if (this.#t.validateMinNumberOfFiles(e), !this.#l(e)) throw new I(this.i18n("missingRequiredMetaField"));
...
}, Le = { strings: { uploadStalled: "Upload has not made any progress for %{seconds} seconds. You may want to retry it." } };
//#endregion
//#region ../../node_modules/@uppy/xhr-upload/lib/index.js
function Re(e, t) {
	let n = t;
	return n ||= /* @__PURE__ */ Error("Upload error"), typeof n == "string" && (n = Error(n)), n instanceof Error || (n = Object.assign(/* @__PURE__ */ Error("Upload error"), { data: n })), k(e) ? (n = new u(n, e), n) : (n.request = e, n);
}
function ze(e) {
...
var Be = {
	...
	constructor(e, t) {
		if (super(e, {
			...
			...t
		}), this.type = "uploader", this.id = this.opts.id || "XHRUpload", this.defaultLocale = Le, this.i18nInit(), this.#t = new A({ concurrency: this.opts.limit }), this.opts.bundle && !this.opts.formData) throw Error("`opts.formData` must be true when `opts.bundle` is enabled.");
		...
		this.uploaderEvents = Object.create(null), this.#e = (e) => async (t, n) => {
			try {
				...
				let n = t.request;
				for (let r of e) this.uppy.emit("upload-error", this.uppy.getFile(r.id), Re(n, t), n);
				throw t;
			}
		};
	}
	...
	addMetadata(e, t, n) {
		E(n.allowedMetaFields, t).forEach((n) => {
			let r = t[n];
	...
	createBundledUpload(e, t) {
		...
		return this.addMetadata(n, r, t), e.forEach((e) => {
			let t = this.getOptions(e), r = ze(e);
			e.name ? n.append(t.fieldName, r, e.name) : n.append(t.fieldName, r);
		}), n;
	}
	async #n(e) {
		let t = new P(this.uppy), n = new AbortController();
	...
	#i(e) {
		let t = this.getOptions(e), n = E(t.allowedMetaFields, e.meta);
		return {
			...e.remote?.body,
			protocol: "multipart",
			endpoint: t.endpoint,
	...
	#o = async (e) => {
		...
		let t = g(this.uppy.getFilesByIds(e)), n = _(t);
...
function at(e, t) {
	let n = q(e).find((e) => e.hasAttribute(H) || e.name === t.replace("[]", "") && e.value === "");
...
function ot(e, t) {
	return q(e).filter((e) => e.name === t && e.value.trim() !== "");
}
function J(e, t) {
	return ot(e, t).map((e) => G(e.value)).filter((e) => e !== null);
}
function st(e, t, n, r) {
	let i = t;
	ot(e, n).forEach((e) => {
		...
		t.type = "hidden", t.name = n, t.value = String(e), t.setAttribute(Ye, "true"), i.insertAdjacentElement("afterend", t), i = t;
	});
}
function ct(e, t, n) {
	...
	let a = e.querySelector("input[name=\"CRAFT_CSRF_TOKEN\"]");
	return a instanceof HTMLInputElement && a.value.trim() && (i.CRAFT_CSRF_TOKEN = a.value.trim()), i;
}
function lt(e, t, n) {
	let r = new FormData(), i = it(e), a = K(t);
	i && r.append("handle", i), a && r.append("fieldHandle", a);
	let o = e?.querySelector("input[name=\"submissionUid\"]");
	return o instanceof HTMLInputElement && o.value.trim() && r.append("submissionUid", o.value.trim()), n.forEach((e) => {
		r.append("assetIds[]", String(e));
	}), r;
}
function ut(e) {
	if (!e) return null;
...
function X(e) {
	...
	let n = t.querySelector("[data-formie-upload-manager-progress-track]"), r = t.querySelector("[data-formie-upload-manager-progress-bar]"), i = t.querySelector("[data-formie-upload-manager-progress-label]");
	return {
		track: n instanceof HTMLElement ? n : null,
...
function dt(e, t, n) {
	let { track: r, bar: i, label: a } = X(e), o = Math.max(0, Math.min(nt, Math.round(t)));
	e.classList.add("is-uploading"), e.classList.remove("is-upload-complete", "is-complete", "is-processing", "is-preparing"), r && r.setAttribute("data-indeterminate", "false"), i && (i.style.width = `${o}%`, i.setAttribute("data-progress", String(o))), a && (n ? a.textContent = n : o > 0 ? a.textContent = `Uploading… ${o}%` : a.textContent = "Uploading…");
}
function ft(e, t, n = {}) {
	...
	let a = Math.min(nt, Math.max(1, Math.round(t)));
	dt(e, a, `Uploading… ${a}%`);
}
function pt(e, t) {
	if (e instanceof XMLHttpRequest && e.responseText) try {
		let t = JSON.parse(e.responseText);
		if (t.message) return t.message;
		if (t.errors) {
			let e = Object.values(t.errors).flat().find(Boolean);
			if (e) return e;
		}
	} catch {}
	return t instanceof Error && t.message ? t.message : "Upload failed.";
}
function mt(e) {
	return e.status === 0 ? !0 : e.status >= 500;
}
function ht(e) {
...
function gt(e) {
	...
	return n.type = "button", n.className = "formie-upload-manager-sort-button", n.setAttribute("data-formie-upload-manager-sort", e), n.setAttribute("data-formie-icon", e === "up" ? "arrow-up" : "arrow-down"), n.setAttribute("aria-label", t), n.setAttribute("title", t), n.textContent = t, n;
}
function _t(e, t) {
	let n = document.createElement("li");
	n.className = "formie-upload-manager-item", n.setAttribute("data-formie-upload-manager-item", "true");
	let r = document.createElement("span");
	r.className = "formie-upload-manager-filename", r.setAttribute("data-formie-upload-manager-filename", "true"), r.textContent = t;
	let i = document.createElement("div");
	i.className = "formie-upload-manager-progress", i.setAttribute("data-formie-upload-manager-progress", "true"), i.setAttribute("aria-live", "polite");
	let a = document.createElement("div");
	a.className = "formie-upload-manager-progress-track", a.setAttribute("data-formie-upload-manager-progress-track", "true"), a.setAttribute("data-indeterminate", "true");
	...
	s.className = "formie-upload-manager-progress-label", s.setAttribute("data-formie-upload-manager-progress-label", "true"), s.textContent = "Preparing…", a.append(o), i.append(a, s);
	let c = document.createElement("div");
	c.className = "formie-upload-manager-sort-controls", c.setAttribute("data-formie-upload-manager-sort-controls", "true"), c.hidden = !0;
	let l = gt("up"), u = gt("down");
	c.append(l, u);
	let d = document.createElement("div");
	d.className = "formie-upload-manager-actions", d.setAttribute("data-formie-upload-manager-actions", "true");
...
function Q(e) {
	let t = q(e).find((e) => e.hasAttribute(Ye));
	if (t?.name) return t.name;
	let n = K(e);
	return n ? `fields[${n}][]` : "fields[fileUpload][]";
}
function vt(e) {
	return e.files.filter((e) => e.assetId !== null).length;
}
function $(e) {
	let t = e.files.map((e) => e.assetId).filter((e) => e !== null);
	st(e.field, e.anchorInput, e.assetInputName, t), e.statusInput && (e.statusInput.value = t.length ? "uploaded" : ""), l(e.field, "file-upload", "uploaded-assets-sync", { assets: t.map((t) => ({
		assetId: t,
		filename: e.files.find((e) => e.assetId === t)?.filename || ""
	})) });
}
function yt(e) {
	c(e, $e, (e) => {
		e.addValidator("uploadManagerRequired", ({ input: e }) => {
			...
			return !(t instanceof HTMLElement) || e.getAttribute("data-formie-validation-required") !== "true" ? !0 : J(t, Q(t)).length > 0;
...
function St(e, t, n) {
	...
	let i = r.querySelector(B);
	if (!(i instanceof HTMLElement)) return () => {};
	let o = r.querySelector(We), s = r.querySelector(Ue), c = r.querySelector(Ge), u = r.querySelector(V);
	if (!(o instanceof HTMLInputElement) || !(c instanceof HTMLElement)) return () => {};
	let d = xt(t, e), f = u instanceof HTMLInputElement ? u : null, p = Q(e), m = at(e, p), h = Y(i, n.uploadEndpoint, "data-formie-file-upload-upload-endpoint", "/actions/formie/file-upload/upload"), g = Y(i, n.deleteEndpoint, "data-formie-file-upload-delete-endpoint", "/actions/formie/file-upload/delete"), _ = Y(i, n.hydrateEndpoint, "data-formie-file-upload-hydrate-endpoint", "/actions/formie/file-upload/hydrate"), v = n.limitFiles ?? G(i.getAttribute("data-formie-file-limit")), y = n.sizeLimit ?? parseFloat(i.getAttribute("data-formie-size-max-limit") || ""), b = n.sizeMinLimit ?? parseFloat(i.getAttribute("data-formie-size-min-limit") || ""), x = ut(n.accept ?? i.getAttribute("accept") ?? o.accept), S = {};
	v && (S.maxNumberOfFiles = v), y && (S.maxFileSize = y * 1e3 * 1e3), b && (S.minFileSize = b * 1e3 * 1e3), x && (S.allowedFileTypes = x);
	let C = new Fe({
		autoProceed: !0,
		restrictions: S
	});
	C.use(Ve, {
		...
		onBeforeRequest(e, t, n) {
			let r = n[0];
			!r?.id || !r.size || e.upload.addEventListener("progress", (e) => {
				let t = M(r.id);
				if (!t) return;
				let n = 0;
				e.lengthComputable && e.total > 0 ? n = Math.round(e.loaded / e.total * 100) : e.loaded > 0 && r.size && (n = Math.min(100, Math.round(e.loaded / r.size * 100))), ft(t.listItem, n, {
					loaded: e.loaded,
					total: e.lengthComputable ? e.total : r.size ?? void 0
				});
			});
		}
	});
	let w = {
		...
		uppy: C,
		files: []
	}, T = () => v ? Math.max(0, v - vt(w)) : null, E = (e) => {
		i.classList.toggle("formie-upload-manager-dropzone-active", e);
	}, D = (e) => e.assetId !== null && !e.listItem.classList.contains("is-error"), O = () => {
		let e = w.files.length >= 2;
		w.files.forEach((t, n) => {
			let r = t.listItem.querySelector(Ke), i = t.listItem.querySelector(qe), a = t.listItem.querySelector(Je);
			if (!(r instanceof HTMLElement)) return;
			let o = e && D(t);
			r.hidden = !o, i instanceof HTMLButtonElement && (i.disabled = !o || n === 0), a instanceof HTMLButtonElement && (a.disabled = !o || n >= w.files.length - 1);
		});
	}, k = (e, t) => {
		let n = w.files.indexOf(e), r = n + t;
		if (n < 0 || r < 0 || r >= w.files.length) return;
		let i = w.files[r];
		w.files[n] = i, w.files[r] = e, t === -1 ? e.listItem.before(i.listItem) : e.listItem.after(i.listItem), $(w), O(), l(w.field, "file-upload", "uploaded-assets-reordered", { assets: w.files.filter((e) => e.assetId !== null).map((e) => ({
			assetId: e.assetId,
			filename: e.filename
		})) });
	}, A = (e, t, n, r) => {
		...
		if (t.uppyFileId && C.removeFile(t.uppyFileId), t.assetId) {
			let n = new FormData(), r = ct(d, e, i);
			Object.entries(r).forEach(([e, t]) => {
				n.append(e, t);
			}), n.append("assetId", String(t.assetId));
			try {
				await a(g, {
					method: "POST",
					body: n
		...
		t.listItem.remove(), w.files = w.files.filter((e) => e !== t), $(w), O();
	}, j = (t, n) => {
		let { listItem: r, removeButton: i, sortUpButton: a, sortDownButton: o } = _t(e, n);
		r.classList.add("is-complete"), c.append(r);
		let s = {
			assetId: t,
			filename: n,
			uppyFileId: null,
		...
		if (t.length) try {
			let n = (await a(_, {
				method: "POST",
				body: lt(d, e, t)
			})).assets || [], r = new Map(n.map((e) => [G(e.assetId), e]).filter(([e]) => e !== null));
			t.forEach((e) => {
				if (w.files.some((t) => t.assetId === e)) return;
				let t = r.get(e);
				t && j(e, t.filename || `Asset #${e}`);
			}), $(w), O();
		} catch (e) {
			U.warn("Failed to hydrate uploaded assets.", { error: e });
		}
	}, M = (e) => e && w.files.find((t) => t.uppyFileId === e) || null;
	C.on("upload-progress", (e, t) => {
		let n = M(e?.id);
		if (!n) return;
		let r = t.bytesTotal || 0, i = t.bytesUploaded || 0, a = r > 0 ? Math.round(i / r * 100) : 0;
		ft(n.listItem, a, {
			loaded: i,
			total: r
		});
	...
	}), C.on("upload-success", (e, t) => {
		let n = M(e?.id);
		if (!n) return;
		let r = n.listItem.querySelector("[data-formie-upload-manager-error]"), i = W(t?.body) ? t.body : {}, a = G(i.assetId);
		if (!i.success || !a) {
			if (n.listItem.classList.add("is-error"), n.listItem.classList.remove("is-uploading", "is-upload-complete", "is-processing", "is-preparing"), r instanceof HTMLElement) {
				r.hidden = !1, r.textContent = pt(null, { message: "Upload failed." });
				let e = i.errors ? Object.values(i.errors).flat().find(Boolean) : null;
				e && (r.textContent = e);
			}
			return;
		}
		n.assetId = a, n.filename = i.filename || n.filename, ht(n.listItem), $(w), O();
	}), C.on("upload-error", (e, t, n) => {
		let r = M(e?.id);
		if (!r) return;
		let i = r.listItem.querySelector("[data-formie-upload-manager-error]");
		r.listItem.classList.add("is-error"), r.listItem.classList.remove("is-uploading", "is-upload-complete", "is-processing", "is-preparing"), i instanceof HTMLElement && (i.hidden = !1, i.textContent = pt(n, t));
	}), C.on("file-added", (t) => {
		let n = T();
		if (n !== null && n <= 0) {
			C.removeFile(t.id), C.info("File limit reached.", "error", 3e3);
			return;
		}
		C.setFileMeta(t.id, ct(d, e, i));
		let { listItem: r, removeButton: a, sortUpButton: o, sortDownButton: s } = _t(e, t.name || "Upload");
		c.append(r);
		let l = {
			assetId: null,
	...
	s?.addEventListener("click", (e) => {
		...
		e.target instanceof Element && e.target.closest(Ue) || N();
	}), i.addEventListener("keydown", (e) => {
		(e.key === "Enter" || e.key === " ") && (e.preventDefault(), N());
	}), o.addEventListener("change", () => {
		if (!o.files?.length) return;
		let e = Array.from(o.files);
		o.value = "";
		try {
			C.addFiles(e.map((e) => ({
				name: e.name,
			...
			e instanceof Error && C.info(e.message, "error", 3e3);
		}
	...
	let P = () => {
		w.files.forEach((e) => {
			e.listItem.remove();
		}), w.files = [], C.cancelAll(), st(e, m, p, []);
	};
	return d?.addEventListener(Xe, P), te(), () => {
		d?.removeEventListener(Xe, P), C.destroy(), w.files = [];
	};
}
var Ct = {
	id: Qe,
	...
	setup: async (e) => {
		...
		let a = (e) => {
			...
			e instanceof HTMLElement && e.hasAttribute("data-formie-field-handle") && a.add(e), e instanceof Element && (e.querySelectorAll("[data-formie-field-handle]").forEach((e) => {
				e instanceof HTMLElement && a.add(e);
			}), e.querySelectorAll(z).forEach((e) => {
				let t = e.closest("[data-formie-field-handle]");
				t instanceof HTMLElement && a.add(t);
			})), a.forEach((e) => {
				r.has(e) || !e.querySelector(z) || (r.add(e), i.push(St(e, n, t)));
			});
		};
		a(e.target);
		let o = (e) => {
		...
		return n?.addEventListener(Ze, o), U.log("Module setup.", { count: i.length }), await e.emit("formie:module:upload-manager:init", { count: i.length }), { destroy: () => {
			n?.removeEventListener(Ze, o), i.forEach((e) => {
				e();
			}), bt(n), U.log("Module destroy."), e.emit("formie:module:upload-manager:destroy", {});
		} };
	}
};
//#endregion
export { Ct as uploadManagerModule };
