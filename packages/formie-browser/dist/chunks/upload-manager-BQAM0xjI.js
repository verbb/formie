...
import { n as a, r as o, t as s } from "./csrf-DxHg_ZYt.js";
import { t as c } from "./http-D-JExro7.js";
import { t as l } from "./styles-BfoIZwJp.js";
import { c as u, l as d, t as f } from "./shared-Bx9s0i0P.js";
...
function g(e, t = {}) {
	let { body: n = null, headers: r = {}, method: i = "GET", onBeforeRequest: a = h, onUploadProgress: o = h, shouldRetry: s = () => !0, onAfterResponse: c = h, onTimeout: l = h, responseType: u, retries: d = 3, signal: f = null, timeout: g = 3e4, withCredentials: _ = !1 } = t, v = (e) => .3 * 2 ** (e - 1) * 1e3, y = new m(g, l);
	function b(t = 0) {
		return new Promise(async (l, m) => {
			let h = new XMLHttpRequest(), g = (e) => {
				s(h) && t < d ? setTimeout(() => {
					b(t + 1).then(l, m);
				}, v(t)) : (y.done(), m(e));
			};
			h.open(i, e, !0), h.withCredentials = _, u && (h.responseType = u), h.onload = async () => {
				try {
					await c(h, t);
				} catch (e) {
					e.request = h, g(e);
				...
				h.status >= 200 && h.status < 300 ? (y.done(), l(h)) : s(h) && t < d ? setTimeout(() => {
					b(t + 1).then(l, m);
				}, v(t)) : (y.done(), m(new p(h.statusText, h)));
			}, h.onerror = () => g(new p(h.statusText, h)), h.upload.onprogress = (e) => {
				y.progress(), o(e);
			}, r && Object.keys(r).forEach((e) => {
				h.setRequestHeader(e, r[e]);
			});
			function x() {
				h.abort(), m(new DOMException("Aborted", "AbortError"));
			}
			if (f?.addEventListener("abort", x), f?.aborted) {
				x();
				return;
			}
			await a(h, t), h.send(n);
		});
	}
	return b();
}
...
var _ = (e) => "error" in e && !!e.error, v = (e) => e.progress.uploadComplete;
function y(e) {
	return e.filter((e) => !_(e) && !v(e));
}
function b(e) {
...
function C(e) {
	...
	let t = e.name ? x(e.name).extension?.toLowerCase() : null;
...
function T(e) {
	let t = "";
	return e.replace(/[^A-Z0-9]/gi, (e) => (t += `-${w(e)}`, "/")) + t;
}
function E(e, t) {
	let n = t || "uppy";
	return typeof e.name == "string" && (n += `-${T(e.name.toLowerCase())}`), e.type !== void 0 && (n += `-${e.type}`), e.meta && typeof e.meta.relativePath == "string" && (n += `-${T(e.meta.relativePath.toLowerCase())}`), e.data?.size !== void 0 && (n += `-${e.data.size}`), e.data.lastModified !== void 0 && (n += `-${e.data.lastModified}`), n;
}
function D(e) {
...
function j() {
	...
	return `${A(e.getHours())}:${A(e.getMinutes())}:${A(e.getSeconds())}`;
}
//#endregion
...
function N(e, t) {
	...
	for (let e of Object.keys(t)) if (e !== "_") {
		let i = t[e];
		typeof i == "string" && (i = n[Symbol.replace](i, "$$$$")), r = te(r, RegExp(`%\\{${e}\\}`, "g"), i);
	}
	return r;
}
var P = (e) => {
	...
	locale;
	constructor(e, { onMissingKey: t = P } = {}) {
		this.locale = {
			strings: {},
			pluralize(e) {
				return e === 1 ? 0 : 1;
	...
	debug: () => {},
	warn: () => {},
	error: (...e) => console.error(`[Uppy] [${j()}]`, ...e)
}, ie = {
	debug: (...e) => console.debug(`[Uppy] [${j()}]`, ...e),
	warn: (...e) => console.warn(`[Uppy] [${j()}]`, ...e),
	error: (...e) => console.error(`[Uppy] [${j()}]`, ...e)
}, ae = /* @__PURE__ */ t(((e, t) => {
...
})), L = /* @__PURE__ */ e(ae(), 1), ce = /* @__PURE__ */ e(se(), 1), le = {
	maxFileSize: null,
	minFileSize: null,
	...
	validateAggregateRestrictions(e, t) {
		...
		if (r && e.filter((e) => !e.isGhost).length + t.length > r) throw new R(`${this.getI18n()("youCanOnlyUploadX", { smart_count: r })}`);
		if (n) {
			let r = [...e, ...t].reduce((e, t) => e + (t.size ?? 0), 0);
			if (r > n) throw new R(this.getI18n()("aggregateExceedsSize", {
				sizeAllowed: (0, L.default)(n),
				size: (0, L.default)(r)
			}));
		}
	}
	validateSingleFile(e) {
		...
		if (r && !r.some((t) => t.includes("/") ? e.type ? (0, ce.default)(e.type.replace(/;.*?$/, ""), t) : !1 : t[0] === "." && e.extension ? e.extension.toLowerCase() === t.slice(1).toLowerCase() : !1)) {
			let t = r.join(", ");
			throw new R(this.getI18n()("youCanOnlyUploadFileTypes", { types: t }), { file: e });
		}
		if (t && e.size != null && e.size > t) throw new R(this.getI18n()("exceedsSize", {
			size: (0, L.default)(t),
			file: e.name ?? this.getI18n()("unnamed")
		}), { file: e });
		if (n && e.size != null && e.size < n) throw new R(this.getI18n()("inferiorSize", { size: (0, L.default)(n) }), { file: e });
	}
	validate(e, t) {
		t.forEach((e) => {
	...
	validateMinNumberOfFiles(e) {
		...
		if (t && Object.keys(e).length < t) throw new R(this.getI18n()("youHaveToAtLeastSelectX", { smart_count: t }));
	}
	getMissingRequiredMetaFields(e) {
		let t = new R(this.getI18n()("missingRequiredMetaFieldOnFile", { fileName: e.name ?? this.getI18n()("unnamed") })), { requiredMetaFields: n } = this.getOpts().restrictions, r = [];
	...
	var n = pe(), r = typeof self == "object" && self && self.Object === Object && self;
	...
	var n = ve(), r = Object.prototype, i = r.hasOwnProperty, a = r.toString, o = n ? n.toStringTag : void 0;
	function s(e) {
	...
	var n = ve(), r = ye(), i = be(), a = "[object Null]", o = "[object Undefined]", s = n ? n.toStringTag : void 0;
	function c(e) {
	...
	var n = xe(), r = Se(), i = "[object Symbol]";
	function a(e) {
		return typeof e == "symbol" || r(e) && n(e) == i;
	}
	t.exports = a;
})), we = /* @__PURE__ */ t(((e, t) => {
	var n = _e(), r = z(), i = Ce(), a = NaN, o = /^[-+]0x[0-9a-f]+$/i, s = /^0b[01]+$/i, c = /^0o[0-7]+$/i, l = parseInt;
	function u(e) {
	...
	var n = z(), r = he(), i = we(), a = "Expected a function", o = Math.max, s = Math.min;
	function c(e, t, c) {
	...
	var n = Te(), r = z(), i = "Expected a function";
	function a(e, t, a) {
		var o = !0, s = !0;
...
})), Oe = "useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict", ke = (e = 21) => {
	let t = "", n = e | 0;
	for (; n--;) t += Oe[Math.random() * 64 | 0];
	return t;
}, Ae = {
	name: "@uppy/core",
...
var Pe = /* @__PURE__ */ e(Ee(), 1), Fe = /* @__PURE__ */ e(De(), 1), B = {
	totalProgress: 0,
	allowNewUpload: !0,
	error: null,
	recoveredState: null
}, Ie = class e {
	static VERSION = Ae.version;
	...
	constructor(t) {
		...
		this.opts = {
		...
		}, t?.logger && t.debug ? this.log("You are using a custom `logger`, but also set `debug: true`, which uses built-in logger to output logs to console. Ignoring `debug: true` and using your custom `logger`.", "warning") : t?.debug && (this.opts.logger = ie), this.log(`Using Core v${e.VERSION}`), this.i18nInit(), this.store = this.opts.store, this.setState({
			...B,
			plugins: {},
			files: {},
			currentUploads: {},
			...
			meta: { ...this.opts.meta },
			info: []
		}), this.#t = new ue(() => this.opts, () => this.i18n), this.#n = this.store.subscribe((e, t, n) => {
	...
	i18nInit() {
		let e = new F([this.defaultLocale, this.opts.locale], { onMissingKey: (e) => this.log(`Missing i18n string: ${e}`, "error") });
	...
	#u(e) {
		...
		if (t === !1) {
			let t = new R(this.i18n("noMoreFilesAllowed"), { file: e });
			throw this.#s([t]), t;
		}
	}
	...
	#d(e) {
		let t = e instanceof File ? {
			...
			source: void 0,
			preview: void 0
		} : e, n = C(t), r = je(n, t), i = x(r).extension, a = O(t, this.getID()), o = {
			...t.meta,
			name: r,
			type: n
	...
	#p(e) {
		...
		for (let a of e) try {
			...
			if (t = this.getState().files, n = {
				...t,
				...n
			}, !s && this.checkIfFileAlreadyExists(e.id)) throw new R(this.i18n("noDuplicates", { fileName: e.name ?? this.i18n("unnamed") }), { file: e });
			if (s === !1 && !o) throw new R("Cannot add the file because onBeforeFileAdded returned false.", {
				isUserFacing: !1,
				file: e
			});
	...
	cancelAll() {
		...
		t.length && this.removeFiles(t), this.setState(B);
	}
	retryUpload(e) {
		this.setFileState(e, {
			error: null,
	...
	async upload() {
		...
		try {
			if (this.#t.validateMinNumberOfFiles(e), !this.#l(e)) throw new R(this.i18n("missingRequiredMetaField"));
...
}, Re = { strings: { uploadStalled: "Upload has not made any progress for %{seconds} seconds. You may want to retry it." } };
//#endregion
//#region ../../node_modules/@uppy/xhr-upload/lib/index.js
function ze(e, t) {
	let n = t;
	return n ||= /* @__PURE__ */ Error("Upload error"), typeof n == "string" && (n = Error(n)), n instanceof Error || (n = Object.assign(/* @__PURE__ */ Error("Upload error"), { data: n })), M(e) ? (n = new p(n, e), n) : (n.request = e, n);
}
function Be(e) {
...
var Ve = {
	...
	constructor(e, t) {
		if (super(e, {
			...
			...t
		}), this.type = "uploader", this.id = this.opts.id || "XHRUpload", this.defaultLocale = Re, this.i18nInit(), this.#t = new ee({ concurrency: this.opts.limit }), this.opts.bundle && !this.opts.formData) throw Error("`opts.formData` must be true when `opts.bundle` is enabled.");
		...
		this.uploaderEvents = Object.create(null), this.#e = (e) => async (t, n) => {
			try {
				...
				let n = t.request;
				for (let r of e) this.uppy.emit("upload-error", this.uppy.getFile(r.id), ze(n, t), n);
				throw t;
			}
		};
	}
	...
	addMetadata(e, t, n) {
		k(n.allowedMetaFields, t).forEach((n) => {
			let r = t[n];
	...
	createBundledUpload(e, t) {
		...
		return this.addMetadata(n, r, t), e.forEach((e) => {
			let t = this.getOptions(e), r = Be(e);
			e.name ? n.append(t.fieldName, r, e.name) : n.append(t.fieldName, r);
		}), n;
	}
	async #n(e) {
		let t = new ne(this.uppy), n = new AbortController();
	...
	#i(e) {
		let t = this.getOptions(e), n = k(t.allowedMetaFields, e.meta);
		return {
			...e.remote?.body,
			protocol: "multipart",
			endpoint: t.endpoint,
	...
	#o = async (e) => {
		...
		let t = y(this.uppy.getFilesByIds(e)), n = b(t);
...
function st(e, t) {
	let n = J(e).find((e) => e.hasAttribute(W) || e.name === t.replace("[]", "") && e.value === "");
	if (n) return n.setAttribute(W, "true"), n;
	let r = document.createElement("input");
	return r.type = "hidden", r.name = t.replace("[]", ""), r.value = "", r.setAttribute(W, "true"), e.prepend(r), r;
}
function ct(e, t) {
	return J(e).filter((e) => e.name === t && e.value.trim() !== "");
}
function Y(e, t) {
	return ct(e, t).map((e) => K(e.value)).filter((e) => e !== null);
}
function lt(e, t, n, r) {
	let i = t;
	ct(e, n).forEach((e) => {
		...
		t.type = "hidden", t.name = n, t.value = String(e), t.setAttribute(Xe, "true"), i.insertAdjacentElement("afterend", t), i = t;
	});
}
function ut(e, t, n) {
...
function dt(e, t, n) {
	let r = new FormData(), i = ot(e), a = q(t);
...
function pt(e, t, n) {
	let { track: r, bar: i, label: a } = Z(e), o = Math.max(0, Math.min(rt, Math.round(t)));
...
function mt(e, t, n = {}) {
	...
	let a = Math.min(rt, Math.max(1, Math.round(t)));
	pt(e, a, `Uploading… ${a}%`);
}
function ht(e, t) {
...
function bt(e) {
	let t = J(e).find((e) => e.hasAttribute(Xe));
...
function $(e) {
	...
	lt(e.field, e.anchorInput, e.assetInputName, t), e.statusInput && (e.statusInput.value = t.length ? "uploaded" : ""), f(e.field, "file-upload", "uploaded-assets-sync", { assets: t.map((t) => ({
		assetId: t,
...
function St(e) {
	d(e, et, (e) => {
		e.addValidator("uploadManagerRequired", ({ input: e }) => {
			if (!e.matches(U)) return !0;
			let t = e.closest("[data-formie-field-handle]");
			return !(t instanceof HTMLElement) || e.getAttribute("data-formie-validation-required") !== "true" || Y(t, bt(t)).length > 0;
			...
			let n = t.querySelector(H);
			if (!(n instanceof HTMLElement)) return !0;
			let r = parseInt(n.getAttribute("data-formie-file-limit") || "", 10);
			return !r || Y(t, bt(t)).length <= r;
		}, ({ input: e, t }) => {
			let n = e.closest("[data-formie-field-handle]")?.querySelector(H);
...
function Tt(e, t, n) {
	let r = e.querySelector(V);
	if (!(r instanceof HTMLElement)) return () => {};
	let i = r.querySelector(H);
	if (!(i instanceof HTMLElement)) return () => {};
	let a = r.querySelector(Ge), s = r.querySelector(We), l = r.querySelector(Ke), u = r.querySelector(U);
	if (!(a instanceof HTMLInputElement) || !(l instanceof HTMLElement)) return () => {};
	let d = wt(t, e), p = u instanceof HTMLInputElement ? u : null, m = bt(e), h = st(e, m), g = X(i, n.uploadEndpoint, "data-formie-file-upload-upload-endpoint", "/actions/formie/file-upload/upload"), _ = X(i, n.deleteEndpoint, "data-formie-file-upload-delete-endpoint", "/actions/formie/file-upload/delete"), v = X(i, n.hydrateEndpoint, "data-formie-file-upload-hydrate-endpoint", "/actions/formie/file-upload/hydrate"), y = n.limitFiles ?? K(i.getAttribute("data-formie-file-limit")), b = n.sizeLimit ?? parseFloat(i.getAttribute("data-formie-size-max-limit") || ""), x = n.sizeMinLimit ?? parseFloat(i.getAttribute("data-formie-size-min-limit") || ""), S = ft(n.accept ?? i.getAttribute("accept") ?? a.accept), C = {};
	y && (C.maxNumberOfFiles = y), b && (C.maxFileSize = b * 1e3 * 1e3), x && (C.minFileSize = x * 1e3 * 1e3), S && (C.allowedFileTypes = S);
	let w = new Ie({
		autoProceed: !0,
		restrictions: C
	}), T = o(d);
	w.use(He, {
		...
		onBeforeRequest(e, t, n) {
			let r = o(d);
			r && e.setRequestHeader("X-CSRF-Token", r.value);
			let i = n[0];
			!i?.id || !i.size || e.upload.addEventListener("progress", (e) => {
				let t = P(i.id);
				if (!t) return;
				let n = 0;
				e.lengthComputable && e.total > 0 ? n = Math.round(e.loaded / e.total * 100) : e.loaded > 0 && i.size && (n = Math.min(100, Math.round(e.loaded / i.size * 100))), mt(t.listItem, n, {
					loaded: e.loaded,
					total: e.lengthComputable ? e.total : i.size ?? void 0
				});
			});
		}
	});
	let E = {
		...
		uppy: w,
		files: []
	}, D = () => y ? Math.max(0, y - xt(E)) : null, O = (e) => {
		i.classList.toggle("formie-upload-manager-dropzone-active", e);
	}, k = (e) => e.assetId !== null && !e.listItem.classList.contains("is-error"), A = () => {
		let e = E.files.length >= 2;
		E.files.forEach((t, n) => {
			let r = t.listItem.querySelector(qe), i = t.listItem.querySelector(Je), a = t.listItem.querySelector(Ye);
			if (!(r instanceof HTMLElement)) return;
			let o = e && k(t);
			r.hidden = !o, i instanceof HTMLButtonElement && (i.disabled = !o || n === 0), a instanceof HTMLButtonElement && (a.disabled = !o || n >= E.files.length - 1);
		});
	}, j = (e, t) => {
		let n = E.files.indexOf(e), r = n + t;
		if (n < 0 || r < 0 || r >= E.files.length) return;
		let i = E.files[r];
		E.files[n] = i, E.files[r] = e, t === -1 ? e.listItem.before(i.listItem) : e.listItem.after(i.listItem), $(E), A(), f(E.field, "file-upload", "uploaded-assets-reordered", { assets: E.files.filter((e) => e.assetId !== null).map((e) => ({
			assetId: e.assetId,
			filename: e.filename
		})) });
	}, M = (e, t, n, r) => {
		...
		if (t.uppyFileId && w.removeFile(t.uppyFileId), t.assetId) {
			let n = new FormData(), r = ut(d, e, i);
		...
		t.listItem.remove(), E.files = E.files.filter((e) => e !== t), $(E), A();
	}, te = (t, n) => {
		let { listItem: r, removeButton: i, sortUpButton: a, sortDownButton: o } = yt(e, n);
		r.classList.add("is-complete"), l.append(r);
		let s = {
			assetId: t,
			filename: n,
			uppyFileId: null,
		...
		if (t.length) try {
			let n = (await c(v, {
				method: "POST",
				body: dt(d, e, t)
			})).assets || [], r = new Map(n.map((e) => [K(e.assetId), e]).filter(([e]) => e !== null));
			t.forEach((e) => {
				if (E.files.some((t) => t.assetId === e)) return;
				let t = r.get(e);
				t && te(e, t.filename || `Asset #${e}`);
			}), $(E), A();
		} catch (e) {
			G.warn("Failed to hydrate uploaded assets.", { error: e });
		}
	}, P = (e) => e && E.files.find((t) => t.uppyFileId === e) || null;
	w.on("upload-progress", (e, t) => {
		let n = P(e?.id);
		if (!n) return;
	...
	}), w.on("upload-success", (e, t) => {
		let n = P(e?.id);
		if (!n) return;
		let r = n.listItem.querySelector("[data-formie-upload-manager-error]"), i = at(t?.body) ? t.body : {}, a = K(i.assetId);
		if (!i.success || !a) {
			if (n.listItem.classList.add("is-error"), n.listItem.classList.remove("is-uploading", "is-upload-complete", "is-processing", "is-preparing"), r instanceof HTMLElement) {
				r.hidden = !1, r.textContent = ht(null, { message: "Upload failed." });
				let e = i.errors ? Object.values(i.errors).flat().find(Boolean) : null;
				e && (r.textContent = e);
			}
			return;
		}
		n.assetId = a, n.filename = i.filename || n.filename, _t(n.listItem), $(E), A();
	}), w.on("upload-error", (e, t, n) => {
		let r = P(e?.id);
		if (!r) return;
		let i = r.listItem.querySelector("[data-formie-upload-manager-error]");
		r.listItem.classList.add("is-error"), r.listItem.classList.remove("is-uploading", "is-upload-complete", "is-processing", "is-preparing"), i instanceof HTMLElement && (i.hidden = !1, i.textContent = ht(n, t));
	}), w.on("file-added", (t) => {
		let n = D();
		if (n !== null && n <= 0) {
			w.removeFile(t.id), w.info("File limit reached.", "error", 3e3);
			return;
		}
		w.setFileMeta(t.id, ut(d, e, i));
		let { listItem: r, removeButton: a, sortUpButton: o, sortDownButton: s } = yt(e, t.name || "Upload");
		l.append(r);
		let c = {
			assetId: null,
	...
	s?.addEventListener("click", (e) => {
		...
		e.target instanceof Element && e.target.closest(We) || F();
	}), i.addEventListener("keydown", (e) => {
		(e.key === "Enter" || e.key === " ") && (e.preventDefault(), F());
	}), a.addEventListener("change", () => {
		if (!a.files?.length) return;
		let e = Array.from(a.files);
		a.value = "";
		try {
			w.addFiles(e.map((e) => ({
				name: e.name,
			...
			e instanceof Error && w.info(e.message, "error", 3e3);
		}
	...
	let I = () => {
		E.files.forEach((e) => {
			e.listItem.remove();
		}), E.files = [], w.cancelAll(), lt(e, h, m, []);
	};
	return d?.addEventListener(Ze, I), N(), () => {
		d?.removeEventListener(Ze, I), w.destroy(), E.files = [];
	};
}
var Et = {
	id: $e,
	kind: "field",
	match: (e) => !!e.target.querySelector(V),
	setup: async (e) => {
		...
		let a = (e) => {
			...
			e instanceof HTMLElement && e.hasAttribute("data-formie-field-handle") && a.add(e), e instanceof Element && (e.querySelectorAll("[data-formie-field-handle]").forEach((e) => {
				...
				r.has(e) || !e.querySelector(V) || (r.add(e), i.push(Tt(e, n, t)));
			});
		};
		a(e.target);
		let o = (e) => {
		...
		return n?.addEventListener(Qe, o), G.log("Module setup.", { count: i.length }), await e.emit("formie:module:upload-manager:init", { count: i.length }), { destroy: () => {
			n?.removeEventListener(Qe, o), i.forEach((e) => {
				e();
			}), Ct(n), G.log("Module destroy."), e.emit("formie:module:upload-manager:destroy", {});
		} };
	}
};
//#endregion
export { Et as uploadManagerModule };
