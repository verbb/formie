...
var _ = /* @__PURE__ */ c((/* @__PURE__ */ o(((e, t) => {
	(function(n, r) {
		...
		let pe = typeof window == "object" && window !== null ? window : typeof global == "object" && global !== null ? global : {};
		function me() {
			let e = (() => {
				let e = pe.$locutus;
				typeof e == "object" && e || (e = {}, pe.$locutus = e);
				let t = e.php;
				return typeof t == "object" && t || (t = {}, e.php = t), t;
			})(), t = e.ini, n = e.locales, r = e.localeCategories, i = e.pointers, a = de(t) ? t : {}, o = ((e) => de(e))(n) ? n : {}, s = ((e) => de(e))(r) ? r : {}, c = Array.isArray(i) ? i : [];
		...
		function Se(e, ...t) {
			...
			let r = fe(e);
			e: for (let [e, i] of le(r)) {
				for (let e of t) {
					let t = fe(e), n = !1;
					for (let [, e] of le(t)) if (e === i) {
						n = !0;
						break;
					}
					if (!n) continue e;
		...
		let Ee = new j("implode", function(e, t) {
			return `__runtime.implode(${e}, ${t})`;
		}, function(e, t, n) {
			return Te(t, n);
		}), De = new j("count", function(e, t) {
			let n = "";
			return t && (n = `, ${t}`), `__runtime.count(${e}${n})`;
		}, function(e, t, n) {
			return we(t, n);
		}), Oe = new j("array_intersect", function(e, ...t) {
			let n = "";
		...
		e.AbstractProvider = M, e.ArrayAdapter = ie, e.ArrayProvider = class extends M {
			getFunctions() {
				return [
					Ee,
					De,
		...
		}, e.BasicProvider = class extends M {
			getFunctions() {
				return [se];
			}
		}, e.CacheItem = A, e.CompileRuntime = Xe, e.Compiler = O, e.DateProvider = class extends M {
			getFunctions() {
		...
		}, e.Expression = ne, e.ExpressionFunction = j, e.ExpressionLanguage = oe, e.IGNORE_UNKNOWN_FUNCTIONS = 2, e.IGNORE_UNKNOWN_VARIABLES = 1, e.Node = _, e.OPERATOR_LEFT = 1, e.OPERATOR_RIGHT = 2, e.ParsedExpression = k, e.Parser = te, e.StringProvider = class extends M {
			getFunctions() {
				return [
					new j("strtolower", (e) => "__runtime.strtolower(" + e + ")", (e, t) => _e(t)),
					new j("strtoupper", (e) => "__runtime.strtoupper(" + e + ")", (e, t) => ve(t)),
					new j("explode", (e, t, n = "null") => `__runtime.explode(${e}, ${t}, ${n})`, (e, t, n, r = null) => ce(t, n, r)),
...
})(), ee = /[\p{L}\p{N}\p{M}]+(?:['’._-][\p{L}\p{N}\p{M}]+)*/gu;
function te(e) {
...
//#endregion
export { S as a, h as c, x as i, ie as n, T as o, C as r, g as s, E as t };
