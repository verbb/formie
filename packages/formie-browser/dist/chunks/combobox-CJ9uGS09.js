...
var J = 0, Y = class extends o(a) {
	constructor(e, t) {
		...
		typeof a != "function" && (typeof a == "string" && (a = new RegExp(a)), i.createFilter = a instanceof RegExp ? (e) => a.test(e) : (e) => this.settings.duplicates || !this.options[e]), this.initializePlugins(i.plugins), this.setupCallbacks(), this.setupTemplates();
	...
	onItemSelect(e, t) {
		var n = this;
		return !n.isLocked && n.settings.mode === "multi" && (j(e), n.setActiveItem(t, e), !0);
	}
	canLoad(e) {
	...
	registerOptionGroup(e) {
		...
		return t !== null && (e.$order = e.$order || ++this.order, this.optgroups[t] = e, t);
	}
	addOptionGroup(e, t) {
		var n;
	...
	updateOriginalInput(e = {}) {
		...
		if (t.is_select_tag) {
			...
			function o(n, r, o) {
				return n ||= R("<option value=\"" + A(r) + "\">" + A(o) + "</option>"), n != i && t.input.append(n), e.push(n), (n != i || a > 0 || t.settings.mode == "multi") && (n.selected = !0), n;
			}
		...
		e.control_input.addEventListener("keydown", (t) => {
			switch (t.keyCode) {
				case it:
					...
					return;
				case at: e.focus_node.tabIndex = -1;
			}
...
var Ct = (e, t = !1) => {
	...
	return document.querySelector(e);
}, Et = (e) => typeof e == "string" && e.indexOf("<") > -1;
function Dt(e) {
	let t = this, n = Object.assign({
		label: "×",
		title: "Remove",
		...
		html: (e) => {
			let t = document.createElement("div");
			return t.className = e.className || "", t.title = e.title || "", t.setAttribute("role", e.role || "button"), t.tabIndex = e.tabindex ?? -1, t.textContent = e.label || "", t;
		}
	}, e);
	t.hook("after", "setupTemplates", () => {
		var e = t.settings.render.item;
		t.settings.render.item = (r, i) => {
			var a = Tt(e.call(t, r, i)), o = Tt(n.html(n));
			return a.appendChild(o), wt(o, "mousedown", (e) => {
				Ct(e, !0);
			}), wt(o, "click", (e) => {
				t.isLocked || (Ct(e, !0), !t.isLocked && t.shouldDelete([a], e) && (t.removeItem(a), t.refreshOptions(!1), t.inputState()));
			}), a;
		};
	});
}
...
function Nt() {
	...
	let p = (t) => e.settings.maxOptions !== null && typeof e.settings.maxOptions == "number" && a.children.length >= e.settings.maxOptions ? !1 : !!(t in i && i[t]), m = (t, n) => e.items.indexOf(n) >= 0 || c.indexOf(n) >= 0;
	e.setNextUrl = (e, t) => {
		i[e] = t;
	}, e.getUrl = (t) => {
		if (t in i) {
	...
	}), e.hook("instead", "canLoad", (n) => n in i ? p(n) : t.call(e, n)), e.hook("instead", "loadCallback", (t, n) => {
		if (!o) {
			let t = e.lastValue === "" ? m : (t, n) => e.items.indexOf(n) >= 0 || f.indexOf(n) >= 0;
			e.clearOptions(t);
		} else if (s) {
			let n = t[0];
			n !== void 0 && (s.dataset.value = n[e.settings.valueField]);
		}
		r.call(e, t, n), !o && !l && (l = !0, e.lastValue === "" && (c = Object.keys(e.options), u = i[""], d = Object.values(e.options))), o = !1;
		...
		let t = e.lastValue;
		var n;
		p(t) ? (n = e.render("loading_more", { query: t }), n && (n.setAttribute("data-selectable", ""), s = n)) : t in i && !a.querySelector(".no-results") && (n = e.render("no_more_results", { query: t })), n && (At(n, e.settings.optionClass), a.append(n));
	});
	let h = () => {
		l && (e.addOptions(d), e.clearOptions(m), u && (i[""] = u));
	};
	e.on("type", (t) => {
		t === "" && (h(), e.refreshOptions(!1));
	}), e.on("dropdown_close", h), e.on("initialize", () => {
		f = Object.keys(e.options), c = Object.keys(e.options), a = e.dropdown_content, e.settings.render = Object.assign({}, {
...
function Ut(e, t = {}) {
	...
	let n = t.multiple === !0, i = Rt(e), a = Vt(e, t.placeholder), o = {
		create: !1,
		maxItems: n ? null : 1,
	...
	let s = new Pt(e, o);
	return Ht(s), Bt(s.wrapper), s.dropdown && Bt(s.dropdown), e.style.display = "none", e._formieTomSelect = s, $.log("Initialized.", {
		inputName: e.name,
		multiple: n
	}), r(e, Q, "after-init", {
		combobox: s,
		...
		s.destroy(), e.style.removeProperty("display"), zt(e, i), delete e._formieTomSelect, $.log("Destroyed.", { inputName: e.name });
	};
}
var Wt = {
	id: Q,
	kind: "field",
	match: (e) => !!e.target.querySelector(It),
	setup: async (e) => {
		let t = e.options || {}, r = n(e), i = r.map((e) => {
			let n = e.querySelector(It);
			return n instanceof HTMLSelectElement ? Ut(n, t) : ($.warn("Field missing combobox select; skipping."), () => {});
		});
...
//#endregion
export { Wt as comboboxModule, Ut as initFormieCombobox };
