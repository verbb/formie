...
import { t as l } from "./field-references.keys-58ZSTrCW.js";
import { t as u } from "./styles-BfoIZwJp.js";
import { c as d, l as f, t as p } from "./shared-Bx9s0i0P.js";
...
function _(e, t = {}) {
	let { body: n = null, headers: r = {}, method: i = "GET", onBeforeRequest: a = g, onUploadProgress: o = g, shouldRetry: s = () => !0, onAfterResponse: c = g, onTimeout: l = g, responseType: u, retries: d = 3, signal: f = null, timeout: p = 3e4, withCredentials: _ = !1 } = t, v = (e) => .3 * 2 ** (e - 1) * 1e3, y = new h(p, l);
	function b(t = 0) {
		return new Promise(async (l, p) => {
			...
			h.open(i, e, !0), h.withCredentials = _, u && (h.responseType = u), h.onload = async () => {
				...
				h.status >= 200 && h.status < 300 ? (y.done(), l(h)) : s(h) && t < d ? setTimeout(() => {
					b(t + 1).then(l, p);
				}, v(t)) : (y.done(), p(new m(h.statusText, h)));
			}, h.onerror = () => g(new m(h.statusText, h)), h.upload.onprogress = (e) => {
				y.progress(), o(e);
			}, r && Object.keys(r).forEach((e) => {
				h.setRequestHeader(e, r[e]);
			});
			function x() {
				h.abort(), p(new DOMException("Aborted", "AbortError"));
			}
...
var v = (e) => "error" in e && !!e.error, y = (e) => e.progress.uploadComplete;
function b(e) {
	return e.filter((e) => !v(e) && !y(e));
}
function x(e) {
...
function w(e) {
	...
	let t = e.name ? S(e.name).extension?.toLowerCase() : null;
	return t && t in C ? C[t] : "application/octet-stream";
}
//#endregion
...
function E(e) {
	let t = "";
	return e.replace(/[^A-Z0-9]/gi, (e) => (t += `-${T(e)}`, "/")) + t;
}
function D(e, t) {
	let n = t || "uppy";
	return typeof e.name == "string" && (n += `-${E(e.name.toLowerCase())}`), e.type !== void 0 && (n += `-${e.type}`), e.meta && typeof e.meta.relativePath == "string" && (n += `-${E(e.meta.relativePath.toLowerCase())}`), e.data?.size !== void 0 && (n += `-${e.data.size}`), e.data.lastModified !== void 0 && (n += `-${e.data.lastModified}`), n;
}
function O(e) {
...
var N = (e) => {
	...
	locale;
	constructor(e, { onMissingKey: t = N } = {}) {
		this.locale = {
			strings: {},
			pluralize(e) {
				return e === 1 ? 0 : 1;
...
})), F = /* @__PURE__ */ e(ce(), 1), de = /* @__PURE__ */ e(ue(), 1), fe = {
	maxFileSize: null,
	minFileSize: null,
	...
	validateSingleFile(e) {
		...
		if (r && !r.some((t) => t.includes("/") ? e.type ? (0, de.default)(e.type.replace(/;.*?$/, ""), t) : !1 : t[0] === "." && e.extension ? e.extension.toLowerCase() === t.slice(1).toLowerCase() : !1)) {
			let t = r.join(", ");
	...
	var n = ge(), r = typeof self == "object" && self && self.Object === Object && self;
	...
	var n = we(), r = Te(), i = "[object Symbol]";
	function a(e) {
		return typeof e == "symbol" || r(e) && n(e) == i;
	}
	t.exports = a;
})), De = /* @__PURE__ */ t(((e, t) => {
	var n = be(), r = L(), i = Ee(), a = NaN, o = /^[-+]0x[0-9a-f]+$/i, s = /^0b[01]+$/i, c = /^0o[0-7]+$/i, l = parseInt;
	function u(e) {
	...
	var n = L(), r = ve(), i = De(), a = "Expected a function", o = Math.max, s = Math.min;
	function c(e, t, c) {
	...
	var n = Oe(), r = L(), i = "Expected a function";
	function a(e, t, a) {
		var o = !0, s = !0;
...
})), je = "useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict", Me = (e = 21) => {
	let t = "", n = e | 0;
	for (; n--;) t += je[Math.random() * 64 | 0];
	return t;
}, Ne = {
	name: "@uppy/core",
...
var Le = /* @__PURE__ */ e(ke(), 1), Re = /* @__PURE__ */ e(Ae(), 1), R = {
	totalProgress: 0,
	allowNewUpload: !0,
	error: null,
	recoveredState: null
}, ze = class e {
	static VERSION = Ne.version;
	...
	constructor(t) {
		...
		this.opts = {
		...
		}, t?.logger && t.debug ? this.log("You are using a custom `logger`, but also set `debug: true`, which uses built-in logger to output logs to console. Ignoring `debug: true` and using your custom `logger`.", "warning") : t?.debug && (this.opts.logger = se), this.log(`Using Core v${e.VERSION}`), this.i18nInit(), this.store = this.opts.store, this.setState({
			...R,
			plugins: {},
			files: {},
			currentUploads: {},
			...
			meta: { ...this.opts.meta },
			info: []
		}), this.#t = new pe(() => this.opts, () => this.i18n), this.#n = this.store.subscribe((e, t, n) => {
	...
	i18nInit() {
		let e = new P([this.defaultLocale, this.opts.locale], { onMissingKey: (e) => this.log(`Missing i18n string: ${e}`, "error") });
	...
	#d(e) {
		let t = e instanceof File ? {
			...
			source: void 0,
			preview: void 0
		} : e, n = w(t), r = Pe(n, t), i = S(r).extension, a = ee(t, this.getID()), o = {
			...t.meta,
			name: r,
			type: n
...
}, Ve = { strings: { uploadStalled: "Upload has not made any progress for %{seconds} seconds. You may want to retry it." } };
//#endregion
//#region ../../node_modules/@uppy/xhr-upload/lib/index.js
function He(e, t) {
	let n = t;
	return n ||= /* @__PURE__ */ Error("Upload error"), typeof n == "string" && (n = Error(n)), n instanceof Error || (n = Object.assign(/* @__PURE__ */ Error("Upload error"), { data: n })), te(e) ? (n = new m(n, e), n) : (n.request = e, n);
}
function Ue(e) {
...
var We = {
	...
	constructor(e, t) {
		if (super(e, {
			...
			...t
		}), this.type = "uploader", this.id = this.opts.id || "XHRUpload", this.defaultLocale = Ve, this.i18nInit(), this.#t = new ne({ concurrency: this.opts.limit }), this.opts.bundle && !this.opts.formData) throw Error("`opts.formData` must be true when `opts.bundle` is enabled.");
		...
		this.uploaderEvents = Object.create(null), this.#e = (e) => async (t, n) => {
			try {
				...
				let n = t.request;
				for (let r of e) this.uppy.emit("upload-error", this.uppy.getFile(r.id), He(n, t), n);
				throw t;
			}
		};
	}
	...
	createBundledUpload(e, t) {
		...
		return this.addMetadata(n, r, t), e.forEach((e) => {
			let t = this.getOptions(e), r = Ue(e);
			e.name ? n.append(t.fieldName, r, e.name) : n.append(t.fieldName, r);
		}), n;
	}
	async #n(e) {
		let t = new ae(this.uppy), n = new AbortController();
	...
	#o = async (e) => {
		...
		let t = b(this.uppy.getFilesByIds(e)), n = x(t);
...
function q(e, t) {
	return dt(e, t).map((e) => W(e.value)).filter((e) => e !== null);
}
function ft(e, t, n, r) {
	let i = t;
	dt(e, n).forEach((e) => {
		...
		t.type = "hidden", t.name = n, t.value = String(e), t.setAttribute($e, "true"), i.insertAdjacentElement("afterend", t), i = t;
	});
}
function pt(e, t, n) {
...
function mt(e, t, n) {
	let r = new FormData(), i = lt(e), a = G(t);
...
function X(e, t, n = "uploading") {
	let { track: r, bar: i, label: a } = Y(e);
...
function gt(e, t, n) {
	let { track: r, bar: i, label: a } = Y(e), o = Math.max(0, Math.min(ot, Math.round(t)));
...
function _t(e, t, n = {}) {
	...
	if ((i > 0 ? r >= i : t >= 100) || t >= 100) {
		X(e, "Processing…", "processing");
		return;
	}
	if (t <= 0 && r <= 0) {
		X(e, "Uploading…", "uploading");
		return;
	}
	let a = Math.min(ot, Math.max(1, Math.round(t)));
	gt(e, a, `Uploading… ${a}%`);
}
function vt(e, t) {
...
function Z(e, t) {
	...
	return p.className = "formie-upload-manager-error", p.setAttribute("data-formie-upload-manager-error", "true"), p.hidden = !0, n.append(r, i, d, p), X(n, "Preparing…", "preparing"), {
		listItem: n,
		filenameEl: r,
		errorEl: p,
		removeButton: f,
...
function Q(e) {
	let t = K(e).find((e) => e.hasAttribute($e));
...
function $(e) {
	...
	ft(e.field, e.anchorInput, e.assetInputName, t), e.statusInput && (e.statusInput.value = t.length ? "uploaded" : ""), p(e.field, "file-upload", "uploaded-assets-sync", { assets: t.map((t) => ({
		assetId: t,
...
function Ct(e) {
	f(e, rt, (e) => {
		e.addValidator("uploadManagerRequired", ({ input: e }) => {
			...
			return !(t instanceof HTMLElement) || e.getAttribute("data-formie-validation-required") !== "true" || q(t, Q(t)).length > 0;
...
function Et(e, t, n) {
	...
	let a = r.querySelector(Je), s = r.querySelector(qe), l = r.querySelector(Ye), u = r.querySelector(V);
	if (!(a instanceof HTMLInputElement) || !(l instanceof HTMLElement)) return () => {};
	let d = Tt(t, e), f = u instanceof HTMLInputElement ? u : null, m = Q(e), h = ut(e, m), g = J(i, n.uploadEndpoint, "data-formie-file-upload-upload-endpoint", "/actions/formie/file-upload/upload"), _ = J(i, n.deleteEndpoint, "data-formie-file-upload-delete-endpoint", "/actions/formie/file-upload/delete"), v = J(i, n.hydrateEndpoint, "data-formie-file-upload-hydrate-endpoint", "/actions/formie/file-upload/hydrate"), y = n.limitFiles ?? W(i.getAttribute("data-formie-file-limit")), b = n.sizeLimit ?? parseFloat(i.getAttribute("data-formie-size-max-limit") || ""), x = n.sizeMinLimit ?? parseFloat(i.getAttribute("data-formie-size-min-limit") || ""), S = ht(n.accept ?? i.getAttribute("accept") ?? a.accept), C = {};
	...
	w.use(Ge, {
		...
		onBeforeRequest(e, t, n) {
			...
			!i?.id || !i.size || e.upload.addEventListener("progress", (e) => {
				...
				if (!t) return;
				let n = 0;
				e.lengthComputable && e.total > 0 ? n = Math.round(e.loaded / e.total * 100) : e.loaded > 0 && i.size && (n = Math.min(100, Math.round(e.loaded / i.size * 100))), _t(t.listItem, n, {
					loaded: e.loaded,
	...
	let E = {
		...
		uppy: w,
		files: []
	}, D = () => y ? Math.max(0, y - St(E)) : null, O = (e) => {
		i.classList.toggle("formie-upload-manager-dropzone-active", e);
	}, ee = (e) => e.assetId !== null && !e.listItem.classList.contains("is-error"), k = () => {
		let e = E.files.length >= 2;
		E.files.forEach((t, n) => {
			let r = t.listItem.querySelector(Xe), i = t.listItem.querySelector(Ze), a = t.listItem.querySelector(Qe);
			if (!(r instanceof HTMLElement)) return;
			let o = e && ee(t);
		...
		let i = E.files[r];
		E.files[n] = i, E.files[r] = e, t === -1 ? e.listItem.before(i.listItem) : e.listItem.after(i.listItem), $(E), k(), p(E.field, "file-upload", "uploaded-assets-reordered", { assets: E.files.filter((e) => e.assetId !== null).map((e) => ({
			assetId: e.assetId,
			filename: e.filename
		})) });
	}, j = (e, t, n, r) => {
		...
		t.listItem.remove(), E.files = E.files.filter((e) => e !== t), $(E), k();
	}, ne = (t, n) => {
		let { listItem: r, removeButton: i, sortUpButton: a, sortDownButton: o } = Z(e, n);
		...
		if (t.length) try {
			let n = (await c(v, {
				method: "POST",
				body: mt(d, e, t)
			})).assets || [], r = new Map(n.map((e) => [W(e.assetId), e]).filter(([e]) => e !== null));
			t.forEach((e) => {
				if (E.files.some((t) => t.assetId === e)) return;
				let t = r.get(e);
				t && ne(e, t.filename || `Asset #${e}`);
			}), $(E), k();
		} catch (e) {
			U.warn("Failed to hydrate uploaded assets.", { error: e });
		}
	}, M = (e) => e && E.files.find((t) => t.uppyFileId === e) || null;
	w.on("upload-progress", (e, t) => {
		...
		let t = M(e?.id);
		t && X(t.listItem, "Retrying…", "retrying");
	}), w.on("upload-success", (e, t) => {
		let n = M(e?.id);
		if (!n) return;
		let r = n.listItem.querySelector("[data-formie-upload-manager-error]"), i = ct(t?.body) ? t.body : {}, a = W(i.assetId);
		if (!i.success || !a) {
			if (n.listItem.classList.add("is-error"), n.listItem.classList.remove("is-uploading", "is-upload-complete", "is-processing", "is-preparing"), r instanceof HTMLElement) {
				r.hidden = !1, r.textContent = vt(null, { message: "Upload failed." });
				let e = i.errors ? Object.values(i.errors).flat().find(Boolean) : null;
				e && (r.textContent = e);
			}
			return;
		}
		n.assetId = a, n.filename = i.filename || n.filename, bt(n.listItem), $(E), k();
	}), w.on("upload-error", (e, t, n) => {
		let r = M(e?.id);
		if (!r) return;
		let i = r.listItem.querySelector("[data-formie-upload-manager-error]");
		r.listItem.classList.add("is-error"), r.listItem.classList.remove("is-uploading", "is-upload-complete", "is-processing", "is-preparing"), i instanceof HTMLElement && (i.hidden = !1, i.textContent = vt(n, t));
	}), w.on("file-added", (t) => {
		let n = D();
		if (n !== null && n <= 0) {
		...
		w.setFileMeta(t.id, pt(d, e, i));
		let { listItem: r, removeButton: a, sortUpButton: o, sortDownButton: s } = Z(e, t.name || "Upload");
		l.append(r);
		let c = {
			assetId: null,
	...
	s?.addEventListener("click", (e) => {
		...
		e.target instanceof Element && e.target.closest(qe) || N();
	...
	let P = () => {
		E.files.forEach((e) => {
			e.listItem.remove();
		}), E.files = [], w.cancelAll(), ft(e, h, m, []);
	};
	return d?.addEventListener(et, P), re(), () => {
		d?.removeEventListener(et, P), w.destroy(), E.files = [];
	};
}
var Dt = {
	id: nt,
	...
	setup: async (e) => {
		...
		let a = (e) => {
			...
			e instanceof HTMLElement && e.hasAttribute("data-formie-field-handle") && a.add(e), e instanceof Element && (e.querySelectorAll("[data-formie-field-handle]").forEach((e) => {
				...
				r.has(e) || !e.querySelector(z) || (r.add(e), i.push(Et(e, n, t)));
			});
		};
		a(e.target);
		let o = (e) => {
		...
		return n?.addEventListener(tt, o), U.log("Module setup.", { count: i.length }), await e.emit("formie:module:upload-manager:init", { count: i.length }), { destroy: () => {
			n?.removeEventListener(tt, o), i.forEach((e) => {
				e();
			}), wt(n), U.log("Module destroy."), e.emit("formie:module:upload-manager:destroy", {});
		} };
	}
};
//#endregion
export { Dt as uploadManagerModule };
