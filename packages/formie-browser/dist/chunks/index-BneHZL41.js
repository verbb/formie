...
const hn = ["prepare", "normalize", "validate", "screen", "authorize", "dispatch", "finalize"], bn = ["prepare", "normalize", "validate", "screen", "authorize"], R = _("general", "pipeline");
function $e(e, t) {
  return {
    ok: !1,
    stage: e,
...
async function tr(e, t, r, n = {}) {
  ...
  for (const u of p) {
    if (R.log("Stage start.", { stage: u, action: t }), i)
      return R.warn("Stage skipped due to abort.", { stage: u, reason: o }), $e(u, o);
    {
...
function ti(e, t) {
  ...
  if (r) {
    ...
    if (r === "text") {
      ...
      t.setAttribute("data-formie-loading-text", o), Xn(t, o);
      return;
    }
...
function lr(e, t) {
  ...
  }), t && (t.setAttribute("data-formie-loading", "true"), ti(e, t));
}
function Me(e) {
...
function be(e, t = {}) {
  ...
  if (B(e), e.reset(), t.preserveHiddenState || st(e, !1), ae(e, "submissionId"), ae(e, "submissionUid"), ae(e, "continuationToken"), ae(e, "pageId"), ni(e), n?.resetLiveState(), i) {
...
function si(e, t, r) {
  ...
  if (r === "save") {
    B(e), ii(e, t), j.log("Applied save/resume token state.");
    return;
  }
...
function mr(e) {
  e.querySelectorAll("[data-formie-field-handle]").forEach((t) => {
    ...
    le(r, e, "fieldLayoutError"), r.removeAttribute("data-formie-field-has-error"), r.querySelectorAll("[data-formie-field-error]").forEach((a) => {
      ...
      const s = a;
      s.removeAttribute("aria-invalid"), le(s, e, "fieldControlError"), s.removeAttribute("data-formie-input-has-error"), i && bi(s, i), o.forEach((l) => {
        vi(s, l);
      });
    });
  }), J(e);
...
function ct(e) {
  ci(e), e.querySelectorAll("[data-formie-message-success]:not([data-formie-success-container])").forEach((t) => {
    t.remove();
...
function Ei(e, t) {
  Object.entries(t).forEach(([r, n]) => {
    ...
    if (!i)
      return;
    const o = hi(i), a = o.id && o.id.trim() ? o.id : `${r}-errors`;
    ...
    i.querySelectorAll("input, select, textarea").forEach((l) => {
      const d = l;
      d.setAttribute("aria-invalid", "true"), O(d, e, "fieldControlError"), d.setAttribute("data-formie-input-has-error", "true"), Mt(d, a), s && yi(d, s);
...
function Le(e, t) {
  if (mr(e), pr(e), ct(e), gr(e), t.ok) {
    Si(e, t) && Ai(e, t.message || "");
    return;
  }
  if (t.fieldErrors && Ei(e, t.fieldErrors), t.formErrors?.length) {
    Ct(e, t.formErrors);
    return;
  }
  !t.fieldErrors && t.message && Ct(e, [t.message]);
}
const wi = _("general", "submit-flow");
function Ti(e) {
...
async function yr(e) {
  ...
  try {
    await d(n), u = await tr(n, s, i, {
      validator: o,
      validateOnSubmit: a
    }), Le(n, u), si(n, u, s), Ti(u) && await p(u), h(u);
  } catch (c) {
    u = {
      ok: !1,
      code: "SUBMIT_ERROR",
    ...
    }, Le(n, u), h(u), wi.warn("Submit failed with exception.", {
      id: t,
      action: s,
      target: r,
...
const Mi = {
  ...
  "address-finder": () => import("./address-finder-DT8N_wrM.js").then((e) => e.addressFinderModule),
  "google-address": () => import("./google-address-BR9Xpj7k.js").then((e) => e.googleAddressModule),
  loqate: () => import("./loqate-f_wcnsYk.js").then((e) => e.loqateModule),
  "place-kit": () => import("./place-kit-BEvvmKGz.js").then((e) => e.placeKitModule)
}, Ci = {
  ...
  "captcha-eu": () => import("./captcha-eu-CorOxRZm.js").then((e) => e.captchaEuModule),
  "friendly-captcha-v1": () => import("./friendly-captcha-v1-CM_amiuh.js").then((e) => e.friendlyCaptchaV1Module),
  "friendly-captcha-v2": () => import("./friendly-captcha-v2-CvWP-yw2.js").then((e) => e.friendlyCaptchaV2Module),
  hcaptcha: () => import("./hcaptcha-gEuIvqLS.js").then((e) => e.hcaptchaModule),
  "recaptcha-enterprise": () => import("./recaptcha-enterprise-CdgZP7Ln.js").then((e) => e.recaptchaEnterpriseModule),
  "recaptcha-v2-checkbox": () => import("./recaptcha-v2-checkbox-UtbGhaXx.js").then((e) => e.recaptchaV2CheckboxModule),
  "recaptcha-v2-invisible": () => import("./recaptcha-v2-invisible-C88bLNnL.js").then((e) => e.recaptchaV2InvisibleModule),
  "recaptcha-v3": () => import("./recaptcha-v3-D8lOmIF5.js").then((e) => e.recaptchaV3Module),
  snaptcha: () => import("./snaptcha-C8ZzvN-8.js").then((e) => e.snaptchaModule),
  turnstile: () => import("./turnstile-BoTRyR9L.js").then((e) => e.turnstileModule)
}, Li = {
  ...
  calculations: () => import("./calculations-BD7H_yKm.js").then((e) => e.calculationsModule),
  "checkbox-radio": () => import("./checkbox-radio-yasMz63q.js").then((e) => e.checkboxRadioModule),
  conditions: () => import("./conditions-Crv7ppK9.js").then((e) => e.conditionsModule),
  "date-picker": () => import("./date-picker-9lTYJ7Fr.js").then((e) => e.datePickerModule),
  "file-upload": () => import("./file-upload-pOvR9XZp.js").then((e) => e.fileUploadModule),
  hidden: () => import("./hidden-BFueiWjw.js").then((e) => e.hiddenModule),
  "phone-country": () => import("./phone-country-C6n-UOg6.js").then((e) => e.phoneCountryModule),
  repeater: () => import("./repeater-DtPevoAU.js").then((e) => e.repeaterModule),
  "rich-text": () => import("./rich-text-CtcG5Pal.js").then((e) => e.richTextModule),
  signature: () => import("./signature-C4bXj1FF.js").then((e) => e.signatureModule),
  summary: () => import("./summary-CpfgiK6M.js").then((e) => e.summaryModule),
  table: () => import("./table-IJZEuX8B.js").then((e) => e.tableModule),
  "text-limit": () => import("./text-limit-DwlhiPbV.js").then((e) => e.textLimitModule)
}, Ii = {
  ...
  bpoint: () => import("./bpoint-CQueIb4O.js").then((e) => e.bpointModule),
  eway: () => import("./eway-Dwch78JT.js").then((e) => e.ewayModule),
  "go-cardless": () => import("./go-cardless-CJFC28CR.js").then((e) => e.goCardlessModule),
  mollie: () => import("./mollie-B2xCeTly.js").then((e) => e.mollieModule),
  moneris: () => import("./moneris-hPtYIngd.js").then((e) => e.monerisModule),
  opayo: () => import("./opayo-D1JCRDWm.js").then((e) => e.opayoModule),
  paddle: () => import("./paddle-CKIpRZL5.js").then((e) => e.paddleModule),
  paypal: () => import("./paypal-BDDF4SeO.js").then((e) => e.paypalModule),
  payway: () => import("./payway-BVfc8A1W.js").then((e) => e.paywayModule),
  square: () => import("./square-DiDi5h_X.js").then((e) => e.squareModule),
  stripe: () => import("./stripe-BNQL5AuB.js").then((e) => e.stripeModule)
}, Fi = {
  ...Li,
  ...Mi,
  ...Ci,
  ...Ii
}, _e = /* @__PURE__ */ new Map(), D = _("general", "loader"), Ri = new Function("src", "return import(src);");
...
async function Pi(e) {
  try {
    const t = await Ri(e), r = t?.default || t?.formieModule || null;
    return Er(r) ? r : null;
  } catch (t) {
...
async function qi(e, t) {
  ...
  if (r)
    return r;
  const n = await ki(e.id, t);
  if (n)
    return n;
  if (e.src) {
    const i = await Pi(e.src);
    if (i)
...
function Lt(e) {
  const t = Array.from(new FormData(e).entries()).filter(([r]) => _i(String(r || "")));
  return Hi(t);
}
function Di(e, t = {}) {
...
const X = '[data-formie]:not([data-formie-init="false"]), [data-formie-form]:not([data-formie-init="false"])', xi = 300, Ni = "/actions/formie/server/forms/render", It = "/api", Ui = "/actions/formie/server/forms/refresh-tokens", Bi = "/actions/formie/server/submissions/submit", ji = "/actions/formie/server/submissions/set-page", zi = "/actions/formie/server/submissions/clear-submission", Wi = "/actions/formie/file-upload/hydrate", L = _("general", "client"), Ft = /* @__PURE__ */ new Set();
function ce(e, t) {
  if (e == null || e === "")
    return t;
...
function Gi(e, t) {
  return re(e.endpoint || t.dataset.formieEndpoint, Ni);
}
function Ji(e, t) {
...
function Yi(e, t, r) {
  const n = r.endpoint || e.dataset.formieEndpoint, i = re(n, Bi), o = t.getAttribute("action");
  t.setAttribute("action", Rt(o, i)), t.querySelectorAll("[data-formie-tab-link]").forEach((a) => {
    const s = a.getAttribute("href"), l = re(n, ji);
...
function no(e) {
  return Math.max(0, ro(e.dataset.formieSubmitDelay, xi));
}
function Je(e) {
...
async function ao(e, t) {
  ...
  }, s = n === "graphql" ? Ji(t, e) : Gi(t, e), l = n === "graphql" ? await fn(s, o, a) : await dn(s, o, {
    ...a,
    endpoint: s
  });
...
function uo() {
  const e = /* @__PURE__ */ new Map(), t = new vr(), r = /* @__PURE__ */ new Map(), n = /* @__PURE__ */ new Map(), i = [
    ...
    w && ((P || T.endpoint || f.dataset.formieEndpoint) && Yi(f, w, T), J(w)), Object.keys(ne).length && I(f, "formie:theme:applied", {
      hasClasses: !0
    });
    ...
    w && (Jr({
      ...
      options: F,
      unbinds: g
    })), w && (so(f, w, T, m, k, g), k && g.push(Wn(w, k, f)), await lo(f, T, w)), i.forEach((C) => {
    ...
    if (!v.autoVisible || io(f) || typeof IntersectionObserver > "u")
      return a(f, v);
    if (e.has(f))
...
function Ze(e) {
  return typeof e == "string" ? Array.from(document.querySelectorAll(e)) : Pe(e) ? [e] : po(e);
}
function go() {
...
async function ho(e) {
  const t = Ze(e);
  return t.length > 0 || typeof e != "string" ? t : (await go(), Ze(e));
}
function bo(e) {
...
async function $t(e, t, r, n) {
  ...
  for (const a of n) {
    ...
    if (e.onReady?.(l), d.push(l.on("formie:submit:result", (p) => {
      const h = p;
      e.onResult?.(h, l), fo(h) ? e.onSuccess?.(h, l) : e.onError?.(h, l);
    })), e.onEvent)
      for (const p of Nr)
        d.push(l.on(p, (h) => {
          e.onEvent?.({
...
async function ha(e) {
  const t = e.client ?? uo(), r = /* @__PURE__ */ new Map(), n = await ho(e.element);
  if (n.length === 0 && !e.allowEmpty)
    throw new Error(`Formie could not find any elements for ${mo(e.element)}.`);
  await $t(e, t, r, n);
...
const gt = 2e3, ba = 5e3, ya = 5e3, va = 12e4;
async function ht(e) {
  await new Promise((t) => {
...
const Eo = /* @__PURE__ */ new Set([
  ...
  "sessionKey",
  "value"
]), So = "[data-formie-captcha-error-container]", Ao = [
  "formie:page:navigate",
  "formie:page:navigate:after",
  "formie:submit:result"
];
...
function Ro(e, t) {
  ...
  return {
    ...
    placeholder: {
      ...
      observe: (o, a) => Lo(e.root, n, o, a),
      createContainer: (o) => wo(o),
      clear: (o) => {
        o && (et(o), o.innerHTML = "");
      }
    },
    errors: {
      ...
      show: (o, a) => {
        To(a || Ne(e.root, n), o || t.ui.errorMessage, e.form || e.root);
      },
      clear: (o) => {
        et(o || Ne(e.root, n));
      }
...
function $o(e, t) {
  const r = Oo(t), n = Array.from(e.querySelectorAll(`[name="${r}"]`)), i = Array.from(e.querySelectorAll(`[name="${r}[]"]`));
...
function de(e) {
  return Ho(e).replace(/\]/g, "").split("[").join(".").replace(/\.+/g, ".").replace(/^\./, "").replace(/\.$/, "");
}
function Rr(e) {
...
function kr(e) {
  ...
  const n = (r[1] || "").trim().toLowerCase(), i = (r[2] || "").trim(), [o, a = ""] = i.split("|", 2), { source: s, transforms: l } = Do(o || "");
  if (n !== "field")
    return {
      raw: t,
      target: "",
...
function Uo(e) {
  ...
  return Array.from(e.querySelectorAll("[name]")).filter((n) => xo(n)).forEach((n) => {
    const i = _o(n.name);
    i && No(t, i, n);
  }), t;
}
...
function Ta(e, t, r) {
  ...
  const o = r ? Pr(r, i) : null, s = (o?.names?.length ? o.names : [Rr(i)]).flatMap((l) => {
...
function Ko(e, t, r) {
  const n = t || {}, i = Object.entries(n).reduce((l, [d, p]) => (zo.has(d) || (l[d] = p), l), {}), o = Array.isArray(n.requiredInputSuffixes) ? n.requiredInputSuffixes.map(String).filter(Boolean) : r.defaultRequiredInputSuffixes || [], a = Number(n.waitForValueMs ?? r.defaultWaitForValueMs ?? Ht), s = typeof n.errorMessage == "string" && n.errorMessage.trim() !== "" ? n.errorMessage.trim() : "Payment authorization is incomplete.";
  return {
    handle: Wo(e, n),
    transport: {
...
function Go(e, t) {
  const r = e.target, n = e.form, i = e.root, o = n || i, a = t.transport.requiredInputSuffixes, s = () => Uo(n || i), l = (y) => {
    const g = jo(y, s()).value;
  ...
  return {
    ...
    getBillingData: (y) => {
      ...
      if (y.billingAddress) {
        const g = y.billingAddress, S = {}, M = l(`${g}.address1`), T = l(`${g}.address2`), F = l(`${g}.address3`), P = l(`${g}.city`), w = l(`${g}.zip`), q = l(`${g}.state`), N = l(`${g}.country`);
        M && (S.line1 = M), T && (S.line2 = T), F && (S.line3 = F), P && (S.city = P), w && (S.postal_code = w), q && (S.state = q), N && (S.country = N), Object.keys(S).length && (m.address = S);
      }
      return { billing_details: m };
    },
    events: {
...
function Jo(e) {
  const t = e.defaultRequiredInputSuffixes ?? qo[e.id] ?? [];
  return {
    id: e.id,
    kind: "payment",
...
const Ma = Jo, Yo = "[data-formie-address-autocomplete-input]", Bt = "[data-formie-address-location]", Zo = {
...
}, Qo = /* @__PURE__ */ new Set(["handle"]);
function Xo(e, t) {
  return (typeof t.handle == "string" && t.handle.trim() !== "" ? t.handle.trim() : "") || e;
}
function ea(e, t) {
  const r = t || {}, n = Object.entries(r).reduce((i, [o, a]) => (Qo.has(o) || (i[o] = a), i), {});
  return {
    handle: Xo(e, r),
    provider: n
  };
...
function ra(e) {
  const t = e.target, r = e.form, n = e.root, i = Yo;
  return {
    root: n,
    field: t,
    form: r,
...
function na(e) {
  return {
    ...
    setup: async (t) => {
      const r = ea(e.id, t.options || {}), n = ra(t);
      te.log("Setup module.", {
        moduleId: e.id
      });
      const i = {
