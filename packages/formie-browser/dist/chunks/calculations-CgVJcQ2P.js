...
import { a as s, o as c, r as l, s as u, t as d } from "./dist-BF5GU3_9.js";
...
function w(e, t, n) {
	...
	return t.forEach(([e, t]) => {
		...
		if (String(n.scope || "").trim()) {
			o[e] = s(t, y(t.sourceKey || "", n, a).value);
			return;
		}
		o[e] = s(t, r(t.sourceKey || "", a).value);
	}), l(o, n.formatting);
}
function T(e, r) {
...
function E(e, t, n, r) {
	let i = u(r), a = c(r), s = /* @__PURE__ */ new Map(), l = null, f = !1, p = !1, m = !1, h = () => {
		s.forEach((e, t) => {
			e.forEach((e, n) => {
