...
function w(e) {
	a(e, l, (e) => {
		e.addValidator("textMinCharacterLimit", ({ input: e }) => {
			...
			return !t || C(e) ? !0 : n(e.value).graphemeCount >= t;
			...
			return !t || e.value.trim() === "" ? !0 : n(e.value).wordCount >= t;
...
function A(e) {
	let t = y(e, "data-formie-max-chars"), r = y(e, "data-formie-max-words"), i = E(e);
	if (!i) return;
	let a = n(e.value);
	if (t > 0) {
		k(i, e, t - a.graphemeCount, t, "character");
		return;
	}
	r > 0 && k(i, e, r - a.wordCount, r, "word");
}
var j = {
	id: "text-limit",
	kind: "field",
