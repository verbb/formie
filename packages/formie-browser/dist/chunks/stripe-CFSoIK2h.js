...
var o = "FORMIE_STRIPE_SCRIPT", s = e("stripe", "confirm"), c = "[data-formie-stripe-elements-placeholder]", l = /* @__PURE__ */ new Set([
	"BIF",
	"CLP",
	"DJF",
	"GNF",
...
function u(e, t) {
	return l.has(t.toUpperCase()) ? Math.ceil(e) : Math.round((e + 2 ** -52) * 100);
}
function d(e, t) {
...
var m = t({
	...
	onBeforeAuthorize: async (e) => {
		...
		return !o?.error || (n.addError(o.error.message), !1);
	},
	setup: async (e) => {
