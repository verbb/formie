...
function Wr(e, t, r, n, i) {
  ...
  return e.legacyEvent === "onFormieLoaded" ? {
    ...
    target: r,
    instance: i
  } : e.legacyEvent === "onFormiePageToggle" ? jr(n, t) : t;
}
function Kr({
  target: e,
  form: t,
  ...
  n.legacyDomEvents && _r.forEach((o) => {
    const a = (s) => {
      if (!(s instanceof CustomEvent) || !Br(o, s.detail))
        return;
      const l = o.target === "document" ? document : t;
      zr(l, o.legacyEvent, Wr(o, s.detail, e, t, r));
    };
    e.addEventListener(ze(o.canonicalEvent), a), i.push(() => {
      e.removeEventListener(ze(o.canonicalEvent), a);
    });
  });
}
function ge(e, t, r) {
...
function Gr({
  ...
  const d = (u) => {
    !(u instanceof CustomEvent) || !$e(u.detail, o) || ge(document, "formieValidatorDestroyed", {
      ...l,
      ...u.detail
    });
  }, p = (u) => {
    !(u instanceof CustomEvent) || !$e(u.detail, o) || !(u.target instanceof Element) || t.contains(u.target) && ge(u.target, "formieValidatorShowError", {
      ...u.detail,
      addValidator: a,
      removeValidator: s,
      form: t,
    ...
    !(u instanceof CustomEvent) || !$e(u.detail, o) || !(u.target instanceof Element) || t.contains(u.target) && ge(u.target, "formieValidatorClearError", {
      ...u.detail,
      addValidator: a,
      removeValidator: s,
      form: t,
...
function I(e, t, r) {
  e.dispatchEvent(new CustomEvent(ze(t), {
    bubbles: !0,
    detail: r
  }));
}
...
function Wt() {
  return jt().__FORMIE_DEBUG__ === !0;
}
function ra(e) {
  jt().__FORMIE_DEBUG__ = e;
}
function Jr(e, t, r) {
  if (Wt()) {
    if (typeof r > "u") {
...
async function cn(e, t, r = {}) {
  ...
  O.log("requestRender start.", { endpoint: e, handle: t });
  const i = await Fe(e, {
    method: "POST",
    body: n,
    headers: {
  ...
  return O.log("requestRender complete.", {
    hasHtml: !!i.html
  }), i;
}
...
query FormieHtmlForm($handle: String!, $input: ServerRenderPayloadInput) {
  ...
  O.log("requestGraphqlRender start.", { endpoint: e, handle: t });
  const o = await Fe(e, {
    method: "POST",
    body: i,
    headers: {
  ...
  return O.log("requestGraphqlRender complete.", {
    hasHtml: !!a.html
  }), a;
}
async function nt(e, t, r) {
  const n = new URL(e, window.location.origin);
  n.searchParams.set("handle", t), r && n.searchParams.set("renderId", r), O.log("requestRefreshTokens start.", {
    endpoint: n.toString(),
    handle: t,
    hasRenderId: !!r
  });
  const i = await Fe(n.toString());
  return O.log("requestRefreshTokens complete.", {
...
async function fn(e, t, r) {
  ...
  O.log("requestSetPage start.", {
    requestUrl: n.toString(),
    pageId: r || null
  });
  const o = await Fe(n.toString(), {
    method: "POST",
    body: i
  });
  return O.log("requestSetPage complete.", o), o;
}
function mn(e, t) {
  ...
  a && n.append("CRAFT_CSRF_TOKEN", a), O.log("clearSubmissionOnUnload start.", {
...
async function pn(e, t) {
  ...
  if (!a.includes("application/json"))
    return o.ok ? (O.log("submitForm non-JSON success response.", {
      status: o.status,
      contentType: a
    }), {
      ok: !0,
      message: "Submission completed."
    }) : (O.warn("submitForm non-JSON HTTP error.", {
      status: o.status,
      contentType: a
    }), {
      ok: !1,
  ...
  return O.log("submitForm JSON response normalized.", {
    ok: l.ok,
    code: l.code,
...
const gn = ["prepare", "normalize", "validate", "screen", "authorize", "dispatch", "finalize"], hn = ["prepare", "normalize", "validate", "screen", "authorize"], R = _("general", "pipeline");
function He(e, t) {
  return {
    ok: !1,
    stage: e,
...
async function tr(e, t, r, n = {}) {
  ...
  const s = En(e, t), l = {
    ...
    formData: vt(e, t),
    abort: (u) => {
      i = !0, o = u, R.warn("Pipeline aborted.", { reason: u });
    },
    isAborted: () => i,
    abortReason: () => o
  }, d = {
  ...
  };
  {
    ...
    u.failed.length > 0 && R.warn("Submit before listeners failed.", {
  ...
  if (s) {
    ...
    u.failed.length > 0 && R.warn("Final submit before listeners failed.", {
      eventName: u.eventName,
      failed: u.failed.length
    });
  }
  ...
  for (const u of p) {
    if (R.log("Stage start.", { stage: u, action: t }), i)
      return R.warn("Stage skipped due to abort.", { stage: u, reason: o }), He(u, o);
    {
      const b = await r.emitSafe(`formie:stage:${u}:before`, {
        ...l,
        stage: u
      });
      b.failed.length > 0 && R.warn("Stage before listeners failed.", {
        stage: u,
    ...
    if (i) {
      ...
      return R.warn("Aborted after stage before-hooks.", { stage: u, reason: o }), b;
    }
    const c = await d[u](l);
    ...
    });
    {
      ...
      b.failed.length > 0 && R.warn("Stage after listeners failed.", {
        stage: u,
        failed: b.failed.length
      });
    }
    if (i) {
      ...
      return R.warn("Aborted after stage after-hooks.", { stage: u, reason: o }), b;
    }
    if (c && !c.ok) {
      {
        const b = await r.emitSafe("formie:submit:after", c);
        b.failed.length > 0 && R.warn("Submit after listeners failed (failed stage).", {
          stage: u,
          failed: b.failed.length
        });
      }
      if (s) {
        ...
        b.failed.length > 0 && R.warn("Final submit after listeners failed (failed stage).", {
          stage: u,
          failed: b.failed.length
        });
      }
  ...
  };
  {
    ...
    u.failed.length > 0 && R.warn("Submit after listeners failed (success).", {
      failed: u.failed.length
    });
  }
  if (s) {
    const u = await r.emitSafe("formie:submit:final:after", h);
    u.failed.length > 0 && R.warn("Final submit after listeners failed (success).", {
      failed: u.failed.length
    });
  }
...
class Vn {
  ...
  removeError(t) {
    ...
    r.querySelectorAll("[data-formie-field-error]").forEach((o) => {
      ...
      const a = o;
      a.removeAttribute("aria-invalid"), this.config.inputErrorClass.length && a.classList.remove(...this.config.inputErrorClass), a.removeAttribute("data-formie-input-has-error"), i && Rn(a, i), r.querySelectorAll("[data-formie-field-error]").forEach((s) => {
        const l = s.id;
        l && Pn(a, l);
      });
    });
  ...
  showError(t, r, n) {
    ...
    l.setAttribute("data-formie-field-error", "true"), l.setAttribute(`data-formie-field-error-${r}`, "true"), l.setAttribute("id", s), l.setAttribute("role", "alert"), this.config.messageClass.length && l.classList.add(...this.config.messageClass), l.textContent = n, o.appendChild(l), i.setAttribute("data-formie-field-has-error", "true"), i.querySelectorAll("input, select, textarea").forEach((d) => {
      const p = d;
      p.setAttribute("aria-invalid", "true"), this.config.inputErrorClass.length && p.classList.add(...this.config.inputErrorClass), p.setAttribute("data-formie-input-has-error", "true"), kn(p, o.id), qn(p, s);
    });
...
const he = "data-formie-submit-validation-disabled", Oe = "data-formie-preserve-disabled", $n = "data-formie-submit-ready";
function ir(e) {
...
function at(e, t) {
  ...
  e.setAttribute($n, i ? "true" : "false"), Hn(e).forEach((o) => {
    if (On(o)) {
      if (i) {
        if (!o.hasAttribute(he))
          return;
        o.hasAttribute(Oe) ? (o.disabled = !0, o.removeAttribute(Oe)) : o.disabled = !1, o.removeAttribute(he);
        return;
      }
      o.hasAttribute(he) || (o.disabled && o.setAttribute(Oe, "true"), o.setAttribute(he, "true")), o.disabled = !0;
    }
  });
}
function _n(e, t, r) {
...
const Dn = "STALE_SUBMISSION_STATE", St = /* @__PURE__ */ new WeakMap(), Te = /* @__PURE__ */ new WeakMap(), B = _("general", "submit-result");
function je(e, t, r) {
...
function Wn(e, t) {
  ...
  r && (r.style.width = `${t}%`, r.setAttribute("aria-valuenow", `${t}`), r.setAttribute("data-formie-progress-state", Bn(t)), n && (n.textContent = `${t}%`, n.setAttribute("data-formie-progress-value", `${t}`)));
}
function Kn(e, t) {
  if (!t)
    return;
  ...
  if (r) {
    ...
    if (r === "text") {
      ...
      t.setAttribute("data-formie-loading-text", o), jn(t, o);
      return;
    }
...
function sr(e, t) {
  ...
  }), t && (t.setAttribute("data-formie-loading", "true"), Kn(e, t));
}
function Me(e) {
...
function lt(e, t) {
  const r = or(e), n = Un(e), i = r.findIndex((o) => o.getAttribute("data-formie-page-id") === t);
  if (r.forEach((o) => {
    o.getAttribute("data-formie-page-id") === t ? (o.removeAttribute("data-formie-page-hidden"), le(o, e, "pageHidden")) : (o.setAttribute("data-formie-page-hidden", "true"), $(o, e, "pageHidden"));
  }), n.forEach((o, a) => {
  ...
  if (je(e, "pageId", t), J(e), e.dataset.formieDisableSubmitUntilValid === "true") {
    const o = e;
...
function Gn(e, t) {
  ...
  typeof n == "string" && n.trim() !== "" ? je(e, "continuationToken", n) : ae(e, "continuationToken");
}
function Jn(e) {
  const t = e.getAttribute("action");
  t && e.setAttribute("action", xn(t, "resumeToken"));
  try {
...
function be(e, t = {}) {
  ...
  if (z(e), e.reset(), t.preserveHiddenState || st(e, !1), ae(e, "submissionId"), ae(e, "submissionUid"), ae(e, "continuationToken"), ae(e, "pageId"), Jn(e), n?.resetLiveState(), i) {
    lt(e, i), e.dispatchEvent(new CustomEvent(Be("reset"), { bubbles: !0 }));
    return;
  }
  J(e), e.dispatchEvent(new CustomEvent(Be("reset"), { bubbles: !0 }));
}
function Zn(e) {
  return e.code === Dn || e.meta?.resetState === !0;
}
function Qn(e, t) {
  ...
  if (Array.isArray(r) && r.length > 0) {
    ...
    for (const h of p) {
      const u = h.event;
      n.add(u), B.log("Dispatching submitData event.", {
        eventName: u
  ...
  return d && !n.has(d) && (d.startsWith("formie:payment:") && (i = !0), e.dispatchEvent(new CustomEvent(d, {
    bubbles: !0,
    detail: { data: l }
  })), B.log("Dispatching fallback payment action event.", {
    eventName: d
  })), { hasPaymentFollowUpEvent: i };
}
function Xn(e, t, r) {
  if (B.log("Applying submit result state.", {
    ok: t.ok,
    action: r,
    code: t.code,
    ...
    be(e), B.log("Resetting state due to stale/reset marker.");
    return;
  }
  const n = Qn(e, t);
  if (!t.ok && t.redirect?.url && !n.hasPaymentFollowUpEvent) {
    B.log("Applying redirect fallback for failed result.", {
      url: t.redirect.url,
      target: t.redirect.target
    }), z(e), t.redirect.target === "new-tab" ? window.open(t.redirect.url, "_blank") : (At(e, "redirect"), window.location.href = t.redirect.url);
    return;
  }
  if (Gn(e, t), !t.ok) {
    B.log("Non-redirect failure; keeping current form state."), z(e);
    return;
  }
  if (Kt(e, r), t.nextPage?.id) {
    z(e), e.formieValidation?.resetLiveState(), lt(e, t.nextPage.id), B.log("Advanced to next page.", {
      nextPageId: t.nextPage.id
    });
    return;
  }
  if (r === "save") {
    z(e), Yn(e, t), B.log("Applied save/resume token state.");
    return;
  }
  if (r === "submit" && !t.redirect?.url) {
    const i = wt(e), o = i === "message" && Tt(e);
    if (i === "reload") {
      z(e), At(e, "reload"), window.location.reload();
      return;
    }
    if (i === "reset") {
      be(e);
    ...
    z(e), be(e, { preserveHiddenState: o });
    return;
  }
...
function oi(e) {
  const t = ei(e), r = ni(e, t);
  let n = r.querySelector("[data-formie-error-container], [data-formie-errors]");
  return n || (n = document.createElement("div"), n.setAttribute("data-formie-errors", "true"), $(n, e, "errors")), n.setAttribute("data-formie-error-container", "true"), t === "bottom-form" ? r.append(n) : r.prepend(n), n;
}
function ai(e, t) {
  let r = t.querySelector("[data-formie-error-message-container], [data-formie-message][data-formie-message-error]");
  return r || (r = document.createElement("div"), r.setAttribute("data-formie-error-message-container", "true"), t.appendChild(r)), r.setAttribute("data-formie-message", "true"), r.setAttribute("data-formie-message-error", "true"), $(r, e, "message", "messageError"), r.setAttribute("role", "alert"), r.setAttribute("aria-live", "polite"), r.setAttribute("aria-atomic", "true"), r;
}
function si(e, t) {
  let r = e.querySelector("[data-formie-success-container]");
  const n = ii(e, t);
  return r || (r = document.createElement("div"), r.setAttribute("data-formie-success-container", "true"), $(r, e, "successes")), t === "bottom-form" ? n.append(r) : n.prepend(r), r;
}
function li(e) {
  let t = e.querySelector("[data-formie-field-errors]");
  return t || (t = document.createElement("div"), t.setAttribute("data-formie-field-errors", "true"), $(t, e, "fieldErrors"), e.appendChild(t)), t;
}
function ui(e, t) {
  const r = (e.getAttribute("aria-describedby") || "").trim();
  if (!r)
...
function fr(e) {
  e.querySelectorAll("[data-formie-field-handle]").forEach((t) => {
    ...
    le(r, e, "fieldLayoutError"), r.removeAttribute("data-formie-field-has-error"), r.querySelectorAll("[data-formie-field-error]").forEach((a) => {
      ...
      const s = a;
      s.removeAttribute("aria-invalid"), le(s, e, "fieldControlError"), s.removeAttribute("data-formie-input-has-error"), i && ui(s, i), o.forEach((l) => {
        di(s, l);
      });
    });
  }), J(e);
...
function ct(e) {
  ri(e), e.querySelectorAll("[data-formie-message-success]:not([data-formie-success-container])").forEach((t) => {
    t.remove();
...
function fi(e, t) {
  Object.entries(t).forEach(([r, n]) => {
    ...
    if (!i)
      return;
    const o = li(i), a = o.id && o.id.trim() ? o.id : `${r}-errors`;
    o.id = a, o.setAttribute("aria-live", "polite"), o.setAttribute("aria-atomic", "true"), $(i, e, "fieldLayoutError"), i.setAttribute("data-formie-field-has-error", "true"), n.forEach((l, d) => {
      const p = document.createElement("div");
      p.setAttribute("data-formie-field-error", "true"), p.setAttribute("role", "alert"), p.id = `${a}-${d + 1}`, $(p, e, "fieldError"), p.textContent = l, o.appendChild(p);
    });
    const s = o.querySelector("[data-formie-field-error]")?.id;
    i.querySelectorAll("input, select, textarea").forEach((l) => {
      const d = l;
      d.setAttribute("aria-invalid", "true"), $(d, e, "fieldControlError"), d.setAttribute("data-formie-input-has-error", "true"), Mt(d, a), s && ci(d, s);
...
function Ct(e, t) {
  const r = oi(e), n = ai(e, r);
  $(r, e, "errors"), t.forEach((i) => {
    const o = document.createElement("div");
    o.setAttribute("data-formie-error", "true"), o.setAttribute("role", "alert"), $(o, e, "error"), o.innerHTML = i, n.appendChild(o);
  });
}
function mi(e, t) {
...
function pi(e, t) {
  ...
  if (!r)
    return;
  const n = si(e, r);
  $(n, e, "message", "messageSuccess"), n.setAttribute("data-formie-message", "true"), n.setAttribute("data-formie-message-success", "true"), n.setAttribute("role", "status"), n.setAttribute("aria-live", "polite"), n.setAttribute("aria-atomic", "true");
  const i = document.createElement("div");
  i.setAttribute("data-formie-success", "true"), $(i, e, "success"), i.innerHTML = t, n.appendChild(i), ut(e) && st(e, !0);
  const o = ti(e);
  if (o !== null) {
...
function Le(e, t) {
  if (fr(e), mr(e), ct(e), pr(e), t.ok) {
    mi(e, t) && pi(e, t.message || "");
    return;
  }
  if (t.fieldErrors && fi(e, t.fieldErrors), t.formErrors?.length) {
    Ct(e, t.formErrors);
    return;
  }
  !t.fieldErrors && t.message && Ct(e, [t.message]);
}
const gi = _("general", "submit-flow");
function hi(e) {
...
async function br(e) {
  ...
  try {
    await d(n), u = await tr(n, s, i, {
      validator: o,
      validateOnSubmit: a
    }), Le(n, u), Xn(n, u, s), hi(u) && await p(u), h(u);
  } catch (c) {
    u = {
      ok: !1,
      code: "SUBMIT_ERROR",
    ...
    }, Le(n, u), h(u), gi.warn("Submit failed with exception.", {
      id: t,
      action: s,
      target: r,
...
const bi = {
  ...
  "address-finder": () => import("./address-finder-Btvx2XGr.js").then((e) => e.addressFinderModule),
  "google-address": () => import("./google-address-D1sUzVjX.js").then((e) => e.googleAddressModule),
  loqate: () => import("./loqate-BVKoINwN.js").then((e) => e.loqateModule),
  "place-kit": () => import("./place-kit-Du-ZShyp.js").then((e) => e.placeKitModule)
}, yi = {
  ...
  "captcha-eu": () => import("./captcha-eu-CFCCq682.js").then((e) => e.captchaEuModule),
  "friendly-captcha-v1": () => import("./friendly-captcha-v1-DuI0p8Iw.js").then((e) => e.friendlyCaptchaV1Module),
  "friendly-captcha-v2": () => import("./friendly-captcha-v2-C2TeCazG.js").then((e) => e.friendlyCaptchaV2Module),
  hcaptcha: () => import("./hcaptcha-C_ZKcv0P.js").then((e) => e.hcaptchaModule),
  "recaptcha-enterprise": () => import("./recaptcha-enterprise-ZA02J1wL.js").then((e) => e.recaptchaEnterpriseModule),
  "recaptcha-v2-checkbox": () => import("./recaptcha-v2-checkbox-ewu0fHZt.js").then((e) => e.recaptchaV2CheckboxModule),
  "recaptcha-v2-invisible": () => import("./recaptcha-v2-invisible-fe-qww0K.js").then((e) => e.recaptchaV2InvisibleModule),
  "recaptcha-v3": () => import("./recaptcha-v3-Cd6csFC8.js").then((e) => e.recaptchaV3Module),
  snaptcha: () => import("./snaptcha-BEnP1F5q.js").then((e) => e.snaptchaModule),
  turnstile: () => import("./turnstile-CUYVNpfU.js").then((e) => e.turnstileModule)
}, vi = {
  ...
  calculations: () => import("./calculations-D35EGLR3.js").then((e) => e.calculationsModule),
  "checkbox-radio": () => import("./checkbox-radio-BUBDTuQC.js").then((e) => e.checkboxRadioModule),
  conditions: () => import("./conditions-Cw2aMnty.js").then((e) => e.conditionsModule),
  "date-picker": () => import("./date-picker-BODSziKP.js").then((e) => e.datePickerModule),
  "file-upload": () => import("./file-upload-vvKPBffN.js").then((e) => e.fileUploadModule),
  hidden: () => import("./hidden-DLz-_Dev.js").then((e) => e.hiddenModule),
  "phone-country": () => import("./phone-country-BcTygQgd.js").then((e) => e.phoneCountryModule),
  repeater: () => import("./repeater-6VMHpMuC.js").then((e) => e.repeaterModule),
  "rich-text": () => import("./rich-text-CMnDczR1.js").then((e) => e.richTextModule),
  signature: () => import("./signature-BkBgz9qS.js").then((e) => e.signatureModule),
  summary: () => import("./summary-CkcP4ere.js").then((e) => e.summaryModule),
  table: () => import("./table-CQeirNPp.js").then((e) => e.tableModule),
  "text-limit": () => import("./text-limit-Dju5eTqh.js").then((e) => e.textLimitModule)
}, Ei = {
  ...
  bpoint: () => import("./bpoint-Be0QJaEr.js").then((e) => e.bpointModule),
  eway: () => import("./eway-C76eVrl8.js").then((e) => e.ewayModule),
  "go-cardless": () => import("./go-cardless-A6dAAhKe.js").then((e) => e.goCardlessModule),
  mollie: () => import("./mollie-B0Sep0A3.js").then((e) => e.mollieModule),
  moneris: () => import("./moneris-0RJsEi1N.js").then((e) => e.monerisModule),
  opayo: () => import("./opayo-BOvZlUac.js").then((e) => e.opayoModule),
  paddle: () => import("./paddle-CJhPAtk9.js").then((e) => e.paddleModule),
  paypal: () => import("./paypal-DfwuhBhr.js").then((e) => e.paypalModule),
  payway: () => import("./payway-DBoOrSjO.js").then((e) => e.paywayModule),
  square: () => import("./square-CP83S4l6.js").then((e) => e.squareModule),
  stripe: () => import("./stripe-d-2Kqqpu.js").then((e) => e.stripeModule)
}, Si = {
  ...vi,
  ...bi,
  ...yi,
  ...Ei
}, _e = /* @__PURE__ */ new Map(), D = _("general", "loader"), Ai = new Function("src", "return import(src);");
...
async function Ti(e) {
  try {
    const t = await Ai(e), r = t?.default || t?.formieModule || null;
    return vr(r) ? r : null;
  } catch (t) {
...
async function Mi(e, t) {
  ...
  if (r)
    return r;
  const n = await wi(e.id, t);
  if (n)
    return n;
  if (e.src) {
    const i = await Ti(e.src);
    if (i)
...
function Lt(e) {
  const t = Array.from(new FormData(e).entries()).filter(([r]) => Ri(String(r || "")));
  return Fi(t);
}
function ki(e, t = {}) {
...
const X = '[data-formie]:not([data-formie-init="false"]), [data-formie-form]:not([data-formie-init="false"])', qi = 300, Pi = "/actions/formie/server/forms/render", It = "/api", Vi = "/actions/formie/server/forms/refresh-tokens", $i = "/actions/formie/server/submissions/submit", Hi = "/actions/formie/server/submissions/set-page", Oi = "/actions/formie/server/submissions/clear-submission", _i = "/actions/formie/file-upload/hydrate", L = _("general", "client"), Ft = /* @__PURE__ */ new Set();
function ce(e, t) {
  if (e == null || e === "")
    return t;
...
function xi(e, t) {
  return re(e.endpoint || t.dataset.formieEndpoint, Pi);
}
function Ni(e, t) {
...
function Ui(e, t, r) {
  const n = r.endpoint || e.dataset.formieEndpoint, i = re(n, $i), o = t.getAttribute("action");
  t.setAttribute("action", Rt(o, i)), t.querySelectorAll("[data-formie-tab-link]").forEach((a) => {
    const s = a.getAttribute("href"), l = re(n, Hi);
    a.setAttribute("href", Rt(s, l));
...
function Wi(e) {
  return Pt(window.location.href, "resumeToken") || Pt(e.getAttribute("action"), "resumeToken");
}
function Ki(e) {
...
function Ji(e) {
  return Math.max(0, Gi(e.dataset.formieSubmitDelay, qi));
}
function Je(e) {
...
async function Qi(e, t) {
  const r = Re(t.mode), n = ke(t.transport);
  ...
  }, s = n === "graphql" ? Ni(t, e) : xi(t, e), l = n === "graphql" ? await dn(s, o, a) : await cn(s, o, {
    ...a,
    endpoint: s
  });
...
function to() {
  const e = /* @__PURE__ */ new Map(), t = new yr(), r = /* @__PURE__ */ new Map(), n = /* @__PURE__ */ new Map(), i = [
    ...
    if (w && k) {
      ...
      I(w, "formie:validator:ready", H), I(f, "formie:validator:ready", H);
    }
    w && ((q || T.endpoint || f.dataset.formieEndpoint) && Ui(f, w, T), J(w)), Object.keys(ne).length && I(f, "formie:theme:applied", {
      hasClasses: !0
    });
    const me = await Er(fe, {
      ...
      setupContext: {
        ...
        state: Y,
        on: (C, H) => m.on(C, H),
        emit: (C, H) => (I(f, C, H), m.emitSafe(C, H).then((Z) => {
    ...
    const Pe = {
      ...
      submit: async (C = "submit") => {
        ...
        const H = w.querySelector('input[name="submitAction"]');
        if (H && (H.value = C), w.getAttribute("data-formie-loading") === "true")
          return {
            ok: !1,
    ...
    w && (Gr({
      ...
      options: F,
      unbinds: g
    })), w && (Xi(f, w, T, m, k, g), k && g.push(_n(w, k, f)), await eo(f, T, w)), i.forEach((C) => {
      const H = m.on(`formie:stage:${C}:before`, async (W) => {
    ...
    }), Or = m.on("formie:submit:final:after", async (C) => {
    ...
    if (!v.autoVisible || Yi(f) || typeof IntersectionObserver > "u")
      return a(f, v);
    if (e.has(f))
  ...
  return {
    ...
    update: async (f, v) => {
      ...
      const y = v.payload?.theme || E.options.payload?.theme || $t(f, E.form)?.theme, m = yt(f, y, E.form);
    ...
    refreshForCache: async (f) => {
      ...
      if (typeof f == "string") {
        ...
        q ? v = q : v = document.querySelector(`[data-formie-form-id="${f}"]`);
      } else
        v = f;
      if (!v) {
      ...
      const F = await nt(S, g, T);
      F && (pt(y, F), I(v, "formie:refresh-tokens:after", F));
    },
...
function io(e) {
  return typeof e == "string" ? `selector "${e}"` : qe(e) ? `element "${e.tagName.toLowerCase()}"` : "provided element collection";
}
function oo(e) {
  const t = /* @__PURE__ */ new Set(), r = [];
  for (const n of e)
    !qe(n) || t.has(n) || (t.add(n), r.push(n));
  return r;
}
function Ze(e) {
  return typeof e == "string" ? Array.from(document.querySelectorAll(e)) : qe(e) ? [e] : oo(e);
}
function ao() {
...
async function so(e) {
  const t = Ze(e);
  return t.length > 0 || typeof e != "string" ? t : (await ao(), Ze(e));
}
function lo(e) {
  return typeof e == "string" ? document : qe(e) ? e.getRootNode() : document;
}
function uo(e) {
  const {
    element: t,
...
async function Ht(e, t, r, n) {
  ...
  for (const a of n) {
    ...
    if (e.onReady?.(l), d.push(l.on("formie:submit:result", (p) => {
      const h = p;
      e.onResult?.(h, l), no(h) ? e.onSuccess?.(h, l) : e.onError?.(h, l);
    })), e.onEvent)
      for (const p of xr)
        d.push(l.on(p, (h) => {
          e.onEvent?.({
...
async function la(e) {
  const t = e.client ?? to(), r = /* @__PURE__ */ new Map(), n = await so(e.element);
  if (n.length === 0 && !e.allowEmpty)
    throw new Error(`Formie could not find any elements for ${io(e.element)}.`);
  await Ht(e, t, r, n);
  const i = e.observe ? t.observe(lo(e.element)) : null;
  return {
    client: t,
    get instances() {
    ...
    async rescan() {
      ...
      return o.length === 0 ? Array.from(r.values()).map(({ instance: a }) => a) : Ht(e, t, r, o);
    },
    async destroy() {
      i?.();
...
const gt = 2e3, ua = 5e3, ca = 5e3, da = 12e4;
async function ht(e) {
  await new Promise((t) => {
...
const fo = /* @__PURE__ */ new Set([
  ...
  "sessionKey",
  "value"
]), mo = "[data-formie-captcha-error-container]", po = [
  "formie:page:navigate",
  "formie:page:navigate:after",
  "formie:submit:result"
];
...
function ho(e, t, r) {
  ...
  n.setAttribute("data-formie-captcha-error-container", ""), n.setAttribute("aria-live", "polite"), n.setAttribute("aria-atomic", "true"), $(n, r || e, "fieldErrors");
  const i = document.createElement("div");
  i.setAttribute("data-formie-captcha-error", ""), i.setAttribute("role", "alert"), $(i, r || e, "fieldError"), i.textContent = t, n.appendChild(i), e.appendChild(n);
}
function bo(e) {
...
function Ao(e, t) {
  ...
  return {
    ...
    placeholder: {
      ...
      observe: (o, a) => vo(e.root, n, o, a),
      createContainer: (o) => go(o),
      clear: (o) => {
        o && (et(o), o.innerHTML = "");
      }
    },
    errors: {
      ...
      show: (o, a) => {
        ho(a || Ne(e.root, n), o || t.ui.errorMessage, e.form || e.root);
      },
      clear: (o) => {
        et(o || Ne(e.root, n));
      }
...
function To(e) {
  return Ir({
    ...
    setup: async (t) => {
      ...
      })), t.form && r.push(t.services.events.onForm(Be("reset"), () => {
...
function Io(e, t) {
  const r = Lo(t), n = Array.from(e.querySelectorAll(`[name="${r}"]`)), i = Array.from(e.querySelectorAll(`[name="${r}[]"]`));
...
function de(e) {
  return Fo(e).replace(/\]/g, "").split("[").join(".").replace(/\.+/g, ".").replace(/^\./, "").replace(/\.$/, "");
}
function Fr(e) {
...
function Rr(e) {
  ...
  const n = (r[1] || "").trim().toLowerCase(), i = (r[2] || "").trim(), [o, a = ""] = i.split("|", 2), { source: s, transforms: l } = ko(o || "");
  if (n !== "field")
    return {
      raw: t,
      target: "",
...
function Vo(e) {
  ...
  return Array.from(e.querySelectorAll("[name]")).filter((n) => qo(n)).forEach((n) => {
    const i = Ro(n.name);
    i && Po(t, i, n);
  }), t;
}
...
function ha(e, t, r) {
  ...
  const o = r ? kr(r, i) : null, s = (o?.names?.length ? o.names : [Fr(i)]).flatMap((l) => {
...
function Do(e, t, r) {
  const n = t || {}, i = Object.entries(n).reduce((l, [d, p]) => (Oo.has(d) || (l[d] = p), l), {}), o = Array.isArray(n.requiredInputSuffixes) ? n.requiredInputSuffixes.map(String).filter(Boolean) : r.defaultRequiredInputSuffixes || [], a = Number(n.waitForValueMs ?? r.defaultWaitForValueMs ?? Ot), s = typeof n.errorMessage == "string" && n.errorMessage.trim() !== "" ? n.errorMessage.trim() : "Payment authorization is incomplete.";
  return {
    handle: _o(e, n),
    transport: {
      requiredInputSuffixes: o,
      waitForValueMs: Number.isFinite(a) ? a : Ot,
      errorMessage: s
    },
    provider: i
  };
...
function xo(e, t) {
  const r = e.target, n = e.form, i = e.root, o = n || i, a = t.transport.requiredInputSuffixes, s = () => Vo(n || i), l = (y) => {
    const g = Ho(y, s()).value;
  ...
  return {
    ...
    addError: (y) => {
      ...
      S.setAttribute("data-payment-error", ""), S.textContent = y, $(S, n || i, "fieldError"), m.appendChild(S);
    },
    removeError: () => {
    ...
    addSuccess: (y) => {
      ...
      g && g.remove();
      const S = document.createElement("div");
      S.setAttribute("data-payment-success", ""), S.textContent = y, $(S, n || i, "successMessage"), m.appendChild(S);
    },
    removeSuccess: () => {
      r.querySelector(Dt)?.remove();
    },
    hasToken: () => Ae(o, a).ok,
    waitForToken: (y = t.transport.waitForValueMs) => Pr(o, a, y).then((m) => m.ok),
    getFieldValue: (y, m = "string") => {
      const g = l(y);
      return m === "float" || m === "int" || m === "number" ? Ue(g) : g;
    },
    resolveAmount: (y) => {
      const m = n || i, S = String(y.type || "").toLowerCase() === "dynamic" && typeof y.variable == "string" && y.variable.trim() !== "", M = y.value ?? (S ? y.variable : y.fixed), T = String(M ?? "").trim(), F = typeof M == "number" ? M : Ue(T);
      ...
      if (T !== "") {
        ...
        if (!q)
          return {
            ok: !1,
            error: P ? x('Provide a value for "{label}" to proceed.', { label: P }) : x("Provide a payment amount to proceed.")
          };
      }
      return {
        ok: !1,
    ...
    resolveCurrency: (y) => {
      const m = n || i, S = String(y.type || "").toLowerCase() === "dynamic" && typeof y.variable == "string" && y.variable.trim() !== "", M = y.value ?? (S ? y.variable : y.fixed ?? y.defaultCurrency ?? ""), T = String(M ?? "").trim(), F = T.toUpperCase();
      if (/^[A-Z]{3}$/.test(F) && !S)
        return { ok: !0, value: F };
      if (T !== "") {
        const q = String(l(T) || "").trim(), w = q.toUpperCase();
        if (/^[A-Z]{3}$/.test(w))
          return { ok: !0, value: w };
        const P = _t(m, T);
        if (!q)
          return {
            ok: !1,
            error: P ? x('Provide a value for "{label}" to proceed.', { label: P }) : x("Provide a payment currency to proceed.")
          };
      }
      return {
        ok: !1,
    ...
    watchFieldValueChanges: (y, m, g = 600) => {
      const S = n || i, M = y.map((P) => String(P || "").trim()).filter(Boolean);
      if (M.length === 0)
        return () => {
        };
      const T = s(), F = /* @__PURE__ */ new Set();
      M.forEach((P) => {
        const N = de(P), j = T.get(N);
        if (j?.names?.length) {
          j.names.forEach((fe) => {
            F.add(fe);
          });
    ...
    getBillingData: (y) => {
      ...
      if (y.billingAddress) {
        const g = y.billingAddress, S = {}, M = l(`${g}.address1`), T = l(`${g}.address2`), F = l(`${g}.address3`), q = l(`${g}.city`), w = l(`${g}.zip`), P = l(`${g}.state`), N = l(`${g}.country`);
        M && (S.line1 = M), T && (S.line2 = T), F && (S.line3 = F), q && (S.city = q), w && (S.postal_code = w), P && (S.state = P), N && (S.country = N), Object.keys(S).length && (m.address = S);
      }
      return { billing_details: m };
    },
    events: {
...
function No(e) {
  const t = e.defaultRequiredInputSuffixes ?? Mo[e.id] ?? [];
  return {
    id: e.id,
    kind: "payment",
      ...
      return i[e.id] = { destroy: v }, {
        ...
        onBeforeStage: async (E) => {
          ...
          if (a.transport.requiredInputSuffixes.length === 0)
            return;
          const S = r.form || r.root, M = await Pr(
            S,
...
const ba = No, Uo = "[data-formie-address-autocomplete-input]", zt = "[data-formie-address-location]", zo = {
...
}, Bo = /* @__PURE__ */ new Set(["handle"]);
function jo(e, t) {
  return (typeof t.handle == "string" && t.handle.trim() !== "" ? t.handle.trim() : "") || e;
}
function Wo(e, t) {
  const r = t || {}, n = Object.entries(r).reduce((i, [o, a]) => (Bo.has(o) || (i[o] = a), i), {});
  return {
    handle: jo(e, r),
    provider: n
  };
...
function Go(e) {
  const t = e.target, r = e.form, n = e.root, i = Uo;
  return {
    root: n,
    field: t,
    form: r,
    input: {
      ...
      setValue: (o, a, s) => {
        const l = zo[o], d = t.querySelector(l);
        d && (d.value = a || s || "");
      }
    },
    location: {
      getButton: () => t.querySelector(zt),
      onUseLocation: (o) => {
        const a = t.querySelector(zt);
        if (!a)
          return () => {
          };
        const s = (l) => {
...
function Jo(e) {
  return {
    ...
    setup: async (t) => {
      const r = Wo(e.id, t.options || {}), n = Go(t);
      te.log("Setup module.", {
        moduleId: e.id
      });
      const i = {
      ...
      Bt(t.target) && await p(), ["formie:page:navigate:after", "formie:submit:result"].forEach((c) => {
        const b = () => {
          p();
        };
