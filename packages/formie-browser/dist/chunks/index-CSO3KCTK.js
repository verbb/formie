...
const wi = {
  ...
  "address-finder": () => import("./address-finder-DlHRvbkk.js").then((e) => e.addressFinderModule),
  "google-address": () => import("./google-address-C5845tZm.js").then((e) => e.googleAddressModule),
  loqate: () => import("./loqate-ClABtHja.js").then((e) => e.loqateModule),
  "place-kit": () => import("./place-kit-B-xO3vID.js").then((e) => e.placeKitModule)
}, Ti = {
  ...
  "captcha-eu": () => import("./captcha-eu-0mJ94FaD.js").then((e) => e.captchaEuModule),
  "friendly-captcha-v1": () => import("./friendly-captcha-v1-D4VE7N4P.js").then((e) => e.friendlyCaptchaV1Module),
  "friendly-captcha-v2": () => import("./friendly-captcha-v2-vebA49Dm.js").then((e) => e.friendlyCaptchaV2Module),
  hcaptcha: () => import("./hcaptcha-B86eeAxQ.js").then((e) => e.hcaptchaModule),
  "recaptcha-enterprise": () => import("./recaptcha-enterprise-BHCX-rPy.js").then((e) => e.recaptchaEnterpriseModule),
  "recaptcha-v2-checkbox": () => import("./recaptcha-v2-checkbox-B6KBY7Vg.js").then((e) => e.recaptchaV2CheckboxModule),
  "recaptcha-v2-invisible": () => import("./recaptcha-v2-invisible-De09eoOr.js").then((e) => e.recaptchaV2InvisibleModule),
  "recaptcha-v3": () => import("./recaptcha-v3-CIrj9_O3.js").then((e) => e.recaptchaV3Module),
  snaptcha: () => import("./snaptcha-DHL_hZha.js").then((e) => e.snaptchaModule),
  turnstile: () => import("./turnstile-D9gw8_hW.js").then((e) => e.turnstileModule)
}, Mi = {
  ...
  calculations: () => import("./calculations-CfJFqCBm.js").then((e) => e.calculationsModule),
  "checkbox-radio": () => import("./checkbox-radio-BsZuXRcc.js").then((e) => e.checkboxRadioModule),
  conditions: () => import("./conditions-C0guStc2.js").then((e) => e.conditionsModule),
  "date-picker": () => import("./date-picker-IR8u5rUj.js").then((e) => e.datePickerModule),
  "file-upload": () => import("./file-upload-Cqr56V4p.js").then((e) => e.fileUploadModule),
  hidden: () => import("./hidden-BUAi3-40.js").then((e) => e.hiddenModule),
  "phone-country": () => import("./phone-country-C4MX8qfw.js").then((e) => e.phoneCountryModule),
  repeater: () => import("./repeater-DINWXoHz.js").then((e) => e.repeaterModule),
  "rich-text": () => import("./rich-text-DE1tXye4.js").then((e) => e.richTextModule),
  signature: () => import("./signature-B9472D15.js").then((e) => e.signatureModule),
  summary: () => import("./summary-BgS68-Xt.js").then((e) => e.summaryModule),
  table: () => import("./table-JP94Noma.js").then((e) => e.tableModule),
  "text-limit": () => import("./text-limit-6A3-FrBG.js").then((e) => e.textLimitModule)
}, Ci = {
  ...
  bpoint: () => import("./bpoint-Z7q14JXe.js").then((e) => e.bpointModule),
  eway: () => import("./eway-qmBntcwX.js").then((e) => e.ewayModule),
  "go-cardless": () => import("./go-cardless-Sx-Q6NdM.js").then((e) => e.goCardlessModule),
  mollie: () => import("./mollie-DaDJh7Vq.js").then((e) => e.mollieModule),
  moneris: () => import("./moneris-D86Rykrg.js").then((e) => e.monerisModule),
  opayo: () => import("./opayo-CAzX4z5W.js").then((e) => e.opayoModule),
  paddle: () => import("./paddle-Cp_XavRi.js").then((e) => e.paddleModule),
  paypal: () => import("./paypal-DZc4p3hp.js").then((e) => e.paypalModule),
  payway: () => import("./payway-C5AQkzWm.js").then((e) => e.paywayModule),
  square: () => import("./square-rSfGlhvZ.js").then((e) => e.squareModule),
  stripe: () => import("./stripe-DQ578jU8.js").then((e) => e.stripeModule)
}, Li = {
  ...Mi,
  ...wi,
  ...Ti,
