...
var k = "FrcFrameId", A = "frc-i-agent", oe = "frc-i-widget", se = "frc-widget-placeholder";
function ce(e, t, n) {
	let i = {
	...
	a.className = A, a.dataset[k] = t, a.src = n + "?" + r(i), a.frcSDK = e;
	let o = a.style;
	return o.width = o.height = o.border = o.visibility = "0", o.display = "none", a;
}
function le(e, t, n, i) {
	let a = document.createElement("iframe"), o = M(i), s = {
		origin: document.location.origin,
		sess_id: g(),
		sess_c: h(!0),
		comm_id: t,
	...
	i.theme && (s.theme = i.theme), v && (a.allow = "clipboard-write"), a.frameBorder = "0", a.src = n + "?" + r(s), a.className = oe, a.title = ae(o), a.dataset[k] = t;
	let c = a.style;
...
function ue(e) {
	...
	return n.color = r ? "#fff" : "#222", n.backgroundColor = r ? "#171717" : "#fafafa", n.borderRadius = "4px", n.border = "1px solid", n.borderColor = "#ddd", n.padding = "8px", n.height = n.width = "100%", n.fontSize = "14px", n.boxSizing = "border-box", j(n), e.element.appendChild(t), t;
}
function j(e) {
...
function de(e) {
	...
	let n = M(e), r = e.theme === "dark" || e.theme === "auto" && window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches, i = "#565656", a = "#a2a2a2";
	r && (i = "#a2a2a2", a = "#565656");
	let o = t.style;
...
function fe(e, t, n) {
	let r = (e, t) => {
		...
		let r = n.style;
		return j(r), r.textDecoration = "underline", r.color = "#565656", n.onmouseenter = () => r.textDecoration = "none", n.onmouseleave = () => r.textDecoration = "underline", n;
...
function pe(e, t, n, r) {
	let i = N(), a = n.getBoundingClientRect(), o = {
		v: 1,
		tt: e,
		pnow: i,
		sm: t,
...
var me = "frc-captcha-response", he = class {
	constructor(e) {
		...
		this.e.frcWidget = this, this.formFieldName = t.formFieldName === void 0 ? me : t.formFieldName, this.sitekey = t.sitekey, this._reset = e.callbacks.onReset, this._destroy = e.callbacks.onDestroy, this._trigger = e.callbacks.onTrigger, this.startMode = e.createOpts.startMode || "focus", this.formFieldName !== null && (this.hiddenFormEl = S(this.e, this.formFieldName)), this.setState({
...
var I = "addEventListener", L = Math, ve;
function R() {
...
function ye(e) {
	let t = [];
	for (let n = 0; n < e.length; n++) t.push(0), document[I](e[n], (e) => t[n]++);
	return t;
}
function be() {
	let e = [
	...
	return document[I]("keydown", (n) => {
		let r = n.keyCode;
		t[r] ? e[t[r]]++ : r >= 112 && r <= 123 && e[0]++;
	}), e;
}
function B(e, t, n, r) {
	return L.sqrt(L.pow(e - t, 2) + L.pow(n - r, 2));
}
function V(e, t, n) {
	return L.sqrt(L.pow(e, 2) + L.pow(t, 2) + L.pow(n, 2));
}
function H(e, t) {
	let n = t - e;
...
var xe = class {
	constructor(e) {
		...
		C(() => {
			let e = r.body;
			e[I]("mouseenter", n), e[I]("mouseleave", n);
		}), this.bh = {
			onoff: {
				kdu: z("keydown", "keyup"),
				cse: z("compositionstart", "compositionend"),
				mdu: z("mousedown", "mouseup"),
				mle: z("mouseleave", "mouseenter"),
				med: z("mouseenter", "mousedown", !0),
				semd: z("scrollend", "mousedown", !0, r),
				se: z("scroll", "scrollend", !1, r),
				pdc: z("pointerdown", "pointercancel", !0),
				mmc: z("mousemove", "click", !0),
	...
	setupMovementMetrics() {
		let e, t = [], n = F(), r = F(), i = F(), a = {
			...
			if (t.length >= 1e4 / 50 || o && (o[0] && this.tm.timeStamp === o[1] || !o[0] && this.mm.timeStamp === o[1])) {
				...
				let s = t[0];
				n.add(o[1] - s[1]), r.add(B(o[2], s[2], o[3], s[3]));
				for (let e = 1; e < t.length; e++) {
					let n = t[e], r = t[e - 1], a = B(n[2], r[2], n[3], r[3]) * 1e3, o = n[1] - r[1];
					i.add(a / o);
				}
				t = [];
				return;
	...
	setupOrientationMetrics() {
		...
		if (!R()) return n;
		let r;
		return window[I]("deviceorientation", (i) => {
			i.gamma == null || i.beta == null || i.alpha == null || (n.ts = i.timeStamp, n.a = i.alpha, n.b = i.beta, n.g = i.gamma, r ? (e.add(H(i.gamma, n.g)), t.add(H(n.b, i.beta))) : (n.fts = n.ts, r = !0));
		}), n;
	}
	gmm() {
		let e = this.mm;
...
var U = (e) => e.map((e) => `https://${e}.frcapi.com`).join(","), W = {
	eu: U([
		"eu",
		"eu0",
		"eu1"
...
}, G = (e) => e.split(",").map((e) => e.trim()).filter((e) => !!e), Ce = (e) => G(W[e] || e);
function K(e) {
	let t = G(e || W.global).reduce((e, t) => e.concat(Ce(t)), []).map(i);
	return t.length > 0 ? t : G(W.global).map(i);
}
function we() {
...
var Oe = "frc-risk-intelligence-token", ke = class {
	constructor(e) {
		...
		this.e.frcRiskIntelligence = this, this.formFieldName = e.formFieldName === void 0 ? Oe : e.formFieldName, this.formFieldName !== null && (this.hiddenFormEl = S(this.e, this.formFieldName)), this.startMode = e.startMode || "focus", this.requestRiskIntelligence = e.riskIntelligence, this.handleStartMode();
	}
	handleStartMode() {
...
var je = "/api/v2/captcha/agent", Me = "/api/v2/captcha/widget", Z = "FrcFrameId", Ne = "FrcAgentOriginKey", Pe = 1e3 * 60 * 60 * 36, Fe = 5, Q, $ = 0, Ie = class {
	constructor(t = {}) {
		if (this.agents = /* @__PURE__ */ new Map(), this.agentState = /* @__PURE__ */ new Map(), this.widgets = /* @__PURE__ */ new Map(), this._attached = e(), this.attached = this._attached.promise, this.riskIntelligencePromises = /* @__PURE__ */ new Map(), this.clearRiskIntelligencePromises = /* @__PURE__ */ new Map(), this.riskIntelligenceHandles = [], this.apiEndpoint = t.apiEndpoint, Q ||= new s(), Q.listen((e) => this.onReceiveMessage(e)), this.bus = Q, $++, $ > 1 && console.warn("Multiple Friendly Captcha SDKs created, this is not recommended. Please use a single SDK instance."), this.signals = Se({ disableEvalPatching: t.disableEvalPatching || we() }), t.startAgent) {
			let e = K(this.apiEndpoint || q()), t = this.getRetryOrigins(e);
	...
	ensureAgentIFrame(e) {
		let t = 1, n = e[Y(t, e)], r = n + je, i = Fe, a = this.agents.get(n);
		if (a && a.dataset[Z]) return a.dataset[Z];
		let o = document.getElementsByClassName(A);
		for (let e = 0; e < o.length; e++) {
			let t = o[e];
			if (t.dataset[Ne] === n && t.dataset[Z]) return this.agents.set(n, t), t.dataset[Z];
		}
		...
		let f = () => {
			this.bus.registerTargetIFrame("agent", s, l, this.getRetryTimeout(t)).then((r) => {
				if (r === "timeout") {
					...
					let r = t + 1;
					d = e[Y(r, e)] || d, console.warn("[Friendly Captcha] Retrying agent iframe load."), l.src = X(u, d, r - 1), t = r, f();
				}
			});
		};
		return f(), s;
	...
	createWidget(t) {
		let n = K(t.apiEndpoint || this.apiEndpoint || q()), r = this.getRetryOrigins(n), a = 1;
		...
		let m = le(s, l, o + Me, t), h = Fe, g = m.src, _ = o, v = ue(t);
		te(t.element), de(t);
		let y = M(t);
		...
		let S = () => {
			this.bus.registerTargetIFrame("widget", l, m, this.getRetryTimeout(a)).then((e) => {
				if (e === "timeout") {
					...
					let e = a + 1, t = Y(e, r);
					_ = r[t] || _, b.backgroundColor = "#fee", b.color = "#222", v.textContent = O(y, "retrying") + ` (${a})`, console.warn(`[Friendly Captcha] Retrying widget ${l} iframe load.`), x("Widget load timeout, will retry"), m.src = X(g, _, e - 1), a = e, S();
	...
	riskIntelligence(t) {
		let n = K(t.apiEndpoint || this.apiEndpoint || q()), r = this.getRetryOrigins(n);
		this.bus.addOrigins(n);
...
}, Le = "frc:widget.statechange", Re = "frc:widget.complete", ze = "frc:widget.expire", Be = "frc:widget.error", Ve = "frc:widget.reset", He = "frc:riskintelligence.complete", Ue = "frc:riskintelligence.error", We = "frc:riskintelligence.expire";
//#endregion
export { He as FRCRiskIntelligenceCompleteEventName, Ue as FRCRiskIntelligenceErrorEventName, We as FRCRiskIntelligenceExpireEventName, Re as FRCWidgetCompleteEventName, Be as FRCWidgetErrorEventName, ze as FRCWidgetExpireEventName, Ve as FRCWidgetResetEventName, Le as FRCWidgetStateChangeEventName, Ie as FriendlyCaptchaSDK };
