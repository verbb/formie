...
const bi = {
  ...
  "address-finder": () => import("./address-finder-vAET5TLA.js").then((e) => e.addressFinderModule),
  "google-address": () => import("./google-address-Cma6rTpZ.js").then((e) => e.googleAddressModule),
  loqate: () => import("./loqate-CPfm4PWZ.js").then((e) => e.loqateModule),
  "place-kit": () => import("./place-kit-D_-XYzYT.js").then((e) => e.placeKitModule)
}, yi = {
  ...
  "captcha-eu": () => import("./captcha-eu-DDflcLHB.js").then((e) => e.captchaEuModule),
  "friendly-captcha-v1": () => import("./friendly-captcha-v1-BYSXhNVS.js").then((e) => e.friendlyCaptchaV1Module),
  "friendly-captcha-v2": () => import("./friendly-captcha-v2-BGu8VVhe.js").then((e) => e.friendlyCaptchaV2Module),
  hcaptcha: () => import("./hcaptcha-oWNxH4LZ.js").then((e) => e.hcaptchaModule),
  "recaptcha-enterprise": () => import("./recaptcha-enterprise-98amVDFC.js").then((e) => e.recaptchaEnterpriseModule),
  "recaptcha-v2-checkbox": () => import("./recaptcha-v2-checkbox-BW8dx1SX.js").then((e) => e.recaptchaV2CheckboxModule),
  "recaptcha-v2-invisible": () => import("./recaptcha-v2-invisible-CFMst5dU.js").then((e) => e.recaptchaV2InvisibleModule),
  "recaptcha-v3": () => import("./recaptcha-v3-Dij_ZS7n.js").then((e) => e.recaptchaV3Module),
  snaptcha: () => import("./snaptcha-DJbsw-8R.js").then((e) => e.snaptchaModule),
  turnstile: () => import("./turnstile-C1Yf0UZO.js").then((e) => e.turnstileModule)
}, vi = {
  ...
  calculations: () => import("./calculations-BWaZApw2.js").then((e) => e.calculationsModule),
  "checkbox-radio": () => import("./checkbox-radio-De22EH0I.js").then((e) => e.checkboxRadioModule),
  conditions: () => import("./conditions-CsZaCwc2.js").then((e) => e.conditionsModule),
  "date-picker": () => import("./date-picker-B_jAp2Z7.js").then((e) => e.datePickerModule),
  "file-upload": () => import("./file-upload-CCN89DGY.js").then((e) => e.fileUploadModule),
  hidden: () => import("./hidden-CncME0c6.js").then((e) => e.hiddenModule),
  "phone-country": () => import("./phone-country-BGLYPeyn.js").then((e) => e.phoneCountryModule),
  repeater: () => import("./repeater-Be8xHbA1.js").then((e) => e.repeaterModule),
  "rich-text": () => import("./rich-text-C5tEkpZu.js").then((e) => e.richTextModule),
  signature: () => import("./signature-HZ44y6Ec.js").then((e) => e.signatureModule),
  summary: () => import("./summary-B0tTWx9y.js").then((e) => e.summaryModule),
  table: () => import("./table-CZ_HNqnp.js").then((e) => e.tableModule),
  "text-limit": () => import("./text-limit-5rj7Cf-6.js").then((e) => e.textLimitModule)
}, Ei = {
  ...
  bpoint: () => import("./bpoint-BkOhpyIz.js").then((e) => e.bpointModule),
  eway: () => import("./eway-B4SqXn5G.js").then((e) => e.ewayModule),
  "go-cardless": () => import("./go-cardless-BI_s02kh.js").then((e) => e.goCardlessModule),
  mollie: () => import("./mollie-g7__2x5y.js").then((e) => e.mollieModule),
  moneris: () => import("./moneris-BUAJ_oKV.js").then((e) => e.monerisModule),
  opayo: () => import("./opayo-BdL2enj4.js").then((e) => e.opayoModule),
  paddle: () => import("./paddle-BRJF5DMF.js").then((e) => e.paddleModule),
  paypal: () => import("./paypal-MD1_YRe4.js").then((e) => e.paypalModule),
  payway: () => import("./payway-BmV32oUY.js").then((e) => e.paywayModule),
  square: () => import("./square-DAW0c82M.js").then((e) => e.squareModule),
  stripe: () => import("./stripe-7B7mH29D.js").then((e) => e.stripeModule)
}, Si = {
  ...vi,
  ...bi,
  ...yi,
