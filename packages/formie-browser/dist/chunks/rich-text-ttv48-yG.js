import { g as j, d as M } from "./shared-BDEKVuB5.js";
import { e as q } from "./styles-C3aqgtek.js";
var b = { exports: {} }, R = b.exports, T;
function O() {
  return T || (T = 1, (function(o, r) {
    (function(d, a) {
      a(r);
    })(R, function(d) {
      var a = Object.assign || function(e) {
        ...
        return e;
      }, s = "defaultParagraphSeparator", f = "formatBlock", h = function(e, c, u) {
        ...
        e && i("insertImage", e);
      } } }, S = { actionbar: "pell-actionbar", button: "pell-button", content: "pell-content", selected: "pell-button-selected" }, B = function(e) {
        var c = e.actions ? e.actions.map(function(t) {
          return typeof t == "string" ? v[t] : v[t.name] ? a({}, v[t.name], t) : t;
        }) : Object.keys(v).map(function(t) {
          return v[t];
        }), u = a({}, S, e.classes), g = e[s] || "div", C = y("div");
        C.className = u.actionbar, k(e.element, C);
        ...
        return l.contentEditable = !0, l.className = u.content, l.oninput = function(t) {
          ...
          m && m.nodeType === 3 ? i(f, "<" + g + ">") : l.innerHTML === "<br>" && (l.innerHTML = ""), e.onChange(l.innerHTML);
        }, l.onkeydown = function(t) {
          var m;
          t.key === "Enter" && (m = f, document.queryCommandValue(m) === "blockquote") && setTimeout(function() {
            return i(f, "<" + g + ">");
          }, 0);
...
function ae(o) {
  ...
  return r.map((a) => d.find((s) => s.name === a)).filter((a) => !!a);
}
function se(o, r, d) {
  const a = {
    element: o,
    ...
    onChange: (f) => {
      const h = "<p><br></p>";
      r.value = r.placeholder && f === h ? "" : f, r.dispatchEvent(new Event("input", { bubbles: !0 })), M(r, w, "populate", {
        richText: r,
        value: r.value
      });
    },
  ...
  const s = p.init(a);
  return r.richText = s, s.content.innerHTML = r.value || "", r.placeholder && s.content.setAttribute("data-placeholder", r.placeholder), M(r, w, "after-init", {
    richText: s
  }), () => {
...
const ce = {
  ...
  setup: async (o) => {
    const r = o.options || {}, a = j(o).map((s) => {
      const f = s.querySelector(E), h = s.querySelector(L);
      return !(f instanceof HTMLElement) || !(h instanceof HTMLTextAreaElement) ? () => {
      } : se(f, h, r);
    });
