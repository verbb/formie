...
import { i as t, r as n, t as r } from "./constants-DVcJAvc5.js";
//#region src/js/modules/address/host.ts
var i = /* @__PURE__ */ new Set(["handle"]);
function a(e, t) {
...
function c(e) {
	let i = e.target, a = e.form, o = e.root, c = n;
	return {
		root: o,
		field: i,
		form: a,
		input: {
			...
			setValue: (e, n, r) => {
				...
				if (!a) return;
				let o = n || r || "";
				a.value !== o && (a.value = o, a.dispatchEvent(new Event("input", { bubbles: !0 })), a.dispatchEvent(new Event("change", { bubbles: !0 })));
			}
		},
		location: {
			getButton: () => i.querySelector(r),
			onUseLocation: (e) => {
				let t = i.querySelector(r);
				if (!t) return () => {};
				let n = (t) => {
