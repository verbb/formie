...
import { a as n, o as r } from "./dist-FkODFcm-.js";
import { n as i } from "./shared-Bx9s0i0P.js";
...
function ne(e) {
	let t = Array.from(e.querySelectorAll(S)).filter((e) => te(e)).length;
	if (t > 0) {
		let n = String(t);
...
function D(e) {
	let t = e.closest(x);
	for (; t;) ne(t), t = t.parentElement?.closest(x) || null;
}
function O(e, t, n, r = {}) {
	if (r.displayMode === "muted") return re(e, t);
	let i = !1;
	return (e.hasAttribute(g) || e.classList.contains(m) || e.classList.contains(h)) && (T(e), i = !0), i = w(e, t) || i, ee(e, t), D(e), t && n && i && C(e), i;
}
function re(e, t) {
	let n = !1;
...
var k = "input, select, textarea", ie = "[data-formie-repeater-item], [data-formie-table-row]";
function A(e) {
...
function M(e) {
	return Array.from(e.querySelectorAll(k)).filter((e) => A(e));
}
function N(e) {
...
function F(e, t) {
	if (!t) return e;
	let n = e.filter((e) => P(e, t));
	return n.length ? n : e;
}
function I(e, t) {
	let n = j(e);
	if (!n) return t;
	let r = t.filter((e) => j(e) === n);
	return r.length ? r : t;
}
function L(e) {
...
function R(e, n, r) {
	...
	if (s.length) return I(n, s).flatMap((e) => F(M(e), a.selector));
	let c = i(t(a.handle)), l = Array.from(e.querySelectorAll(`[name="${c}"]`)).filter((e) => A(e)), u = Array.from(e.querySelectorAll(`[name="${c}[]"]`)).filter((e) => A(e));
	if (l.length || u.length) return I(n, [...l, ...u]);
	if (!a.handle.includes("__ROW__")) return [];
	let d = ae(n);
	if (d) {
		let n = i(t(a.handle.replace(/__ROW__/g, d))), r = Array.from(e.querySelectorAll(`[name="${n}"]`)).filter((e) => A(e)), o = Array.from(e.querySelectorAll(`[name="${n}[]"]`)).filter((e) => A(e));
		if (r.length || o.length) return [...r, ...o];
	}
	let f = t(a.handle).replace(/[.*+?^${}()|[\]\\]/g, "\\$&").replace(/__ROW__/g, "\\d+"), p = new RegExp(f);
	return Array.from(e.querySelectorAll("[name]")).filter((e) => A(e) && p.test(e.getAttribute("name") || ""));
}
//#endregion
...
function q(e, t) {
	if (!t) return e;
	let n = t.transformerId ? e.map((e) => K(e, t)) : e;
...
function ce(e, t = null) {
	...
	return e.forEach((e, t) => {
		let r = oe(e, t), i = n.get(r) || [];
		i.push(e), n.set(r, i);
	}), q(Array.from(n.values()).flatMap((e) => se(e, t?.selector || "")), t);
}
//#endregion
...
function X(e) {
	return e.length ? e.some((e) => le(e)) : null;
}
function ue(e, t) {
	return n(e, e.conditions.map((e) => {
		let n = t(e);
		return r(e, ce(n, L(e)), { visibility: X(n) });
	}));
}
//#endregion
...
var de = {
	...
	setup: async (e) => {
		...
		let n = [], r = [], i = !1, a = !1, o = () => {
			...
			let n = !1;
			return r.forEach((r) => {
				let i = ue(r.settings, (e) => R(t, r.node, e)), a = r.node.hasAttribute("data-formie-page") ? "hide" : u, o = O(r.node, i.shouldHide, r.settings.clearOnHide, { displayMode: a });
