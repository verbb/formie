...
const ui = {
  ...
  "address-finder": () => import("./address-finder-CQW81kY0.js").then((e) => e.addressFinderModule),
  "google-address": () => import("./google-address-BcTBncyS.js").then((e) => e.googleAddressModule),
  loqate: () => import("./loqate-nXuTX7In.js").then((e) => e.loqateModule),
  "place-kit": () => import("./place-kit-Dg6f_UoM.js").then((e) => e.placeKitModule)
}, ci = {
  ...
  "captcha-eu": () => import("./captcha-eu-DIa6aUWz.js").then((e) => e.captchaEuModule),
  "friendly-captcha-v1": () => import("./friendly-captcha-v1-DA2QPKA3.js").then((e) => e.friendlyCaptchaV1Module),
  "friendly-captcha-v2": () => import("./friendly-captcha-v2-BorOWiz_.js").then((e) => e.friendlyCaptchaV2Module),
  hcaptcha: () => import("./hcaptcha-BchdVCqq.js").then((e) => e.hcaptchaModule),
  "recaptcha-enterprise": () => import("./recaptcha-enterprise--VYAeeqz.js").then((e) => e.recaptchaEnterpriseModule),
  "recaptcha-v2-checkbox": () => import("./recaptcha-v2-checkbox-atBNe5ml.js").then((e) => e.recaptchaV2CheckboxModule),
  "recaptcha-v2-invisible": () => import("./recaptcha-v2-invisible-DnBufNPT.js").then((e) => e.recaptchaV2InvisibleModule),
  "recaptcha-v3": () => import("./recaptcha-v3-CF6O8rDj.js").then((e) => e.recaptchaV3Module),
  snaptcha: () => import("./snaptcha-C7qQo02f.js").then((e) => e.snaptchaModule),
  turnstile: () => import("./turnstile-_uCRwnU-.js").then((e) => e.turnstileModule)
}, di = {
  ...
  calculations: () => import("./calculations-BqZsENCq.js").then((e) => e.calculationsModule),
  "checkbox-radio": () => import("./checkbox-radio-BI-UjgMF.js").then((e) => e.checkboxRadioModule),
  conditions: () => import("./conditions-BVl6jTYo.js").then((e) => e.conditionsModule),
  "date-picker": () => import("./date-picker-69TgvErA.js").then((e) => e.datePickerModule),
  "file-upload": () => import("./file-upload-BDZZftgL.js").then((e) => e.fileUploadModule),
  hidden: () => import("./hidden-D8RqSPt7.js").then((e) => e.hiddenModule),
  "phone-country": () => import("./phone-country-K9pYAlzM.js").then((e) => e.phoneCountryModule),
  repeater: () => import("./repeater-CB7Yojvx.js").then((e) => e.repeaterModule),
  "rich-text": () => import("./rich-text-nAV_SQZo.js").then((e) => e.richTextModule),
  signature: () => import("./signature-BT6CsQ6n.js").then((e) => e.signatureModule),
  summary: () => import("./summary-DC_ipXCU.js").then((e) => e.summaryModule),
  table: () => import("./table-BEAI99qo.js").then((e) => e.tableModule),
  "text-limit": () => import("./text-limit-Blgq5G-G.js").then((e) => e.textLimitModule)
}, fi = {
  ...
  bpoint: () => import("./bpoint-D8OjLmsn.js").then((e) => e.bpointModule),
  eway: () => import("./eway-1GPxH6DU.js").then((e) => e.ewayModule),
  "go-cardless": () => import("./go-cardless-DwBgERcA.js").then((e) => e.goCardlessModule),
  mollie: () => import("./mollie-qdCynQCd.js").then((e) => e.mollieModule),
  moneris: () => import("./moneris-BNEA-laO.js").then((e) => e.monerisModule),
  opayo: () => import("./opayo-BJtXOkuK.js").then((e) => e.opayoModule),
  paddle: () => import("./paddle-D72Pa8kr.js").then((e) => e.paddleModule),
  paypal: () => import("./paypal-Cqt2bned.js").then((e) => e.paypalModule),
  payway: () => import("./payway-BjCqsc0H.js").then((e) => e.paywayModule),
  square: () => import("./square-C5AH3trb.js").then((e) => e.squareModule),
  stripe: () => import("./stripe-EJK0RyUv.js").then((e) => e.stripeModule)
}, mi = {
  ...di,
  ...ui,
  ...ci,
