...
function ge(e) {
  let t = [];
  const n = Object.keys(e), i = encodeURIComponent;
  for (let r = 0; r < n.length; r++)
    t.push(`${i(n[r])}=${i(e[n[r]])}`);
  return t.join("&");
}
function S(e) {
...
var we = class {
  constructor(e) {
    this.ready = !1, this.buffer = [], this.id = e.id, this.type = e.type, this.element = e.element, this.onReady = e.onReady, this.origin = S(e.element.src);
  }
  send(e) {
...
var Ae = class {
   ...
   */
  addOrigins(e) {
    e.forEach((t) => this.origins.add(t));
  }
  /**
  ...
  send(e) {
    if (e.from_id) {
      const i = this.targets[e.from_id];
      if (!i) {
        console.error(`[bus] Unexpected message from unknown sender ${e.from_id}`, e);
        return;
      }
      (e.type === "widget_announce" || e.type === "agent_announce") && i.setReady(!0);
    }
    const t = e.rid;
    if (t) {
   ...
   * @internal
   */
  registerTargetIFrame(e, t, n, i) {
    const r = M();
    let o = new Promise((u) => setTimeout(() => u("timeout"), i));
    const s = new we({
      id: t,
      element: n,
      type: e,
    ...
    return this.registerTarget(s), Promise.race([r.promise, o]);
  }
  /**
   * @internal
   */
...
function D(e, t = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789") {
  let n = "";
  for (let i = 0; i < e; i++)
...
function ke(e) {
  ...
  for (let n = t.length - 1; n > 0; n--) {
    const i = Math.floor(Math.random() * (n + 1)), r = t[n];
    t[n] = t[i], t[i] = r;
  }
  return t;
}
var ee = "frc_sc", te = "frc_sid", ne = "__", j = "0", Fe = "__" + D(10);
function K(e) {
  {
    let t = 0;
    try {
      t = parseInt(sessionStorage.getItem(ee) || "", 10);
    } catch {
    }
    isNaN(t) && (t = 0), e && t++, j = t.toString();
    try {
      sessionStorage.setItem(ee, j);
    } catch {
    }
  }
  return j;
...
function U() {
  let e;
  try {
    e = sessionStorage.getItem(te);
  } catch {
    return Fe;
  }
  return e || (e = D(12), sessionStorage.setItem(te, e)), e;
}
var xe = class {
  constructor(e) {
  ...
  set(e, t) {
    const n = this.storePrefix + ne + e;
    try {
      t === void 0 ? (this.mem.delete(e), sessionStorage.removeItem(n)) : (this.mem.set(e, t), sessionStorage.setItem(n, t));
    } catch {
    }
  }
}, Re = typeof navigator < "u" && navigator.userAgentData !== void 0;
function _e() {
  const e = document.querySelectorAll(".frc-captcha"), t = document.querySelectorAll(".frc-risk-intelligence");
  return [e, t];
}
function he(e) {
  let t = e;
...
}, Me = ["ar", "he", "fa", "ur", "ps", "sd", "yi"];
function $(e) {
  return e.toLowerCase().split("-")[0].split("_")[0];
}
function V(e) {
  return e = $(e), Me.indexOf(e) !== -1;
}
function pe(e) {
  return e = $(e), (z[e] || z.en).title + " - Widget";
}
function Y(e, t) {
  return e = $(e), (z[e] || z.en)[t];
}
var Ee = "FrcFrameId", ve = "frc-i-agent", Oe = "frc-i-widget", Te = "frc-widget-placeholder";
function Pe(e, t, n) {
  const i = {
  ...
  r.className = ve, r.dataset[Ee] = t, r.src = n + "?" + ge(i), r.frcSDK = e;
  const o = r.style;
  return o.width = o.height = o.border = o.visibility = "0", o.display = "none", r;
}
function Ne(e, t, n, i) {
  const r = document.createElement("iframe"), o = Z(i), s = {
    origin: document.location.origin,
    sess_id: U(),
    sess_c: K(!0),
    comm_id: t,
  ...
  i.theme && (s.theme = i.theme), Re && (r.allow = "clipboard-write"), r.frameBorder = "0", r.src = n + "?" + ge(s), r.className = Oe, r.title = pe(o), r.dataset[Ee] = t;
  const u = r.style;
  return u.border = u.visibility = "0", u.position = "absolute", u.height = u.width = "100%", u.userSelect = "none", u["-webkit-tap-highlight-color"] = "transparent", u.display = "none", i.element.appendChild(r), r;
}
function Le(e) {
  const t = document.createElement("div");
  t.classList.add(Te);
  const n = t.style, i = e.theme === "dark" || e.theme === "auto" && window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches;
  return n.color = i ? "#fff" : "#222", n.backgroundColor = i ? "#171717" : "#fafafa", n.borderRadius = "4px", n.border = "1px solid", n.borderColor = "#ddd", n.padding = "8px", n.height = n.width = "100%", n.fontSize = "14px", n.boxSizing = "border-box", G(n), e.element.appendChild(t), t;
}
function G(e) {
...
function Be(e) {
  ...
  const n = Z(e), i = e.theme === "dark" || e.theme === "auto" && window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches;
  let r = "#565656", o = "#a2a2a2";
  i && (r = "#a2a2a2", o = "#565656");
  const s = t.style;
  s.position = "absolute", s.bottom = "6px", V(n) ? s.left = "6px" : s.right = "6px", s.lineHeight = "1";
  const u = document.createElement("a");
  u.href = "https://friendlycaptcha.com", u.rel = "noopener";
  const c = u.style;
  G(c), c.color = r, c.fontSize = "10px", c.userSelect = "none", c.textDecorationLine = "underline", c.textDecorationThickness = "1px", c.textDecorationColor = o, c.letterSpacing = "-0.0125rem", u.target = "_blank", u.textContent = "Friendly Captcha", u.onmouseenter = () => c.textDecorationColor = r, u.onmouseleave = () => c.textDecorationColor = o, t.appendChild(u), e.element.appendChild(t);
}
function Z(e) {
  let t = e.language;
  return (!t || t === "html") && (t = Ie(e.element) || ""), t;
}
function We(e, t, n) {
  const i = (s, u) => {
    const c = document.createElement("a");
    c.href = s, c.target = "_blank", c.rel = "noopener", c.textContent = u;
    const a = c.style;
    return G(a), a.textDecoration = "underline", a.color = "#565656", c.onmouseenter = () => a.textDecoration = "none", c.onmouseleave = () => a.textDecoration = "underline", c;
  }, r = Y(n, "failed"), o = [i(`${t}/connectionTest`, r)];
  e.textContent = "", o.forEach((s) => e.appendChild(s));
}
function Q() {
...
function ze(e, t, n, i) {
  const r = Q(), o = n.getBoundingClientRect(), s = {
    v: 1,
    tt: e,
    pnow: r,
    sm: t,
...
var je = "frc-captcha-response", He = class {
  /**
  ...
  constructor(e) {
    ...
    if (this.e = t.element, this.ready = e.registered, !this.e) throw new Error("No element provided to mount widget under.");
    this.e.frcWidget = this, this.formFieldName = t.formFieldName === void 0 ? je : t.formFieldName, this.sitekey = t.sitekey, this._reset = e.callbacks.onReset, this._destroy = e.callbacks.onDestroy, this._trigger = e.callbacks.onTrigger, this.startMode = e.createOpts.startMode || "focus", this.formFieldName !== null && (this.hiddenFormEl = me(this.e, this.formFieldName)), this.setState({ response: ".UNCONNECTED", state: "init" }), this.ready.then(() => {
  ...
  handleStartMode() {
    if (this.startMode === "focus" && !this.focusEventPending && !this.isDestroyed) {
      const e = he(this.e);
      e && (this.focusEventPending = !0, fe(e, (t) => {
  ...
  trigger(e, t = {}) {
    ...
    const n = ze(e, this.startMode, this.e, t.ev);
  ...
  const t = [], n = /* @__PURE__ */ new Map(), i = function() {
    return t.splice(0, t.length);
  }, r = window, o = (function() {
    try {
      const d = document.createElement("iframe");
      d.style.display = "none", (document.body || document.head).appendChild(d);
      const h = d ? d.contentWindow : 0;
      return d.remove(), h || r;
    } catch {
      return r;
    }
  })(), s = Function.prototype.toString, u = function(...d) {
    const h = Ve(this) ? n.get(this) : !1, l = this === u ? s : h || this;
    return s.apply(l, d);
  };
  Function.prototype.toString = u;
  const c = function() {
    return (o.Error || r.Error)("FriendlyCaptcha_DummyTrace").stack || "";
  }, a = "prototype", m = r.EventTarget ? r.EventTarget[a].dispatchEvent : {}, f = [
    ...
    ["EventTarget." + a + ".dispatchEvent", m, "dispatchEvent"]
  ];
  return e.disableEvalPatching || f.push(["eval", r, "eval"]), f.forEach(function([g, d, h]) {
    const l = Object.getOwnPropertyDescriptor(d, h), p = l && (l.get || l.set);
    if (l) {
      if (p) {
        if (!l.get)
          return;
      } else if (typeof l.value != "object" && typeof l.value != "function")
        return;
    } else return;
    let x = 0, A = 0;
    const k = function(...w) {
      const v = Date.now();
      if (v - x >= 1e3 && (A = 0, x = v), A < 50) {
        const _ = {
          d: v,
          pnow: Q(),
          n: g,
        ...
        t.length > 2e4 && t.splice(0, 1e3), t.push(_), A++;
      }
      return (p ? l.get : l.value).apply(this, w);
    };
    try {
      const E = p ? l.get ? l.get() : void 0 : l.value();
      E && (k.length = E.length, k.name = E.name);
    } catch {
    }
    try {
      const E = J({}, l);
      p ? E.get = k : E.value = k, Object.defineProperty(d, h, E), n.set(k, p ? l.get : l.value);
    } catch {
    }
  }), i;
};
function F() {
  ...
  return {
    s: e,
    add(t) {
      const n = ++e[0], i = t - e[1], r = i / n, o = r * r, s = i * r * (n - 1);
      e[1] += r, e[4] += s * o * (n * n - 3 * n + 3) + 6 * o * e[2] - 4 * r * e[3], e[3] += s * r * (n - 2) - 3 * r * e[2], e[2] += s, n == 1 ? e[5] = e[6] = t : (t < e[5] && (e[5] = t), t > e[6] && (e[6] = t));
    }
  };
}
var b = "addEventListener", R = Math, ie;
function re() {
  return /Android/i.test(navigator.userAgent);
}
function y(e, t, n = !1, i) {
  const r = F();
  let o = !1, s;
  return H(() => {
    i = i || document.body, i[b](e, (u) => {
      (!o || n) && (s = u.timeStamp, o = !0);
    }), i[b](t, (u) => {
      o && (r.add(u.timeStamp - s), o = !1);
    });
  }), r.s;
}
function Xe(e) {
...
function qe() {
  ...
  return document[b]("keydown", (n) => {
    const i = n.keyCode;
    t[i] ? e[t[i]]++ : i >= 112 && i <= 123 && e[0]++;
  }), e;
}
function oe(e, t, n, i) {
  return R.sqrt(R.pow(e - t, 2) + R.pow(n - i, 2));
}
function se(e, t, n) {
  return R.sqrt(R.pow(e, 2) + R.pow(t, 2) + R.pow(n, 2));
}
function ue(e, t) {
  let n = t - e;
...
var Ke = class {
  constructor(e) {
    ...
    H(() => {
      const o = r.body;
      o[b](t + "enter", i), o[b](t + "leave", i);
    }), this.bh = {
      onoff: {
        kdu: y("keydown", "keyup"),
        cse: y("compositionstart", "compositionend"),
        mdu: y(t + "down", t + "up"),
        mle: y(t + "leave", t + "enter"),
        med: y(t + "enter", t + "down", !0),
        semd: y("scrollend", t + "down", !0, r),
        se: y("scroll", "scrollend", !1, r),
        pdc: y("pointerdown", "pointercancel", !0),
        mmc: y(t + "move", "click", !0),
    ...
    }, this.dep = e.disableEvalPatching || !1, this.takeTraceRecords = Ye(e);
  }
  setupMovementMetrics() {
    ...
    const i = F(), r = F(), o = F(), s = {
      ...
      a && (a[0] && this.tm.timeStamp === a[1] || // Last sample was touch and timestamp is unchanged.
      !a[0] && this.mm.timeStamp === a[1])) {
        if (clearInterval(e), e = void 0, t.length === 1) {
          s.ns++, t = [];
          return;
        }
        const f = t[0];
        i.add(a[1] - f[1]), r.add(oe(a[2], f[2], a[3], f[3]));
        for (let g = 1; g < t.length; g++) {
          const d = t[g], h = t[g - 1], l = oe(d[2], h[2], d[3], h[3]) * 1e3, p = d[1] - h[1];
          o.add(l / p);
        }
        t = [];
        return;
      ...
      let m = 0;
      if (a ? m = a[0] : this.mm && this.tm ? m = this.mm.timeStamp > this.tm.timeStamp ? 0 : 1 : this.mm || (m = 1), m) {
        const f = this.tm.touches[0];
        f && t.push([1, this.tm.timeStamp, f.screenX, f.screenY]);
      } else
    ...
    return H(() => {
      ...
      a[b]("mousemove", (m) => {
        this.mm = m, e === void 0 && (u(), e = setInterval(u, 50));
      }), a[b]("touchmove", (m) => {
        this.tm = m;
        const f = m.touches[0];
        if (f) {
          const g = f.radiusX + f.radiusY * 1.234;
          g !== c && (c = g, this.rn++);
        }
        e === void 0 && (u(), e = setInterval(u, 50));
      });
    }), s;
  }
  /**
  ...
  setupMotionMetrics() {
    ...
    return re() && window[b]("devicemotion", (i) => {
      n.ts = i.timeStamp, n.i = i.interval, n.g = !i.acceleration;
      const r = i.acceleration || i.accelerationIncludingGravity;
      r && e.add(se(r.x, r.y, r.z));
      const o = i.rotationRate;
      o && t.add(se(o.alpha, o.beta, o.gamma));
    }), n;
  }
  /**
   * @internal
  ...
  setupOrientationMetrics() {
    ...
    if (!re())
      return n;
    let i;
    return window[b]("deviceorientation", (r) => {
      r.gamma == null || r.beta == null || r.alpha == null || (n.ts = r.timeStamp, n.a = r.alpha, n.b = r.beta, n.g = r.gamma, i ? (e.add(ue(r.gamma, n.g)), t.add(ue(n.b, r.beta))) : (n.fts = n.ts, i = !0));
    }), n;
  }
  /**
   * @internal
   ...
   */
  get(e) {
    const t = document.body, n = window, i = n.performance;
    return {
      v: 1,
      i: ++this.i,
      hl: history.length,
...
function Ue(e) {
  return ie || (ie = new Ke(e));
}
var ae = (e) => e.map((t) => `https://${t}.frcapi.com`).join(","), X = {
  eu: ae(["eu", "eu0", "eu1"]),
  global: ae(["global", "global0", "global1"])
}, q = (e) => e.split(",").map((t) => t.trim()).filter((t) => !!t), $e = (e) => q(X[e] || e);
function O(e) {
  const t = e || X.global, n = q(t).reduce((i, r) => i.concat($e(r)), []).map(S);
  return n.length > 0 ? n : q(X.global).map(S);
}
function Ge() {
...
function T() {
  ...
  if (t) {
    const i = t.dataset.frcApiEndpoint;
    if (i) return i;
  }
  const n = document.querySelector(".frc-captcha[data-api-endpoint]");
  if (n) {
    const i = n.dataset.apiEndpoint;
    if (i) return i;
  }
}
function Ze() {
...
function Qe(e) {
  return window.TextEncoder ? Je(new TextEncoder().encode(e)) : "";
}
function Je(e) {
  const t = e.length;
  let n = "";
  for (let i = 0; i < t; i += 3) {
    const r = e[i + 0], o = e[i + 1], s = e[i + 2];
    let u = "";
    u += P.charAt(r >>> 2), u += P.charAt((r & 3) << 4 | o >>> 4), u += P.charAt((o & 15) << 2 | s >>> 6), u += P.charAt(s & 63), n += u;
  }
  return t % 3 === 2 ? n = n.substring(0, n.length - 1) + "=" : t % 3 === 1 && (n = n.substring(0, n.length - 2) + "=="), n;
}
var et = "frc-risk-intelligence-token", tt = class {
  /**
   ...
   */
  constructor(e) {
    if (this.timeout = null, this.data = null, this.e = e.element, !this.e) throw new Error("No element provided for mounting Risk Intelligence handle.");
    this.e.frcRiskIntelligence = this, this.formFieldName = e.formFieldName === void 0 ? et : e.formFieldName, this.formFieldName !== null && (this.hiddenFormEl = me(this.e, this.formFieldName)), this.startMode = e.startMode || "focus", this.requestRiskIntelligence = e.riskIntelligence, this.handleStartMode();
  }
  handleStartMode() {
...
function nt(e) {
  return e.length === 0 ? [] : [e[0]].concat(ke(e.slice(1)));
}
function N(e, t) {
  const n = t.length;
  if (n === 0) return -1;
  if (e <= 2 || n === 1) return 0;
  const i = n - 1, r = e - 2;
  return r <= i ? r : 1 + Math.floor(Math.random() * i);
}
function ce(e, t, n) {
  const i = S(e), r = S(t);
  let o = C(e, i) ? e.slice(i.length) : e;
  o.length === 0 ? o = "/" : C(o, "/") || (o = "/" + o);
  const s = o.indexOf("?") === -1 ? "?" : "&";
  return r + o + s + "retry=" + n;
}
var it = "/api/v2/captcha/agent", rt = "/api/v2/captcha/widget", L = "FrcFrameId", le = "FrcAgentOriginKey", ot = 1e3 * 60 * 60 * 36, de = 5, B, I = 0, st = class {
  constructor(e = {}) {
    if (this.agents = /* @__PURE__ */ new Map(), this.agentState = /* @__PURE__ */ new Map(), this.widgets = /* @__PURE__ */ new Map(), this._attached = M(), this.attached = this._attached.promise, this.riskIntelligencePromises = /* @__PURE__ */ new Map(), this.clearRiskIntelligencePromises = /* @__PURE__ */ new Map(), this.riskIntelligenceHandles = [], this.apiEndpoint = e.apiEndpoint, B = B || new Ae(), B.listen((t) => this.onReceiveMessage(t)), this.bus = B, I++, I > 1 && console.warn(
      "Multiple Friendly Captcha SDKs created, this is not recommended. Please use a single SDK instance."
    ), this.signals = Ue({
      disableEvalPatching: e.disableEvalPatching || Ge()
    }), e.startAgent) {
      const t = O(this.apiEndpoint || T()), n = this.getRetryOrigins(t);
      this.ensureAgentIFrame(n);
    }
  ...
  onReceiveMessage(e) {
    if (e.type === "root_set_response") {
      ...
      if (!t) {
        I === 1 && console.warn(`Received set response message for widget ${e.widget_id} that doesn't exist`);
        return;
      }
      t.setState(e);
    } else if (C(e.type, "root_store"))
      ...
      if (!t) {
        I === 1 && console.warn(`Received reset message for widget ${e.from_id} that doesn't exist`);
        return;
      }
      t.reset({ trigger: "widget" });
    } else C(e.type, "root_risk_intelligence") && this.handleRiskIntelligenceMessage(e);
  }
  handleRiskIntelligenceMessage(e) {
    if (e.type === "root_risk_intelligence_generate_reply") {
      const t = this.riskIntelligencePromises.get(e.uid);
      ...
      const t = this.clearRiskIntelligencePromises.get(e.uid);
  ...
  handleWidgetLanguageChange(e) {
    const t = this.widgets.get(e.from_id);
    if (!t) {
      I === 1 && console.warn(`Received language change message for widget ${e.from_id} that doesn't exist`);
      return;
    }
    const n = t.getElement(), i = n.querySelector("iframe");
    i && (i.title = pe(e.language));
    const r = n.querySelector(".frc-banner");
    if (r) {
      const o = r.style;
      V(e.language) ? (o.left = "6px", o.right = "auto") : (o.left = "auto", o.right = "6px");
    }
  }
  ...
  ensureAgentIFrame(e) {
    let t = 1;
    const n = N(t, e), i = e[n], r = i + it, o = de, s = this.agents.get(i);
    if (s && s.dataset[L])
      return s.dataset[L];
    let u = document.getElementsByClassName(ve);
    for (let d = 0; d < u.length; d++) {
      const h = u[d];
      if (h.dataset[le] === i && h.dataset[L])
        return this.agents.set(i, h), h.dataset[L];
    }
    const c = "a_" + D(12), a = Pe(this, c, r);
    a.dataset[le] = i;
    const m = a.src;
    let f = i;
    this.agents.set(i, a), this.agentState.set(c, { store: new xe(i), origin: i }), document.body.appendChild(a);
    const g = () => {
      this.bus.registerTargetIFrame("agent", c, a, this.getRetryTimeout(t)).then((d) => {
        if (d === "timeout") {
          if (t >= o) {
            console.error(`[Friendly Captcha] Failed to load agent iframe after ${t - 1} retries.`), a.remove(), this.agents.delete(i);
            return;
          }
          const h = t + 1, l = N(h, e);
          f = e[l] || f, console.warn("[Friendly Captcha] Retrying agent iframe load."), a.src = ce(m, f, h - 1), t = h, g();
        }
      });
    };
    return g(), c;
  ...
  setupPeriodicRefresh() {
    ...
    setInterval(() => {
      ...
      this.agents.forEach((n, i) => {
        ...
        const r = n.getElement().querySelector("iframe");
        r.src += t;
      });
    }, ot);
  }
  ...
  attach(e) {
    ...
    for (let o = 0; o < n.length; o++) {
      const s = n[o];
      if (s && !s.frcRiskIntelligence) {
        const u = s.dataset, c = u.sitekey;
        if (!c) {
          console.warn("Risk Intelligence <div> found with no sitekey, skipping...", s);
          continue;
        }
        this.riskIntelligenceHandles.push(
          new tt({
            element: s,
            formFieldName: u.formFieldName,
            startMode: u.start,
            riskIntelligence: () => this.riskIntelligence({
              sitekey: c,
              apiEndpoint: u.apiEndpoint
            })
          })
        );
      }
    ...
    for (let o = 0; o < e.length; o++) {
      ...
      if (s && !s.frcWidget) {
        ...
        i.push(this.createWidget(c));
      }
    }
    const r = this.getAllWidgets();
    return this._attached.resolve(r), this.attached = Promise.resolve(r), i;
  }
  /**
   ...
   */
  createWidget(e) {
    const t = O(e.apiEndpoint || this.apiEndpoint || T()), n = this.getRetryOrigins(t);
    let i = 1;
    this.bus.addOrigins(t);
    const r = n[N(i, n)] || t[0], o = this.ensureAgentIFrame(n), s = "w_" + D(12), u = (w) => {
      const v = { from_id: s, to_id: o, _frc: 1 };
      this.bus.send(J(v, w));
    }, c = {
      onDestroy: () => {
        u({ type: "root_destroy_widget" }), this.bus.removeTarget(s), this.widgets.delete(s), e.element.innerHTML = "", Se(e.element);
      },
      onReset: () => {
        u({ type: "root_reset_widget" });
      },
      onTrigger: (w) => {
        u({ type: "root_trigger_widget", trigger: w.trigger });
      }
    }, a = M(), m = new He({
      id: s,
      createOpts: e,
    ...
    this.widgets.set(s, m);
    const f = r + rt, g = Ne(o, s, f, e), d = de, h = g.src;
    let l = r;
    const p = Le(e);
    Ce(e.element), Be(e);
    let x = Z(e);
    V(x) && (e.element.dir = "rtl");
    const A = p.style;
    p.textContent = Y(x, "connecting");
    function k(w) {
      const v = Qe(
        JSON.stringify({
          sdk_v: "1.0.0",
      ...
      let _ = ".ERROR.UNREACHABLE";
      v && (_ += "~" + v), m.setState({
        state: "error",
        response: _,
        error: { code: "network_error", detail: w }
      });
    }
    const E = () => {
      this.bus.registerTargetIFrame("widget", s, g, this.getRetryTimeout(i)).then((w) => {
        if (w === "timeout") {
          if (i >= d) {
            console.error(`[Friendly Captcha] Failed to load widget iframe after ${i - 1} retries.`), k("Widget load timeout, stopped retrying"), A.borderColor = "#f00", A.fontSize = "12px", We(p, S(g.src), x);
            return;
          }
          const v = i + 1, _ = N(v, n);
          l = n[_] || l, A.backgroundColor = "#fee", A.color = "#222", p.textContent = Y(x, "retrying") + ` (${i})`, console.warn(`[Friendly Captcha] Retrying widget ${s} iframe load.`), k("Widget load timeout, will retry"), g.src = ce(h, l, v - 1), i = v, E();
        } else w === "registered" && (e.element.removeChild(p), g.style.display = "");
      });
    };
    return E(), a.resolve(), m;
  }
  /**
  ...
  riskIntelligence(e) {
    const t = O(e.apiEndpoint || this.apiEndpoint || T()), n = this.getRetryOrigins(t);
    this.bus.addOrigins(t);
    const i = this.ensureAgentIFrame(n), r = D(8);
    this.bus.send({
      ...
      _frc: 1,
      sitekey: e.sitekey,
      bypassCache: e.bypassCache || !1,
      uid: r
    });
    const o = M();
    return this.riskIntelligencePromises.set(r, o), o.promise;
  }
  /**
  ...
  clearRiskIntelligence(e) {
    ...
    const o = M();
    return this.clearRiskIntelligencePromises.set(r, o), o.promise;
  }
  /**
...
}, ut = "frc:widget.statechange", at = "frc:widget.complete", ct = "frc:widget.expire", lt = "frc:widget.error", dt = "frc:widget.reset", gt = "frc:riskintelligence.complete", ht = "frc:riskintelligence.error", ft = "frc:riskintelligence.expire";
export {
  gt as FRCRiskIntelligenceCompleteEventName,
  ht as FRCRiskIntelligenceErrorEventName,
  ft as FRCRiskIntelligenceExpireEventName,
  at as FRCWidgetCompleteEventName,
  lt as FRCWidgetErrorEventName,
  ct as FRCWidgetExpireEventName,
  dt as FRCWidgetResetEventName,
  ut as FRCWidgetStateChangeEventName,
  st as FriendlyCaptchaSDK
};
