...
function pe(e) {
	var t = e.state, n = e.instance, r = e.options, i = r.scroll, a = i === void 0 ? !0 : i, o = r.resize, s = o === void 0 ? !0 : o, c = y(t.elements.popper), l = [].concat(t.scrollParents.reference, t.scrollParents.popper);
...
function $(e, t) {
	t === void 0 && (t = {});
	var n = t, o = n.placement, s = o === void 0 ? e.placement : o, l = n.strategy, u = l === void 0 ? e.strategy : l, h = n.boundary, g = h === void 0 ? d : h, _ = n.rootBoundary, v = _ === void 0 ? f : _, y = n.elementContext, x = y === void 0 ? p : y, S = n.altBoundary, C = S === void 0 ? !1 : S, w = n.padding, T = w === void 0 ? 0 : w, E = U(typeof T == "number" ? re(T, c) : T), D = x === p ? m : p, O = e.rects.popper, k = e.elements[C ? D : x], A = Ce(b(k) ? k : k.contextElement || L(e.elements.popper), g, v, u), j = M(e.elements.reference), N = we({
		reference: j,
		element: O,
		strategy: "absolute",
		placement: s
...
function De(e) {
	...
	if (!t.modifiersData[c]._skip) {
		for (var u = n.mainAxis, d = u === void 0 ? !0 : u, f = n.altAxis, p = f === void 0 ? !0 : f, m = n.fallbackPlacements, h = n.padding, g = n.boundary, _ = n.rootBoundary, v = n.altBoundary, y = n.flipVariations, b = y === void 0 ? !0 : y, x = n.allowedAutoPlacements, S = t.options.placement, C = E(S) === S, w = m || (C || !b ? [q(S)] : Ee(S)), T = [S].concat(w).reduce(function(e, n) {
...
function ze(e) {
	var t = e.state, n = e.options, s = e.name, c = n.mainAxis, u = c === void 0 ? !0 : c, d = n.altAxis, f = d === void 0 ? !1 : d, p = n.boundary, m = n.rootBoundary, h = n.altBoundary, g = n.padding, _ = n.tether, v = _ === void 0 ? !0 : _, y = n.tetherOffset, b = y === void 0 ? 0 : y, x = $(t, {
		boundary: p,
		rootBoundary: m,
		padding: g,
		altBoundary: h
