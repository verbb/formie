...
import { r as t, t as n } from "./field-references.keys-BGhkWxVZ.js";
import { n as r, r as i } from "./field-references.resolver-D3zB6rj6.js";
import { c as a, i as o, n as s, s as c, t as l } from "./dist-BW49hac1.js";
import { r as u, t as d } from "./shared-ktsx_SHX.js";
...
function _(e, t, n, r) {
	let i = l(r), o = a(r), s = /* @__PURE__ */ new Map(), u = null, f = !1, _ = !1, v = !1, y = () => {
		s.forEach((e, t) => {
			e.forEach((e, n) => {
		...
		if (d(t, p, "before-evaluate", l), !l.formula) {
			let e = n.value !== "";
			n.value = "", b(e);
			return;
		}
		try {
			let e = c(l.formula, l.variables, r), i = {
				calculations: n,
				init: a,
				formula: l.formula,
