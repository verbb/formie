import { n as e, t } from "./api-KSUyxI7O.js";
...
var r = "FORMIE_LOQATE_SCRIPT", i = t({
	...
	mount: ({ api: t, field: n, services: r, provider: i }) => {
		...
		let s = {
			...
			if (a) return `${a}[${e}]`;
			let t = s[e], r = t ? n.querySelector(t) : null;
			return r?.name ? r.name : r?.id ? r.id : "";
		}, l = c("autoComplete");
		if (!l) throw Error("Loqate: could not find autocomplete input within address field");
		let u = [
			{
				element: l,
				field: "",
		...
		].filter((e) => e.element), d = new t.Address(u, {
			key: o,
			simulateReactEvents: !0,
			...i.reconfigurableOptions || {}
		});
		return typeof d.load == "function" && d.load(), d;
	}
});
//#endregion
