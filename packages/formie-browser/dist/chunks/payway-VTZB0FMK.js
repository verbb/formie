import { x as y } from "./index-CZtn5KAB.js";
import { e as u } from "./styles-C3aqgtek.js";
import { l as p } from "./scripts--tQDv1Kx.js";
const c = "@layer formie-theme{.formie-payway-button{border:var(--formie-border-width) solid var(--formie-color-border-control);border-radius:var(--formie-radius-sm);background:var(--formie-color-surface);box-sizing:border-box;min-height:var(--formie-control-height);padding:var(--formie-space-2)}}";
u("payway", [c]);
const f = "FORMIE_PAYWAY_SCRIPT", h = y({
  id: "payway",
