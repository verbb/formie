...
const wi = {
  ...
  "address-finder": () => import("./address-finder-qigIwbVW.js").then((e) => e.addressFinderModule),
  "google-address": () => import("./google-address-ByGeycyl.js").then((e) => e.googleAddressModule),
  loqate: () => import("./loqate-CeeWnOWZ.js").then((e) => e.loqateModule),
  "place-kit": () => import("./place-kit-CBvo4KOF.js").then((e) => e.placeKitModule)
}, Ti = {
  ...
  "captcha-eu": () => import("./captcha-eu-CuZm_y1N.js").then((e) => e.captchaEuModule),
  "friendly-captcha-v1": () => import("./friendly-captcha-v1-rdEtJIlt.js").then((e) => e.friendlyCaptchaV1Module),
  "friendly-captcha-v2": () => import("./friendly-captcha-v2-AhDpUP_e.js").then((e) => e.friendlyCaptchaV2Module),
  hcaptcha: () => import("./hcaptcha-OesnqAuT.js").then((e) => e.hcaptchaModule),
  "recaptcha-enterprise": () => import("./recaptcha-enterprise-DrNEGqg5.js").then((e) => e.recaptchaEnterpriseModule),
  "recaptcha-v2-checkbox": () => import("./recaptcha-v2-checkbox-DM1grEqW.js").then((e) => e.recaptchaV2CheckboxModule),
  "recaptcha-v2-invisible": () => import("./recaptcha-v2-invisible-Cojr_dkg.js").then((e) => e.recaptchaV2InvisibleModule),
  "recaptcha-v3": () => import("./recaptcha-v3-Cy2IbiBL.js").then((e) => e.recaptchaV3Module),
  snaptcha: () => import("./snaptcha-FtzU2fOF.js").then((e) => e.snaptchaModule),
  turnstile: () => import("./turnstile-BMGROtgL.js").then((e) => e.turnstileModule)
}, Mi = {
  ...
  calculations: () => import("./calculations-60a-V8n9.js").then((e) => e.calculationsModule),
  "checkbox-radio": () => import("./checkbox-radio-D3SVCOkL.js").then((e) => e.checkboxRadioModule),
  conditions: () => import("./conditions-BiTdLWDd.js").then((e) => e.conditionsModule),
  "date-picker": () => import("./date-picker-BAB6JHGv.js").then((e) => e.datePickerModule),
  "file-upload": () => import("./file-upload-DWvibmU_.js").then((e) => e.fileUploadModule),
  hidden: () => import("./hidden-BGzIp5pr.js").then((e) => e.hiddenModule),
  "phone-country": () => import("./phone-country-Ctl7xHkU.js").then((e) => e.phoneCountryModule),
  repeater: () => import("./repeater-fLs86s76.js").then((e) => e.repeaterModule),
  "rich-text": () => import("./rich-text-Cmc9nW1P.js").then((e) => e.richTextModule),
  signature: () => import("./signature-D-cNDkGz.js").then((e) => e.signatureModule),
  summary: () => import("./summary-BFFlSL83.js").then((e) => e.summaryModule),
  table: () => import("./table-BaxW5HPJ.js").then((e) => e.tableModule),
  "text-limit": () => import("./text-limit-B2LFe-OQ.js").then((e) => e.textLimitModule)
}, Ci = {
  ...
  bpoint: () => import("./bpoint-BL8T2vvA.js").then((e) => e.bpointModule),
  eway: () => import("./eway-CIIXME36.js").then((e) => e.ewayModule),
  "go-cardless": () => import("./go-cardless-BGNsIwRK.js").then((e) => e.goCardlessModule),
  mollie: () => import("./mollie-DWRqnmfd.js").then((e) => e.mollieModule),
  moneris: () => import("./moneris-yIIj6XJQ.js").then((e) => e.monerisModule),
  opayo: () => import("./opayo-DZMRGoej.js").then((e) => e.opayoModule),
  paddle: () => import("./paddle-DSBd9z9U.js").then((e) => e.paddleModule),
  paypal: () => import("./paypal-tnUDJx3P.js").then((e) => e.paypalModule),
  payway: () => import("./payway-C4SDVHcf.js").then((e) => e.paywayModule),
  square: () => import("./square-Dm_Ab01P.js").then((e) => e.squareModule),
  stripe: () => import("./stripe-CJSlUp5S.js").then((e) => e.stripeModule)
}, Li = {
  ...Mi,
  ...wi,
  ...Ti,
