import { n as e } from "./event-names-BzJlD9YG.js";
import { t } from "./api-KSUyxI7O.js";
import { n, t as r } from "./scripts-C4QAqZ0U.js";
...
var f = t({
	...
	mount: async ({ api: t, field: n, services: r, provider: i }) => {
		...
		let s = new o({
			types: ["geocode"],
			...i.options || {}
		}), l = window.getComputedStyle(a).height;
		...
		if (p) {
			...
			e.classList.add("formie-autocomplete-placeholder"), e.textContent = p, f.style.position = "relative", e.style.cssText = `
...
//#endregion
export { f as googleAddressModule };
