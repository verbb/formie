...
var e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", t = 61, n = new Uint8Array(256);
for (let t = 0; t < 64; t++) n[e.charCodeAt(t)] = t;
function r(t) {
	let n = t.length, r = "";
	for (let i = 0; i < n; i += 3) {
...
function d(e, t) {
	return u(e, t.rtl, "<path d=\"M17,11c0.34,0,0.67,0.04,1,0.09V6.27L10.5,3L3,6.27v4.91c0,4.54,3.2,8.79,7.5,9.82c0.55-0.13,1.08-0.32,1.6-0.55 C11.41,19.47,11,18.28,11,17C11,13.69,13.69,11,17,11z\"/><path d=\"M17,13c-2.21,0-4,1.79-4,4c0,2.21,1.79,4,4,4s4-1.79,4-4C21,14.79,19.21,13,17,13z M17,14.38\"/>", !0, t.text_ready, ".UNSTARTED", t.button_start, !1);
}
function f(e, t) {
	return u(e, t.rtl, c, !0, t.text_fetching, ".FETCHING", void 0, !0);
}
function p(e, t) {
	return u(e, t.rtl, c, !0, t.text_solving, ".UNFINISHED", void 0, !0);
}
function m(e, t, n, r) {
	let i = `${r.t.toFixed(0)}s (${(r.h / r.t * .001).toFixed(0)}K/s)${r.solver === o ? " JS Fallback" : ""}`;
	return u(e, t.rtl, `<title>${t.text_completed_sr}</title><path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm-2 16l-4-4 1.41-1.41L10 14.17l6.59-6.59L18 9l-8 8z"></path>`, !1, t.text_completed, n, void 0, !1, i, "frc-success");
}
function h(e, t) {
	return u(e, t.rtl, l, !0, t.text_expired, ".EXPIRED", t.button_restart);
}
function g(e, t, n, r = !0, i = !1) {
	return u(e, t.rtl, l, !0, `<b>${t.text_error}</b><br>${n}`, i ? ".HEADLESS_ERROR" : ".ERROR", r ? t.button_retry : void 0);
}
function _(e = null) {
	if (!document.querySelector("#frc-style")) {
		let t = document.createElement("style");
		t.id = "frc-style", t.innerHTML = a, e && t.setAttribute("nonce", e), document.head.appendChild(t);
	}
}
function v(e, t) {
...
var x, S;
typeof navigator < "u" && typeof navigator.userAgent == "string" && (x = navigator, S = x.userAgent.toLowerCase());
function C() {
	return S.indexOf("headless") !== -1 || x.appVersion.indexOf("Headless") !== -1 || S.indexOf("bot") !== -1 || S.indexOf("crawl") !== -1 || x.webdriver === !0 || !x.language || x.languages !== void 0 && !x.languages.length;
}
function w(e) {
...
async function j(e, t, n) {
	...
	return fetch(e, t).catch(async (i) => {
		if (n === 0) throw i;
		return await new Promise((e) => setTimeout(e, r)), r *= 4, j(e, t, n - 1);
	});
}
var M = {
...
function Z(e, t) {
	let n = new Uint8Array(3), r = new DataView(n.buffer);
...
var te = class {
	...
	async start(e) {
		await this.readyPromise, this.puzzleSolverInputs = O(e.buffer, e.n), this.solutionBuffer = new Uint8Array(8 * e.n), this.numPuzzles = e.n, this.threshold = e.threshold, this.puzzleIndex = 0, this.puzzleNumber++;
	...
	constructor(e, t = {}) {
		this.workerGroup = new te(), this.valid = !1, this.needsReInit = !1, this.hasBeenStarted = !1, this.hasBeenDestroyed = !1, this.opts = Object.assign({
			...
			styleNonce: null
		}, t), this.e = e, this.e.friendlyChallengeWidget = this, this.loadLanguage(), e.innerText = this.lang.text_init, this.opts.skipStyleInjection || _(this.opts.styleNonce), this.init(this.opts.startMode === "auto" || this.e.dataset.start === "auto");
	}
	init(e) {
		...
		if (this.initWorkerGroup(), e) this.start();
			...
			let e = y(this.e);
			e ? b(e, () => this.start()) : console.log("FriendlyCaptcha div seems not to be contained in a form, autostart will not work");
		}
	}
	loadLanguage(e) {
	...
	onWorkerError(e) {
		this.hasBeenStarted = !1, this.needsReInit = !0, this.expiryTimeout && clearTimeout(this.expiryTimeout), console.error("[FRC]", e), this.e.innerHTML = g(this.opts.solutionFieldName, this.lang, "Background worker error " + e.message), this.makeButtonStart(), this.opts.forceJSFallback = !0;
	}
	initWorkerGroup() {
		this.workerGroup.progressCallback = (e) => {
			v(this.e, e);
		}, this.workerGroup.readyCallback = () => {
			this.e.innerHTML = d(this.opts.solutionFieldName, this.lang), this.makeButtonStart(), this.opts.readyCallback();
		}, this.workerGroup.startedCallback = () => {
			this.e.innerHTML = p(this.opts.solutionFieldName, this.lang), this.opts.startedCallback();
	...
	expire() {
		this.hasBeenStarted = !1, this.e.isConnected !== !1 && (this.e.innerHTML = h(this.opts.solutionFieldName, this.lang), this.makeButtonStart());
	}
	async start() {
		if (this.hasBeenDestroyed) {
		...
		if (!e) {
			console.error("FriendlyCaptcha: sitekey not set on frc-captcha element"), this.e.innerHTML = g(this.opts.solutionFieldName, this.lang, "Website problem: sitekey not set", !1);
			return;
		}
		if (C()) {
		...
		try {
			this.e.innerHTML = f(this.opts.solutionFieldName, this.lang), this.puzzle = k(await A(this.opts.puzzleEndpoint, e, this.lang)), this.expiryTimeout && clearTimeout(this.expiryTimeout), this.expiryTimeout = setTimeout(() => this.expire(), this.puzzle.expiry - 3e4);
		} catch (e) {
			console.error("[FRC]", e), this.hasBeenStarted = !1, this.expiryTimeout && clearTimeout(this.expiryTimeout), this.e.innerHTML = g(this.opts.solutionFieldName, this.lang, e.message), this.makeButtonStart(), this.opts.errorCallback({
	...
	handleDone(e) {
		this.valid = !0;
		let t = `${this.puzzle.signature}.${this.puzzle.base64}.${r(e.solution)}.${r(e.diagnostics)}`;
		return this.e.innerHTML = m(this.opts.solutionFieldName, this.lang, t, e), this.needsReInit = !0, t;
	}
	destroy() {
