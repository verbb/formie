import { L as u } from "./index-DtUMIYEa.js";
import { b as A, r as w, a as T } from "./shared-8Shdc9Qt.js";
...
const C = "@layer formie-theme{.formie-limit-number{font-weight:var(--formie-font-weight-semibold);color:var(--formie-color-text)}.formie-limit-number-error{color:var(--formie-color-danger)}}", c = "input[data-formie-single-line-text-input], textarea[data-formie-multi-line-text-input]", E = [
  ...
  "textMinWordLimit",
  "textMaxWordLimit"
], L = "text-limit", f = "data-formie-text-limit-allow-overtype", n = /* @__PURE__ */ new WeakMap();
v("text-limit", [C]);
function d(t) {
...
const _ = {
  ...
  setup: async (t) => {
    const i = t.options || {}, e = A(t), r = Array.from((e || t.target).querySelectorAll(c)).filter((o) => (o instanceof HTMLInputElement || o instanceof HTMLTextAreaElement) && M(o)), a = r.filter((o) => y(o));
