...
var e = "[data-formie-address-autocomplete-input]", t = "[data-formie-address-location]", n = {
	...
	autoComplete: [n.autoComplete, r.autoComplete],
	address1: [n.address1, r.address1],
	address2: [n.address2, r.address2],
	address3: [n.address3, r.address3],
	city: [n.city, r.city],
	state: [n.state, r.state],
	zip: [n.zip, r.zip],
	country: [n.country, r.country]
};
function a(e, t) {
	for (let n of i[t]) {
		let t = e.querySelector(n);
		if (t instanceof HTMLInputElement || t instanceof HTMLSelectElement) return t;
	}
	return null;
}
//#endregion
export { a as i, n, e as r, t };
