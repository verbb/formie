...
function s(e, s, c = {}) {
	let l = String(e.condition || ""), u = t(e.value), d = c.visibility ?? null;
	switch (l) {
		case "=": return n(u, s);
		case "!=": return !n(u, s);
		case ">": return a(s, u, (e, t) => e > t);
		case "<": return a(s, u, (e, t) => e < t);
		case "contains": return r(u, s);
		case "notContains": return !r(u, s);
		case "startsWith": return i(s, u, (e, t) => e.startsWith(t));
		case "endsWith": return i(s, u, (e, t) => e.endsWith(t));
		case "empty": return o(s);
		case "notEmpty": return !o(s);
		case "visible": return d === !0;
		case "hidden": return d === !1;
		default: return !1;
	}
}
function c(e, t) {
	...
	return p || (p = 1, (function(e, t) {
		(function(e, n) {
			...
			function d(e) {
				...
				let n = c.exec(e);
				return n !== null && n.length > 0 && (t = n[1] === void 0 ? { captured: u(n[2], "'") } : { captured: u(n[1], "\"") }, t.length = n[0].length), t;
			}
			let f = /* @__PURE__ */ "&&,and,||,or,+,-,**,*,/,%,&,|,^,>>,<<,===,!==,!=,==,<=,>=,<,>,contains,matches,starts with,ends with,not in,in,not,!,xor,~,..".split(","), p = [
				"and",
				"or",
				"matches",
				"contains",
			...
			function m(e) {
				let t = null;
				for (let n of f) if (e.substr(0, n.length) === n) {
					p.indexOf(n) >= 0 ? e.substr(0, n.length + 1) === n + " " && (t = n) : t = n;
					break;
				}
				return t;
			}
			...
			class v {
				constructor(e = {}, n = {}) {
					t(this, "compile", (e) => {
						...
						let e = "";
						for (let t of this.toArray()) e += g(t) ? t : t.dump();
						return e;
					}), t(this, "dumpString", (e) => `"${_(e, "\0	\"\\")}"`), t(this, "isHash", (e) => {
						let t = 0;
				...
				constructor(e, n, r) {
					super({
						...
						switch (i = this.nodes.right.evaluate(e, t), n) {
							...
							case "matches":
								if (r == null) return !1;
								let e = i.match(y.regex_expression);
			...
			t(y, "regex_expression", /\/(.+)\/(.*)/), t(y, "operators", {
				"~": ".",
				and: "&&",
				or: "||",
				xor: "xor",
			...
			class b extends v {
				constructor(e, n) {
					super({ node: n }, { operator: e }), t(this, "compile", (e) => {
						e.raw("(").raw(b.operators[this.attributes.operator]).compile(this.nodes.node).raw(")");
					}), t(this, "evaluate", (e, t) => {
			...
			class x extends v {
				constructor(e, n = !1, r = !1) {
					super({}, { value: e }), t(this, "compile", (e) => {
						...
						else if (t === !0) e.push("true");
						else if (t === !1) e.push("false");
						else if (t === null) e.push("null");
						else if (typeof t == "number") e.push(t);
						else if (typeof t == "string") e.push(this.dumpString(t));
						else if (Array.isArray(t)) {
							for (let n of t) e.push(","), e.push(new x(n));
							e[0] = "[", e.push("]");
						} else if (this.isHash(t)) {
							for (let n of Object.keys(t)) e.push(", "), e.push(new x(n)), e.push(": "), e.push(new x(t[n]));
							e[0] = "{", e.push("}");
						}
						return e;
			...
			class T extends v {
				constructor() {
					super(), t(this, "addElement", (e, t = null) => {
						t === null ? t = new x(++this.index) : this.type === "Array" && (this.type = "Object"), this.nodes[(++this.keyIndex).toString()] = t, this.nodes[(++this.keyIndex).toString()] = e;
					}), t(this, "compile", (e) => {
						...
						let t = [];
						if (this.isHash(e)) {
							for (let n of Object.keys(e)) t.push(", "), t.push(new x(n)), t.push(": "), t.push(e[n]);
							t[0] = "{", t.push("}");
						} else {
			...
			class D extends v {
				constructor(e, n, r, i) {
					super({
						...
						let t = this.nodes.attribute instanceof x && this.nodes.attribute.isNullSafe;
						switch (this.attributes.type) {
							case D.PROPERTY_CALL:
							...
							case D.METHOD_CALL:
								...
								break;
							case D.ARRAY_CALL: e.compile(this.nodes.node).raw("[").compile(this.nodes.attribute).raw("]");
						}
					}), t(this, "evaluate", (e, t) => {
						switch (this.attributes.type) {
							case D.PROPERTY_CALL:
						...
						let e = this.nodes.attribute instanceof x && this.nodes.attribute.isNullSafe;
						switch (this.attributes.type) {
							case D.PROPERTY_CALL: return [
								this.nodes.node,
								e ? "?." : ".",
								this.nodes.attribute
							];
							case D.METHOD_CALL: return [
								this.nodes.node,
								e ? "?." : ".",
								this.nodes.attribute,
								"(",
				...
				isShortCircuited() {
					return this.attributes.is_short_circuited || this.nodes.node instanceof D && this.nodes.node.isShortCircuited();
				}
			}
			t(D, "PROPERTY_CALL", 1), t(D, "METHOD_CALL", 2), t(D, "ARRAY_CALL", 3);
			class O extends v {
				constructor(e, n) {
					super({
						expr1: e,
					...
					}), t(this, "evaluate", (e, t) => (this.nodes.expr1 instanceof D && this._addNullCoalesceAttributeToGetAttrNodes(this.nodes.expr1), this.nodes.expr1.evaluate(e, t) ?? this.nodes.expr2.evaluate(e, t))), t(this, "toArray", () => [
						"(",
						this.nodes.expr1,
						") ?? (",
						this.nodes.expr2,
				...
				constructor(e = {}) {
					t(this, "functions", {}), t(this, "unaryOperators", {
						...
						for (; n.test(a.OPERATOR_TYPE) && this.binaryOperators[n.value] !== void 0 && this.binaryOperators[n.value] !== null && this.binaryOperators[n.value].precedence >= e;) {
							...
							t = new y(n.value, t, r), n = this.tokenStream.current;
						}
						...
						if (e.test(a.OPERATOR_TYPE) && this.unaryOperators[e.value] !== void 0 && this.unaryOperators[e.value] !== null) {
							...
							return this.parsePostfixExpression(new b(e.value, n));
						}
						...
						for (; !this.tokenStream.current.test(a.PUNCTUATION_TYPE, "}") && (t || (this.tokenStream.expect(a.PUNCTUATION_TYPE, ",", "A hash value must be followed by a comma"), !this.tokenStream.current.test(a.PUNCTUATION_TYPE, "}")));) {
							t = !1;
							let n = null;
							if (this.tokenStream.current.test(a.STRING_TYPE) || this.tokenStream.current.test(a.NAME_TYPE) || this.tokenStream.current.test(a.NUMBER_TYPE)) n = new x(this.tokenStream.current.value), this.tokenStream.next();
							else {
						...
						for (; a.PUNCTUATION_TYPE === t.type;) {
							if (t.value === "." || t.value === "?.") {
								...
								if (t.value !== "[") break;
								{
									...
									this.tokenStream.expect(a.PUNCTUATION_TYPE, "]"), e = new D(e, t, new E(), D.ARRAY_CALL);
								}
							}
						...
						return this.tokenStream.expect(a.PUNCTUATION_TYPE, ")", "A list of arguments must be closed by a parenthesis"), new v(e);
					...
					switch (e.type) {
						case a.NAME_TYPE:
							switch (this.tokenStream.next(), e.value) {
								case "true":
								case "TRUE": return new x(!0);
								case "false":
								case "FALSE": return new x(!1);
								case "null":
								case "NULL": return new x(null);
								default: if (this.tokenStream.current.value === "(") {
									...
									t = new C(e.value, this.parseArguments());
								} else {
									let n = null;
									if (1 & this.flags) n = e.value;
									else {
										if (!this.hasVariable(e.value)) {
											if (this.tokenStream.current.test(a.PUNCTUATION_TYPE, "??")) return new k(e.value);
							...
							break;
						case a.NUMBER_TYPE:
						case a.STRING_TYPE: return this.tokenStream.next(), new x(e.value);
			...
			class j {
				constructor(e) {
					...
					}), t(this, "raw", (e) => (this.source += e, this)), t(this, "string", (e) => (this.source += "\"" + _(e, "\0	\"$\\") + "\"", this)), t(this, "repr", (e, t = !1) => {
						if (t) this.raw(e);
			...
			class N extends M {
				...
				static fromJSON(e) {
					let t = typeof e == "string" ? JSON.parse(e) : e, n = (e) => {
						if (e == null || e instanceof v || typeof e != "object" || !e.name) return e;
						switch (e.name) {
							case "ConstantNode": return new x(e.attributes?.value, !!e.isIdentifier, !!e.isNullSafe);
							case "NameNode": return new w(e.attributes?.name);
							case "NullCoalescedNameNode": return new k(e.attributes?.name);
							case "UnaryNode": return new b(e.attributes?.operator, n(e.nodes?.node));
							case "BinaryNode": return new y(e.attributes?.operator, n(e.nodes?.left), n(e.nodes?.right));
							case "ConditionalNode": return new S(n(e.nodes?.expr1), n(e.nodes?.expr2), n(e.nodes?.expr3));
							case "NullCoalesceNode": return new O(n(e.nodes?.expr1), n(e.nodes?.expr2));
							case "ArgumentsNode": {
								let t = new E();
							...
							case "FunctionNode": {
								...
								return new C(e.attributes?.name, t);
							}
							case "GetAttrNode": {
								let t = new D(n(e.nodes?.node), n(e.nodes?.attribute), n(e.nodes?.fnArguments), e.attributes?.type);
			...
			class F {
				constructor(e = 0) {
					t(this, "createCacheItem", (e, t, n) => {
						...
						for (let t of e) typeof t == "string" || this.expiries[t] || I.validateKey(t);
						...
						return !0;
					}), t(this, "save", (e) => !(!e instanceof I) && (e.expiry !== null && e.expiry <= (/* @__PURE__ */ new Date()).getTime() / 1e3 ? (this.deleteItem(e.key), !0) : (e.expiry === null && 0 < e.defaultLifetime && (e.expiry = (/* @__PURE__ */ new Date()).getTime() / 1e3 + e.defaultLifetime), this.values[e.key] = e.value, this.expiries[e.key] = e.expiry || 2 ** 53 - 1, !0))), t(this, "saveDeferred", (e) => this.save(e)), t(this, "commit", () => !0), t(this, "delete", (e) => this.deleteItem(e)), t(this, "getValues", () => this.values), t(this, "hasItem", (e) => !!(typeof e == "string" && this.expiries[e] && this.expiries[e] > (/* @__PURE__ */ new Date()).getTime() / 1e3) || (I.validateKey(e), !!this.expiries[e] && !this.deleteItem(e))), t(this, "clear", () => (this.values = {}, this.expiries = {}, !0)), t(this, "deleteItem", (e) => (typeof e == "string" && this.expiries[e] || I.validateKey(e), delete this.values[e], delete this.expiries[e], !0)), t(this, "reset", () => {
						this.clear();
			...
			P = I, t(I, "METADATA_EXPIRY_OFFSET", 1527506807), t(I, "RESERVED_CHARACTERS", [
				"{",
				"}",
				"(",
				")",
				...
				for (let t of P.RESERVED_CHARACTERS) if (e.indexOf(t) >= 0) throw Error(`Cache key "${e}" contains reserved character "${t}".`);
				return e;
			});
			...
			class L {
				...
				static fromJavascript(e, t = null) {
					...
					let n = e.replace(/^\/+/, ""), r = n.split("."), i = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof l < "u" ? l : {};
					for (let e of r) {
						if (i == null) break;
						i = i[e];
					}
			...
			class R {
				constructor(e = null, n = []) {
					t(this, "compile", (e, t = []) => this.getCompiler().compile(this.parse(e, t).getNodes()).getSource()), t(this, "evaluate", (e, t = {}) => this.parse(e, Object.keys(t)).getNodes().evaluate(this.functions, t)), t(this, "parse", (e, t, n = 0) => {
						...
						return a === null && (a = new N(e, this.getParser().parse(this.getLexer().tokenize(e), t, n)), i.set(a), this.cache.save(i)), a;
					}), t(this, "lint", (e, t = null, n = 0) => {
						t === null && (console.log("Deprecated: passing \"null\" as the second argument of lint is deprecated, pass IGNORE_UNKNOWN_VARIABLES instead as the third argument"), n |= 1, t = []), e instanceof N || this.getParser().lint(this.getLexer().tokenize(e), t, n);
					...
					}), t(this, "getLexer", () => (this.lexer === null && (this.lexer = { tokenize: o }), this.lexer)), t(this, "getParser", () => (this.parser === null && (this.parser = new A(this.functions)), this.parser)), t(this, "getCompiler", () => (this.compiler === null && (this.compiler = new j(this.functions)), this.compiler.reset())), this.functions = [], this.lexer = null, this.parser = null, this.compiler = null, this.cache = e || new F(), this._registerBuiltinFunctions();
					for (let e of n) this.registerProvider(e);
				}
				_registerBuiltinFunctions() {
					let e = L.fromJavascript("Math.min", "min"), t = L.fromJavascript("Math.max", "max");
					this.addFunction(e), this.addFunction(t), this.addFunction(new L("constant", function(e) {
						...
						let n = (r = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof l < "u" ? l : {}, t.split(".").reduce((e, t) => e?.[t], r));
						var r;
						return n === void 0 && e && Object.prototype.hasOwnProperty.call(e, t) && (n = e[t]), n;
					})), this.addFunction(new L("enum", function(e) {
						...
						var r;
						return n ? (r = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof l < "u" ? l : {}, n.split(".").reduce((e, t) => e?.[t], r)) : void 0;
					}));
				}
			}
			class z {
			...
			let W = typeof window == "object" && window !== null ? window : typeof l == "object" && l ? l : {};
			function ne() {
				let e = (() => {
					let e = W.$locutus;
			...
			let ae = new L("implode", function(e, t) {
				return `implode(${e}, ${t})`;
			}, function(e, t, n) {
				return (function(...e) {
					let t, n = "", r = "", i = "";
			...
			}), oe = new L("count", function(e, t) {
				let n = "";
				return t && (n = `, ${t}`), `count(${e}${n})`;
			}, function(e, t, n) {
				return q(t, n);
			}), se = new L("array_intersect", function(e, ...t) {
				let n = "";
			...
			e.AbstractProvider = z, e.ArrayAdapter = F, e.ArrayProvider = class extends z {
				getFunctions() {
					return [
						ae,
						oe,
			...
			}, e.BasicProvider = class extends z {
				getFunctions() {
					return [te];
				}
			}, e.Compiler = j, e.DateProvider = class extends z {
				getFunctions() {
					return [new L("date", function(e, t) {
						let n = "";
						return t && (n = `, ${t}`), `date(${e}${n})`;
					}, function(e, t, n) {
						return ce(t, n);
					}), new L("strtotime", function(e, t) {
						let n = "";
						...
						return (function(e, t) {
							...
							for (; e.length;) {
								...
								if (!n || !t || n.callback && n.callback.apply(i, t) === !1) return !1;
			...
			}, e.ExpressionFunction = L, e.ExpressionLanguage = R, e.IGNORE_UNKNOWN_FUNCTIONS = 2, e.IGNORE_UNKNOWN_VARIABLES = 1, e.Parser = A, e.StringProvider = class extends z {
				getFunctions() {
					return [
						new L("strtolower", (e) => "strtolower(" + e + ")", (e, t) => (function(e) {
							return (e + "").toLowerCase();
						})(t)),
						new L("strtoupper", (e) => "strtoupper(" + e + ")", (e, t) => (function(e) {
							return (e + "").toUpperCase();
						})(t)),
						new L("explode", (e, t, n = "null") => `explode(${e}, ${t}, ${n})`, (e, t, n, r = null) => (function(...e) {
							let [t, n, r] = e, i = t, a = n;
							if (e.length < 2 || i === void 0 || a === void 0) return null;
							if (i === "" || i === !1 || i === null) return !1;
						...
						new L("strlen", function(e) {
							...
							return (function(e) {
								...
								for (n = 0, r = 0; n < t.length; n++) i(t, n) !== !1 && r++;
								return r;
							})(t);
						}),
						new L("strstr", function(e, t, n) {
							let r = "";
			...
			}, e.default = R, e.tokenize = o, Object.defineProperty(e, "__esModule", { value: !0 });
		}), (function(e) {
...
var h = m(), g = /* @__PURE__ */ e({
	__proto__: null,
	default: /* @__PURE__ */ u(h)
}, [h]), _ = null;
function v() {
	let e = g, t = e.ExpressionLanguage || e.default || g;
...
function j(e) {
	return E ? Array.from(E.segment(e)).length : Array.from(e).length;
}
function M(e) {
	return e.match(D)?.length || 0;
}
function N(e) {
	let t = k(e), n = A(e);
	return {
...
//#endregion
export { w as a, N as c, s as i, c as n, x as o, S as r, b as s, T as t };
