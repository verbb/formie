...
const bi = {
  ...
  "address-finder": () => import("./address-finder-B6Ey5MHv.js").then((e) => e.addressFinderModule),
  "google-address": () => import("./google-address-unhR5t6E.js").then((e) => e.googleAddressModule),
  loqate: () => import("./loqate-BLabART5.js").then((e) => e.loqateModule),
  "place-kit": () => import("./place-kit-DPUUh5uh.js").then((e) => e.placeKitModule)
}, yi = {
  ...
  "captcha-eu": () => import("./captcha-eu-2JblmXdK.js").then((e) => e.captchaEuModule),
  "friendly-captcha-v1": () => import("./friendly-captcha-v1-B-tYLynY.js").then((e) => e.friendlyCaptchaV1Module),
  "friendly-captcha-v2": () => import("./friendly-captcha-v2-BiY55pFE.js").then((e) => e.friendlyCaptchaV2Module),
  hcaptcha: () => import("./hcaptcha-D-rzkXtS.js").then((e) => e.hcaptchaModule),
  "recaptcha-enterprise": () => import("./recaptcha-enterprise-DkPUPlap.js").then((e) => e.recaptchaEnterpriseModule),
  "recaptcha-v2-checkbox": () => import("./recaptcha-v2-checkbox-ClQ-K1Es.js").then((e) => e.recaptchaV2CheckboxModule),
  "recaptcha-v2-invisible": () => import("./recaptcha-v2-invisible-Cp4eHjf3.js").then((e) => e.recaptchaV2InvisibleModule),
  "recaptcha-v3": () => import("./recaptcha-v3-DLAhuQUy.js").then((e) => e.recaptchaV3Module),
  snaptcha: () => import("./snaptcha-CTHOwMl7.js").then((e) => e.snaptchaModule),
  turnstile: () => import("./turnstile-j3-ESx1Z.js").then((e) => e.turnstileModule)
}, vi = {
  ...
  calculations: () => import("./calculations-CUM0U8wk.js").then((e) => e.calculationsModule),
  "checkbox-radio": () => import("./checkbox-radio-CP6ToH_-.js").then((e) => e.checkboxRadioModule),
  conditions: () => import("./conditions-Bo1BNWEj.js").then((e) => e.conditionsModule),
  "date-picker": () => import("./date-picker-BKuNTGcx.js").then((e) => e.datePickerModule),
  "file-upload": () => import("./file-upload-VJfFqmAa.js").then((e) => e.fileUploadModule),
  hidden: () => import("./hidden-BetJMPu1.js").then((e) => e.hiddenModule),
  "phone-country": () => import("./phone-country-CAfmY0Qm.js").then((e) => e.phoneCountryModule),
  repeater: () => import("./repeater-Dc9p-ARe.js").then((e) => e.repeaterModule),
  "rich-text": () => import("./rich-text-B3DIJoOp.js").then((e) => e.richTextModule),
  signature: () => import("./signature-QdPrRYVJ.js").then((e) => e.signatureModule),
  summary: () => import("./summary-BkCQ9WFi.js").then((e) => e.summaryModule),
  table: () => import("./table-BBFJeehq.js").then((e) => e.tableModule),
  "text-limit": () => import("./text-limit-C1bygi2D.js").then((e) => e.textLimitModule)
}, Ei = {
  ...
  bpoint: () => import("./bpoint-Dy4duf3r.js").then((e) => e.bpointModule),
  eway: () => import("./eway-BCJpwpaQ.js").then((e) => e.ewayModule),
  "go-cardless": () => import("./go-cardless-Y-91bC38.js").then((e) => e.goCardlessModule),
  mollie: () => import("./mollie-DZ4qEtBT.js").then((e) => e.mollieModule),
  moneris: () => import("./moneris-qltIKbL0.js").then((e) => e.monerisModule),
  opayo: () => import("./opayo-DsZvt-Im.js").then((e) => e.opayoModule),
  paddle: () => import("./paddle-CLrYLYGx.js").then((e) => e.paddleModule),
  paypal: () => import("./paypal-C8CCyPS-.js").then((e) => e.paypalModule),
  payway: () => import("./payway-BWxTa8GZ.js").then((e) => e.paywayModule),
  square: () => import("./square-COQOA_6K.js").then((e) => e.squareModule),
  stripe: () => import("./stripe-BUXc7y6c.js").then((e) => e.stripeModule)
}, Si = {
  ...vi,
  ...bi,
  ...yi,
