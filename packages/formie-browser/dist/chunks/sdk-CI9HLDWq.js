...
var s = class {
	...
	registerTargetIFrame(t, n, r, i) {
		let o = e(), s = new Promise((e) => setTimeout(() => e("timeout"), i)), c = new a({
			id: n,
			element: r,
			type: t,
			onReady: () => o.resolve("registered")
		});
		return this.registerTarget(c), Promise.race([o.promise, s]);
	}
	removeTarget(e) {
...
var u = "frc_sc", d = "frc_sid", f = "__", p = !1, m = "0", h = "__" + c(10);
function g(e) {
	if (!p) {
		let t = 0;
		try {
		...
		isNaN(t) && (t = 0), e && t++, m = t.toString();
		try {
			sessionStorage.setItem(u, m);
		} catch {}
	}
	return m;
}
...
}, y = typeof navigator < "u" && navigator.userAgentData !== void 0;
function b() {
...
var A = "FrcFrameId", j = "frc-i-agent", oe = "frc-i-widget", se = "frc-widget-placeholder";
function ce(e, t, n) {
	let i = {
	...
	a.className = j, a.dataset[A] = t, a.src = n + "?" + r(i), a.frcSDK = e;
	let o = a.style;
	return o.width = o.height = o.border = o.visibility = "0", o.display = "none", a;
}
function le(e, t, n, i) {
	let a = document.createElement("iframe"), o = N(i), s = {
		origin: document.location.origin,
		sess_id: _(),
		sess_c: g(!0),
		comm_id: t,
	...
	i.theme && (s.theme = i.theme), y && (a.allow = "clipboard-write"), a.frameBorder = "0", a.src = n + "?" + r(s), a.className = oe, a.title = O(o), a.dataset[A] = t;
	let c = a.style;
	return c.border = c.visibility = "0", c.position = "absolute", c.height = c.width = "100%", c.userSelect = "none", c["-webkit-tap-highlight-color"] = "transparent", c.display = "none", i.element.appendChild(a), a;
}
function ue(e) {
	let t = document.createElement("div");
	t.classList.add(se);
	let n = t.style, r = e.theme === "dark" || e.theme === "auto" && window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches;
	return n.color = r ? "#fff" : "#222", n.backgroundColor = r ? "#171717" : "#fafafa", n.borderRadius = "4px", n.border = "1px solid", n.borderColor = "#ddd", n.padding = "8px", n.height = n.width = "100%", n.fontSize = "14px", n.boxSizing = "border-box", M(n), e.element.appendChild(t), t;
}
function M(e) {
...
function de(e) {
	...
	let n = N(e), r = e.theme === "dark" || e.theme === "auto" && window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches, i = "#565656", a = "#a2a2a2";
	r && (i = "#a2a2a2", a = "#565656");
	let o = t.style;
	...
	let c = s.style;
	M(c), c.color = i, c.fontSize = "10px", c.userSelect = "none", c.textDecorationLine = "underline", c.textDecorationThickness = "1px", c.textDecorationColor = a, c.letterSpacing = "-0.0125rem", s.target = "_blank", s.textContent = "Friendly Captcha", s.onmouseenter = () => c.textDecorationColor = i, s.onmouseleave = () => c.textDecorationColor = a, t.appendChild(s), e.element.appendChild(t);
}
function N(e) {
	let t = e.language;
...
function fe(e, t, n) {
	let r = (e, t) => {
		...
		let r = n.style;
		return M(r), r.textDecoration = "underline", r.color = "#565656", n.onmouseenter = () => r.textDecoration = "none", n.onmouseleave = () => r.textDecoration = "underline", n;
	}, i = k(n, "failed"), a = [r(`${t}/connectionTest`, i)];
...
function pe(e, t, n, r) {
	let i = P(), a = n.getBoundingClientRect(), o = {
		v: 1,
		tt: e,
		pnow: i,
		sm: t,
...
var me = "frc-captcha-response", he = class {
	constructor(e) {
		...
		this.e.frcWidget = this, this.formFieldName = t.formFieldName === void 0 ? me : t.formFieldName, this.sitekey = t.sitekey, this._reset = e.callbacks.onReset, this._destroy = e.callbacks.onDestroy, this._trigger = e.callbacks.onTrigger, this.startMode = e.createOpts.startMode || "focus", this.formFieldName !== null && (this.hiddenFormEl = ee(this.e, this.formFieldName)), this.setState({
	...
	handleStartMode() {
		if (this.startMode === "focus" && !this.focusEventPending && !this.isDestroyed) {
			let e = x(this.e);
			e && (this.focusEventPending = !0, S(e, (e) => {
	...
	trigger(e, t = {}) {
		...
		let n = pe(e, this.startMode, this.e, t.ev);
	...
	let t = [], n = /* @__PURE__ */ new Map(), r = function() {
		...
		let t = ge(this) ? n.get(this) : !1, r = this === s ? o : t || this;
		return o.apply(r, e);
	};
...
var L = "addEventListener", R = Math, ve;
function z() {
...
function ye(e) {
	let t = [];
	for (let n = 0; n < e.length; n++) t.push(0), document[L](e[n], (e) => t[n]++);
	return t;
}
function be() {
	let e = [
	...
	return document[L]("keydown", (n) => {
		let r = n.keyCode;
		t[r] ? e[t[r]]++ : r >= 112 && r <= 123 && e[0]++;
	}), e;
}
function V(e, t, n, r) {
	return R.sqrt(R.pow(e - t, 2) + R.pow(n - r, 2));
}
function H(e, t, n) {
...
var xe = class {
	constructor(e) {
		...
		let t = this.smel, n = (e) => {
			t.n || (t.fts = e.timeStamp, t.fxy = [
				e.clientX,
				e.clientY,
				e.screenX,
				e.screenY
			]), t.n++, e.type === "mouseleave" && (t.d += e.timeStamp - t.ts), t.ts = e.timeStamp, t.xy = [e.clientX, e.clientY];
		}, r = document;
		C(() => {
			let e = r.body;
			e[L]("mouseenter", n), e[L]("mouseleave", n);
		}), this.bh = {
			onoff: {
				kdu: B("keydown", "keyup"),
				cse: B("compositionstart", "compositionend"),
				mdu: B("mousedown", "mouseup"),
				mle: B("mouseleave", "mouseenter"),
				med: B("mouseenter", "mousedown", !0),
				semd: B("scrollend", "mousedown", !0, r),
				se: B("scroll", "scrollend", !1, r),
				pdc: B("pointerdown", "pointercancel", !0),
				mmc: B("mousemove", "click", !0),
				tse: B("touchstart", "touchend"),
				fikd: B("focusin", "keydown", !0)
			},
			nev: ye([
				"mouseout",
				"pointercancel",
		...
		}, this.dep = e.disableEvalPatching || !1, this.takeTraceRecords = _e(e);
	}
	setupMovementMetrics() {
		let e, t = [], n = I(), r = I(), i = I(), a = {
			t: n.s,
			v: i.s,
			d: r.s,
			ns: 0
			...
			let o = t[t.length - 1];
			if (t.length >= 1e4 / 50 || o && (o[0] && this.tm.timeStamp === o[1] || !o[0] && this.mm.timeStamp === o[1])) {
				if (clearInterval(e), e = void 0, t.length === 1) {
					a.ns++, t = [];
					return;
				}
				let s = t[0];
				n.add(o[1] - s[1]), r.add(V(o[2], s[2], o[3], s[3]));
				for (let e = 1; e < t.length; e++) {
					let n = t[e], r = t[e - 1], a = V(n[2], r[2], n[3], r[3]) * 1e3, o = n[1] - r[1];
					i.add(a / o);
				}
				t = [];
				return;
	...
	setupOrientationMetrics() {
		...
		if (!z()) return n;
		let r;
		return window[L]("deviceorientation", (i) => {
			i.gamma == null || i.beta == null || i.alpha == null || (n.ts = i.timeStamp, n.a = i.alpha, n.b = i.beta, n.g = i.gamma, r ? (e.add(U(i.gamma, n.g)), t.add(U(n.b, i.beta))) : (n.fts = n.ts, r = !0));
		}), n;
	}
	gmm() {
		let e = this.mm;
...
var W = (e) => e.map((e) => `https://${e}.frcapi.com`).join(","), G = {
	eu: W([
		"eu",
		"eu0",
		"eu1"
...
}, K = (e) => e.split(",").map((e) => e.trim()).filter((e) => !!e), Ce = (e) => K(G[e] || e);
function q(e) {
	let t = K(e || G.global).reduce((e, t) => e.concat(Ce(t)), []).map(i);
	return t.length > 0 ? t : K(G.global).map(i);
}
function we() {
	let e = document.querySelector("meta[name=\"frc-disable-eval-patching\"]");
	return e ? !!e.content : !1;
}
function J() {
	let e = document.querySelector("meta[name=\"frc-api-endpoint\"]");
...
function Ee(e) {
	return window.TextEncoder ? De(new TextEncoder().encode(e)) : "";
}
function De(e) {
	let t = e.length, n = "";
	for (let r = 0; r < t; r += 3) {
		let t = e[r + 0], i = e[r + 1], a = e[r + 2], o = "";
		o += Y.charAt(t >>> 2), o += Y.charAt((t & 3) << 4 | i >>> 4), o += Y.charAt((i & 15) << 2 | a >>> 6), o += Y.charAt(a & 63), n += o;
	}
	return t % 3 == 2 ? n = n.substring(0, n.length - 1) + "=" : t % 3 == 1 && (n = n.substring(0, n.length - 2) + "=="), n;
}
var Oe = "frc-risk-intelligence-token", ke = class {
	constructor(e) {
		...
		this.e.frcRiskIntelligence = this, this.formFieldName = e.formFieldName === void 0 ? Oe : e.formFieldName, this.formFieldName !== null && (this.hiddenFormEl = ee(this.e, this.formFieldName)), this.startMode = e.startMode || "focus", this.requestRiskIntelligence = e.riskIntelligence, this.handleStartMode();
	}
	handleStartMode() {
...
var Me = "/api/v2/captcha/agent", Ne = "/api/v2/captcha/widget", Z = "FrcFrameId", Pe = "FrcAgentOriginKey", Fe = 1e3 * 60 * 60 * 36, Ie = 5, Q, $ = 0, Le = class {
	constructor(t = {}) {
		if (this.agents = /* @__PURE__ */ new Map(), this.agentState = /* @__PURE__ */ new Map(), this.widgets = /* @__PURE__ */ new Map(), this._attached = e(), this.attached = this._attached.promise, this.riskIntelligencePromises = /* @__PURE__ */ new Map(), this.clearRiskIntelligencePromises = /* @__PURE__ */ new Map(), this.riskIntelligenceHandles = [], this.apiEndpoint = t.apiEndpoint, Q ||= new s(), Q.listen((e) => this.onReceiveMessage(e)), this.bus = Q, $++, $ > 1 && console.warn("Multiple Friendly Captcha SDKs created, this is not recommended. Please use a single SDK instance."), this.signals = Se({ disableEvalPatching: t.disableEvalPatching || we() }), t.startAgent) {
			let e = q(this.apiEndpoint || J()), t = this.getRetryOrigins(e);
	...
	ensureAgentIFrame(e) {
		let t = 1, n = e[X(t, e)], r = n + Me, i = Ie, a = this.agents.get(n);
		if (a && a.dataset[Z]) return a.dataset[Z];
		let o = document.getElementsByClassName(j);
		for (let e = 0; e < o.length; e++) {
			let t = o[e];
			if (t.dataset[Pe] === n && t.dataset[Z]) return this.agents.set(n, t), t.dataset[Z];
		}
		let s = "a_" + c(12), l = ce(this, s, r);
		l.dataset[Pe] = n;
		let u = l.src, d = n;
		...
		let f = () => {
			this.bus.registerTargetIFrame("agent", s, l, this.getRetryTimeout(t)).then((r) => {
				if (r === "timeout") {
					...
					let r = t + 1;
					d = e[X(r, e)] || d, console.warn("[Friendly Captcha] Retrying agent iframe load."), l.src = je(u, d, r - 1), t = r, f();
				}
			});
		};
		return f(), s;
	...
	attach(e) {
		...
		for (let e = 0; e < n.length; e++) {
			...
			if (t && !t.frcRiskIntelligence) {
				...
				this.riskIntelligenceHandles.push(new ke({
					element: t,
	...
	createWidget(t) {
		let n = q(t.apiEndpoint || this.apiEndpoint || J()), r = this.getRetryOrigins(n), a = 1;
		this.bus.addOrigins(n);
		let o = r[X(a, r)] || n[0], s = this.ensureAgentIFrame(r), l = "w_" + c(12), u = (e) => {
			let t = {
				from_id: l,
				to_id: s,
				_frc: 1
			...
			onDestroy: () => {
				u({ type: "root_destroy_widget" }), this.bus.removeTarget(l), this.widgets.delete(l), t.element.innerHTML = "", re(t.element);
			},
			onReset: () => {
		...
		let m = le(s, l, o + Ne, t), h = Ie, g = m.src, _ = o, v = ue(t);
		ne(t.element), de(t);
		let y = N(t);
		D(y) && (t.element.dir = "rtl");
		let b = v.style;
		v.textContent = k(y, "connecting");
		function x(e) {
			let n = Ee(JSON.stringify({
				sdk_v: "1.0.0",
				sitekey: t.sitekey || "",
				retry: a + "",
				endpoint: _,
		...
		let S = () => {
			this.bus.registerTargetIFrame("widget", l, m, this.getRetryTimeout(a)).then((e) => {
				if (e === "timeout") {
					if (a >= h) {
						console.error(`[Friendly Captcha] Failed to load widget iframe after ${a - 1} retries.`), x("Widget load timeout, stopped retrying"), b.borderColor = "#f00", b.fontSize = "12px", fe(v, i(m.src), y);
						return;
					}
					let e = a + 1;
					_ = r[X(e, r)] || _, b.backgroundColor = "#fee", b.color = "#222", v.textContent = k(y, "retrying") + ` (${a})`, console.warn(`[Friendly Captcha] Retrying widget ${l} iframe load.`), x("Widget load timeout, will retry"), m.src = je(g, _, e - 1), a = e, S();
	...
	riskIntelligence(t) {
		let n = q(t.apiEndpoint || this.apiEndpoint || J()), r = this.getRetryOrigins(n);
		this.bus.addOrigins(n);
...
}, Re = "frc:widget.statechange", ze = "frc:widget.complete", Be = "frc:widget.expire", Ve = "frc:widget.error", He = "frc:widget.reset", Ue = "frc:riskintelligence.complete", We = "frc:riskintelligence.error", Ge = "frc:riskintelligence.expire";
//#endregion
export { Ue as FRCRiskIntelligenceCompleteEventName, We as FRCRiskIntelligenceErrorEventName, Ge as FRCRiskIntelligenceExpireEventName, ze as FRCWidgetCompleteEventName, Ve as FRCWidgetErrorEventName, Be as FRCWidgetExpireEventName, He as FRCWidgetResetEventName, Re as FRCWidgetStateChangeEventName, Le as FriendlyCaptchaSDK };
