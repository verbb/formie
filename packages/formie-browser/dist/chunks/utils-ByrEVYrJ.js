...
(function() {
	...
	function v(a, b) {
		if (q(a, b)) a = r(a, b);
			...
			a = a.j[b];
			if (a.j === void 0) if (b = a.u, b === Boolean) a.j = !1;
	...
	function Pa() {
		return ";ext=" + M("20") + "|[ \xA0\\t,]*(?:e?xt(?:ensi(?:ó?|ó))?n?|ｅ?ｘｔｎ?|доб|anexo)[:\\.．]?[ \xA0\\t,-]*" + (M("20") + "#?|[ \xA0\\t,]*(?:[xｘ#＃~～]|int|ｉｎｔ)[:\\.．]?[ \xA0\\t,-]*") + (M("9") + "#?|[- ]+") + (M("6") + "#|[ \xA0\\t]*(?:,{2}|;)[:\\.．]?[ \xA0\\t,-]*") + (M("15") + "#?|[ \xA0\\t]*(?:,)+[:\\.．]?[ \xA0\\t,-]*") + (M("9") + "#?");
	}
	var Qa = new RegExp("(?:" + Pa() + ")$", "i"), Ra = new RegExp("^[0-9０-９٠-٩۰-۹]{2}$|^[+＋]*(?:[-x‐-―−ー－-／ \xA0­​⁠　()（）［］.\\[\\]/~⁓∼～*]*[0-9０-９٠-٩۰-۹]){3,}[-x‐-―−ー－-／ \xA0­​⁠　()（）［］.\\[\\]/~⁓∼～*A-Za-z0-9０-９٠-٩۰-۹]*(?:" + Pa() + ")?$", "i"), Sa = /(\$\d)/, Ta = /^\(?\$1\)?$/;
	function Ua(a) {
		return a.length < 2 ? !1 : N(Ra, a);
	}
	function Va(a) {
	...
	K.prototype.format = function(a, b) {
		...
		e != null && (g = e, e = v(g, 2), f = new RegExp(r(g, 1)), v(g, 5), g = v(g, 4), d = b == 2 && g != null && g.length > 0 ? d.replace(f, e.replace(Sa, g)) : d.replace(f, e), b == 3 && (d = d.replace(RegExp("^[-x‐-―−ー－-／ \xA0­​⁠　()（）［］.\\[\\]/~⁓∼～]+"), ""), d = d.replace(RegExp("[-x‐-―−ー－-／ \xA0­​⁠　()（）［］.\\[\\]/~⁓∼～]+", "g"), "-")));
		return Za(c, b, d, a);
	};
	function R(a, b, c) {
	...
	function U(a, b) {
		switch (b) {
			...
			case 6: return r(a, 8);
			case 7: return r(a, 7);
			case 8: return r(a, 21);
			case 9: return r(a, 25);
			case 10: return r(a, 28);
			default: return r(a, 1);
		}
	}
	function $a(a, b) {
		var c = ab(a, b);
	...
	function V(a, b) {
		var c = a.length;
		return w(b, 9) > 0 && G(b).indexOf(c) == -1 ? !1 : N(v(b, 2), a);
	}
	function cb(a, b) {
		var c = ab(a, b);
		var d = v(b, 1);
		var e = R(a, d, c);
		e == null || "001" != c && d != db(a, c) ? e = !1 : (a = Q(b), e = bb(a, e) != -1);
		return e;
	}
	function ab(a, b) {
		if (b == null) return null;
	...
	function fb(a, b, c, d, e, f) {
		...
		if (h.length == 0) g = 20;
			...
			if (g.search(h) == 0) {
				...
				l && l[1] != null && l[1].length > 0 && O(l[1], Ea) == "0" ? g = !1 : (D(b), b.g(g.substring(h)), g = !0);
			} else g = !1;
			g = g ? 5 : 20;
		}
		e && t(f, 6, g);
	...
	function hb(a, b, c, d) {
		...
		var h = f;
		h == null ? g = !0 : h.length === 0 ? g = !1 : (g = Na.exec(h), h = Oa.exec(h), g = g !== null || h !== null);
		...
		h != 0 ? (e = S(h), e != c && (g = R(a, h, e))) : (Wa(e), b.g(e.toString()), c != null ? (h = v(g, 10), t(f, 1, h)) : d && (delete f.h[6], f.g && delete f.g[6]));
	...
	function N(a, b) {
		return (a = b.match(new RegExp("^(?:" + (typeof a == "string" ? a : a.source) + ")$", "i"))) && a[0].length == b.length ? !0 : !1;
	}
	function ib(a) {
		this.ga = RegExp(" ");
		this.ka = "";
	...
	var kb = new H();
	t(kb, 11, "NA");
	var lb = RegExp("^[-x‐-―−ー－-／ \xA0­​⁠　()（）［］.\\[\\]/~⁓∼～]*\\$1[-x‐-―−ー－-／ \xA0­​⁠　()（）［］.\\[\\]/~⁓∼～]*(\\$\\d[-x‐-―−ー－-／ \xA0­​⁠　()（）［］.\\[\\]/~⁓∼～]*)*$"), mb = /[- ]/;
	function jb(a, b) {
		var c = a.ha;
		b = P(b) ? db(c, b) : 0;
		a = T(a.ha, S(b));
	...
	function nb(a) {
		for (var b = a.j.length, c = 0; c < b; ++c) {
			...
			l.length > 0 ? (f.$.g(l), f = !0) : f = !1;
			if (f) return a.ea = e, a.ia = mb.test(r(d, 4)), a.ba = 0, !0;
		}
		return a.v = !1;
	}
	function ob(a, b) {
	...
	function pb(a, b) {
		a.u.g(b);
		var c = b;
		Ia.test(c) || a.u.h.length == 1 && Ha.test(c) ? (b == "+" ? (c = b, a.da.g(b)) : (c = Ea[b], a.da.g(c), a.g.g(c)), b = c) : (a.v = !1, a.ma = !0);
		if (!a.v) {
			if (!a.ma) {
				if (qb(a)) {
					if (rb(a)) return sb(a);
		...
		switch (a.da.h.length) {
			case 0:
			case 1:
			case 2: return a.u.toString();
			case 3: if (qb(a)) a.fa = !0;
			else return a.o = tb(a), ub(a);
			default:
				if (a.fa) return rb(a) && (a.fa = !1), a.h.toString() + a.g.toString();
				if (a.j.length > 0) {
					b = vb(a, b);
					c = wb(a);
					if (c.length > 0) return c;
	...
	function tb(a) {
		...
		if (r(a.l, 10) != 1) var d = !1;
		else d = a.g.toString(), d = d.charAt(0) == "1" && d.charAt(1) != "0" && d.charAt(1) != "1";
		d ? (c = 1, a.h.g("1").g(" "), a.aa = !0) : q(a.l, 15) && (d = new RegExp("^(?:" + r(a.l, 15) + ")"), d = b.match(d), d != null && d[0] != null && d[0].length > 0 && (a.aa = !0, c = d[0].length, a.h.g(b.substring(0, c))));
		D(a.g);
		a.g.g(b.substring(c));
	...
	function qb(a) {
		...
		c = b.match(c);
		return c != null && c[0] != null && c[0].length > 0 ? (a.aa = !0, c = c[0].length, D(a.g), a.g.g(b.substring(c)), D(a.h), a.h.g(b.substring(0, c)), b.charAt(0) != "+" && a.h.g(" "), !0) : !1;
	}
	function rb(a) {
		if (a.g.h.length == 0) return !1;
	...
	m("utils.isPossibleNumber", (a, b, c) => {
		try {
			...
			if (c) {
				const f = yb(c);
				for (let g of f) if (X(d, e, zb[g]) === 0) return !0;
				return !1;
			}
			return X(d, e, -1) === 0;
		} catch {
