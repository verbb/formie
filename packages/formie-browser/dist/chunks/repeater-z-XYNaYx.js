import { d as p, c as L, f as y } from "./shared-BDEKVuB5.js";
import { e as M } from "./styles-C3aqgtek.js";
import { j as k, s as A } from "./index-CZtn5KAB.js";
const R = '@layer formie-theme{.formie-repeater-container{display:grid;gap:var(--formie-space-4)}.formie-repeater-item-wrapper{position:relative;display:grid;gap:var(--formie-space-4);padding:var(--formie-space-4);border:var(--formie-border-width) solid var(--formie-color-border-control);border-radius:var(--formie-radius-md);transition:border-color .15s ease,box-shadow .15s ease,background-color .15s ease}.formie-repeater-item-wrapper:focus-within{border-color:var(--formie-focus-ring-border-color);box-shadow:var(--formie-shadow-focus)}.formie-field-has-error .formie-repeater-item-wrapper{border-color:var(--formie-color-danger)}.formie-field-has-error .formie-repeater-item-wrapper:focus-within{box-shadow:var(--formie-shadow-danger-focus)}.formie-repeater-item-wrapper>.formie-repeater-remove-button{position:absolute;top:var(--formie-repeater-remove-button-top);right:var(--formie-repeater-remove-button-right);transform:var(--formie-repeater-remove-button-transform);font-size:0;line-height:0}.formie-button.formie-repeater-add-button{position:relative;display:inline-flex;align-items:center;justify-content:center;width:auto;max-width:100%;justify-self:start;padding-left:var(--formie-repeater-add-button-padding-left)}.formie-button.formie-repeater-add-button:before{position:absolute;content:"";display:block;width:var(--formie-repeater-add-button-width);height:var(--formie-repeater-add-button-height);left:var(--formie-repeater-add-button-left);top:50%;transform:translateY(-50%);background-color:currentColor;-webkit-mask-image:var(--formie-repeater-add-button-icon-mask);mask-image:var(--formie-repeater-add-button-icon-mask);-webkit-mask-repeat:no-repeat;mask-repeat:no-repeat;-webkit-mask-position:center;mask-position:center;-webkit-mask-size:contain;mask-size:contain}}', u = "[data-formie-repeater-field-layout]", h = "[data-formie-repeater-container]", g = "[data-formie-repeater-item]", C = "[data-formie-repeater-add]", H = "[data-formie-repeater-remove]", E = "data-formie-template-id", l = "repeater", s = k("fields", "repeater");
M(l, [R]);
function S(e, o) {
  return y(e, o);
}
...
function I(e) {
  const o = e.matches(h) ? e : e.querySelector(h), t = e.querySelector(C);
  ...
  if (t instanceof HTMLButtonElement && t.addEventListener("click", v), w(), f(t instanceof HTMLButtonElement ? t : null, i(e)), t instanceof HTMLButtonElement && i(e) === 0) {
  ...
  return p(e, l, "init", {
    ...
    t instanceof HTMLButtonElement && t.removeEventListener("click", v), n.forEach((r, a) => {
