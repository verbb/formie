import { t as e } from "./styles-BfoIZwJp.js";
import { r as t, t as n } from "./shared-Bx9s0i0P.js";
...
var s = class e extends a {
	...
	fromData(e, { clear: t = !0 } = {}) {
		t && this.clear(), this._fromData(e, this._drawCurve.bind(this), this._drawDot.bind(this), this._drawLine.bind(this)), this._data = this._data.concat(e);
	}
	toData() {
		return this._data;
	}
	...
	_strokeBegin(e) {
		...
		switch (e.event.type) {
			...
			case "touchstart":
				...
				break;
			case "pointerdown": t("pointermove", this._handlePointerMove, { passive: !1 }), t("pointerup", this._handlePointerUp, { passive: !1 }), t("pointercancel", this._handlePointerCancel, { passive: !1 });
		}
	...
	_getDotSize(e) {
		return e.dotSize > 0 ? e.dotSize : (e.minWidth + e.maxWidth) / 2;
	}
	_drawDot(e, t) {
		let n = this._ctx, r = this._getDotSize(t);
		n.beginPath(), this._drawCurveSegment(e.x, e.y, r), n.closePath(), n.fillStyle = t.penColor, n.fill();
	}
	_drawLine(e, t, n) {
		let r = this._ctx;
		r.save(), r.beginPath(), r.moveTo(e.x, e.y), r.lineTo(t.x, t.y), r.lineWidth = this._getDotSize(n) * 2, r.lineCap = "round", r.strokeStyle = n.penColor, r.stroke(), r.restore(), this._isEmpty = !1;
	}
	_fromData(e, t, n, i) {
		for (let a of e) {
			let { points: e } = a, o = this._getPointGroupOptions(a);
			if (e.length > 2) for (let n = 0; n < e.length; n += 1) {
				let i = e[n], a = new r(i.x, i.y, i.pressure, i.time);
				n === 0 && this._reset(o);
				let s = this._addPoint(a, o);
				s && t(s, o);
			}
			else e.length === 2 ? (this._reset(o), i(e[0], e[1], o)) : (this._reset(o), n(e[0], o));
		}
	}
	toSVG({ includeBackgroundColor: e = !1, includeDataUrl: t = !1 } = {}) {
		...
		return this._fromData(n, (e, { penColor: t }) => {
			...
			let r = document.createElement("line");
			r.setAttribute("x1", e.x.toString()), r.setAttribute("y1", e.y.toString()), r.setAttribute("x2", t.x.toString()), r.setAttribute("y2", t.y.toString()), r.setAttribute("stroke", n.penColor), r.setAttribute("stroke-width", (this._getDotSize(n) * 2).toString()), r.setAttribute("stroke-linecap", "round"), o.appendChild(r);
		}), o.outerHTML;
	}
...
function x(e, t, n) {
	...
	if (r) {
		if (n) {
			r.textContent = n, r.hidden = !1, t.setAttribute("aria-hidden", "true"), e.classList.add("formie-signature-has-message");
			return;
		}
		r.textContent = "", r.hidden = !0, t.removeAttribute("aria-hidden"), e.classList.remove("formie-signature-has-message");
	}
}
function S(e) {
	return !e.hasAttribute("hidden") && !e.hasAttribute("data-formie-conditionally-hidden") && !e.hasAttribute("data-formie-page-hidden") && !e.hasAttribute("data-formie-row-hidden") && e.getClientRects().length > 0;
}
function C(e, t) {
	if (!t) return;
	let n = new Image();
