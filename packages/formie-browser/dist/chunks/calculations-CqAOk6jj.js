...
import { n as r, r as i } from "./field-references.resolver-DVyat1BQ.js";
import { r as a, t as o } from "./shared-Bx9s0i0P.js";
import { a as s, i as c, o as l, r as u, t as d } from "./dist-DXR-E56t.js";
...
function y(e, t, n) {
	...
	if (i === "index") {
		let e = `${a}.${Number.parseInt(String(t.index ?? "0"), 10)}.${o}`;
		return r(e, n);
	}
	if (i === "all") {
...
function w(e, t, n) {
	...
	return t.forEach(([e, t]) => {
		...
		if (String(n.scope || "").trim()) {
			let r = y(t.sourceKey || "", n, a);
			o[e] = l(t, r.value);
			return;
		}
		let i = r(t.sourceKey || "", a);
		o[e] = l(t, i.value);
	}), u(o, n.formatting);
}
function T(e, r) {
	...
	return r.forEach(([, e]) => {
		...
		if (String(r.scope || "").trim()) {
			v(e.sourceKey || "", r, a).forEach((e) => {
				o.add(e);
			});
			return;
		}
		let i = t(e.sourceKey || ""), s = a.get(i);
		if (s?.names?.length) {
			s.names.forEach((e) => {
				o.add(e);
			});
...
function E(e, t, n, r) {
	let i = c(r), a = s(r), l = /* @__PURE__ */ new Map(), u = null, f = !1, p = !1, m = !1, h = () => {
		l.forEach((e, t) => {
			e.forEach((e, n) => {
		...
		if (o(t, S, "before-evaluate", l), !l.formula) {
			let e = n.value !== "";
			n.value = "", g(e);
			return;
		}
