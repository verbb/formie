...
const bi = {
  ...
  "address-finder": () => import("./address-finder-D_sEu2m4.js").then((e) => e.addressFinderModule),
  "google-address": () => import("./google-address-BtVYlZre.js").then((e) => e.googleAddressModule),
  loqate: () => import("./loqate-NSj_LBYS.js").then((e) => e.loqateModule),
  "place-kit": () => import("./place-kit-DyzihMpx.js").then((e) => e.placeKitModule)
}, yi = {
  ...
  "captcha-eu": () => import("./captcha-eu-_ACyer0f.js").then((e) => e.captchaEuModule),
  "friendly-captcha-v1": () => import("./friendly-captcha-v1-BO0vqhqr.js").then((e) => e.friendlyCaptchaV1Module),
  "friendly-captcha-v2": () => import("./friendly-captcha-v2-CQdmruoW.js").then((e) => e.friendlyCaptchaV2Module),
  hcaptcha: () => import("./hcaptcha-BDK8NsJ-.js").then((e) => e.hcaptchaModule),
  "recaptcha-enterprise": () => import("./recaptcha-enterprise-DROgEe0h.js").then((e) => e.recaptchaEnterpriseModule),
  "recaptcha-v2-checkbox": () => import("./recaptcha-v2-checkbox-C4sf6Wzw.js").then((e) => e.recaptchaV2CheckboxModule),
  "recaptcha-v2-invisible": () => import("./recaptcha-v2-invisible-CAMvhJ-g.js").then((e) => e.recaptchaV2InvisibleModule),
  "recaptcha-v3": () => import("./recaptcha-v3-sQ6zXY-N.js").then((e) => e.recaptchaV3Module),
  snaptcha: () => import("./snaptcha-t-Y4DazY.js").then((e) => e.snaptchaModule),
  turnstile: () => import("./turnstile-C-gVQVaj.js").then((e) => e.turnstileModule)
}, vi = {
  ...
  calculations: () => import("./calculations-BCFXPUhK.js").then((e) => e.calculationsModule),
  "checkbox-radio": () => import("./checkbox-radio-DJEB0rXk.js").then((e) => e.checkboxRadioModule),
  conditions: () => import("./conditions-B0DMhCr3.js").then((e) => e.conditionsModule),
  "date-picker": () => import("./date-picker-B4SnuY2t.js").then((e) => e.datePickerModule),
  "file-upload": () => import("./file-upload-CJ06VUG3.js").then((e) => e.fileUploadModule),
  hidden: () => import("./hidden-SFTgnaFL.js").then((e) => e.hiddenModule),
  "phone-country": () => import("./phone-country-Bzp6Z6cS.js").then((e) => e.phoneCountryModule),
  repeater: () => import("./repeater-BpIrAkCT.js").then((e) => e.repeaterModule),
  "rich-text": () => import("./rich-text-LHWHyYo8.js").then((e) => e.richTextModule),
  signature: () => import("./signature-BPFW652-.js").then((e) => e.signatureModule),
  summary: () => import("./summary-B_3kxSZ7.js").then((e) => e.summaryModule),
  table: () => import("./table-EIRv5IFO.js").then((e) => e.tableModule),
  "text-limit": () => import("./text-limit-C4Syc1BG.js").then((e) => e.textLimitModule)
}, Ei = {
  ...
  bpoint: () => import("./bpoint-CLCmn4AI.js").then((e) => e.bpointModule),
  eway: () => import("./eway-BVofpU06.js").then((e) => e.ewayModule),
  "go-cardless": () => import("./go-cardless-D1hMqk7-.js").then((e) => e.goCardlessModule),
  mollie: () => import("./mollie-BeXtsT94.js").then((e) => e.mollieModule),
  moneris: () => import("./moneris-B0MXw-HY.js").then((e) => e.monerisModule),
  opayo: () => import("./opayo-sKbqItjp.js").then((e) => e.opayoModule),
  paddle: () => import("./paddle-4YBOwTav.js").then((e) => e.paddleModule),
  paypal: () => import("./paypal-CqNiwZCv.js").then((e) => e.paypalModule),
  payway: () => import("./payway-CuNQiGAl.js").then((e) => e.paywayModule),
  square: () => import("./square-Df0-ALm_.js").then((e) => e.squareModule),
  stripe: () => import("./stripe-CJOBTVFT.js").then((e) => e.stripeModule)
}, Si = {
  ...vi,
  ...bi,
  ...yi,
