...
var _ = /* @__PURE__ */ c((/* @__PURE__ */ o(((e, t) => {
	(function(n, r) {
		...
		class N {
			constructor(e = 0) {
				t(this, "createCacheItem", (e, t, n) => {
					...
					for (let t of e) typeof t == "string" || this.expiries[t] || P.validateKey(t);
					...
					return !0;
				}), t(this, "save", (e) => !(!e instanceof P) && (e.expiry !== null && e.expiry <= (/* @__PURE__ */ new Date()).getTime() / 1e3 ? (this.deleteItem(e.key), !0) : (e.expiry === null && 0 < e.defaultLifetime && (e.expiry = (/* @__PURE__ */ new Date()).getTime() / 1e3 + e.defaultLifetime), this.values[e.key] = e.value, this.expiries[e.key] = e.expiry || 2 ** 53 - 1, !0))), t(this, "saveDeferred", (e) => this.save(e)), t(this, "commit", () => !0), t(this, "delete", (e) => this.deleteItem(e)), t(this, "getValues", () => this.values), t(this, "hasItem", (e) => !!(typeof e == "string" && this.expiries[e] && this.expiries[e] > (/* @__PURE__ */ new Date()).getTime() / 1e3) || (P.validateKey(e), !!this.expiries[e] && !this.deleteItem(e))), t(this, "clear", () => (this.values = {}, this.expiries = {}, !0)), t(this, "deleteItem", (e) => (typeof e == "string" && this.expiries[e] || P.validateKey(e), delete this.values[e], delete this.expiries[e], !0)), t(this, "reset", () => {
					this.clear();
		...
		M = P, t(P, "METADATA_EXPIRY_OFFSET", 1527506807), t(P, "RESERVED_CHARACTERS", [
			"{",
			"}",
			"(",
			")",
			...
			for (let t of M.RESERVED_CHARACTERS) if (e.indexOf(t) >= 0) throw Error(`Cache key "${e}" contains reserved character "${t}".`);
			return e;
		});
		...
		class ne {
			constructor(e = null, n = []) {
				t(this, "compile", (e, t = []) => this.getCompiler().compile(this.parse(e, t).getNodes()).getSource()), t(this, "evaluate", (e, t = {}) => this.parse(e, Object.keys(t)).getNodes().evaluate(this.functions, t)), t(this, "parse", (e, t, n = 0) => {
					...
					return a === null && (a = new j(e, this.getParser().parse(this.getLexer().tokenize(e), t, n)), i.set(a), this.cache.save(i)), a;
				}), t(this, "lint", (e, t = null, n = 0) => {
					t === null && (console.log("Deprecated: passing \"null\" as the second argument of lint is deprecated, pass IGNORE_UNKNOWN_VARIABLES instead as the third argument"), n |= 1, t = []), e instanceof j || this.getParser().lint(this.getLexer().tokenize(e), t, n);
				}), t(this, "fixedEncodeURIComponent", (e) => encodeURIComponent(e).replace(/[!'()*]/g, function(e) {
					return "%" + e.charCodeAt(0).toString(16);
				})), t(this, "register", (e, t, n) => {
					if (this.parser !== null) throw new te("Registering functions after calling evaluate(), compile(), or parse() is not supported.");
					this.functions[e] = {
						compiler: t,
						evaluator: n
					};
			...
			_registerBuiltinFunctions() {
				...
				})), this.addFunction(new F("enum", function(e) {
		...
		let se = typeof window == "object" && window !== null ? window : typeof global == "object" && global !== null ? global : {};
		function ce() {
			let e = (() => {
				let e = se.$locutus;
				typeof e == "object" && e || (e = {}, se.$locutus = e);
				let t = e.php;
		...
		function ue(e, t, n) {
			...
			}(e), i = le("unicode.semantics") === "on" ? r.match(/[\uD800-\uDBFF][\uDC00-\uDFFF]|[\s\S]/g) || [] : null, a = i ? i.length : r.length, o = a;
		...
		let pe = new F("implode", function(e, t) {
			return `implode(${e}, ${t})`;
		}, function(e, t, n) {
			return function(...e) {
				let t, n = "", r = "", i = "";
		...
		}), me = new F("count", function(e, t) {
			let n = "";
			return t && (n = `, ${t}`), `count(${e}${n})`;
		}, function(e, t, n) {
			return R(t, n);
		}), he = new F("array_intersect", function(e, ...t) {
			let n = "";
		...
		let z = "[ \\t]*", _e = "(?:([ap])\\.?m\\.?([\\t ]|$))", B = "(2[0-4]|[01]?[0-9])", ve = "([01][0-9]|2[0-4])", V = "(0?[1-9]|1[0-2])", ye = "([0-5][0-9])", be = "sunday|monday|tuesday|wednesday|thursday|friday|saturday|sun|mon|tue|wed|thu|fri|sat|weekdays?", xe = "next|last|previous|this";
		"" + be;
		let H = "([0-9]{4})", Se = "(1[0-2]|0?[0-9])", U = "(0[0-9]|1[0-2])", W = "(?:(3[01]|[0-2]?[0-9])(?:st|nd|rd|th)?)", G = "(0[0-9]|[1-2][0-9]|3[01])", Ce = "january|february|march|april|may|june|july|august|september|october|november|december", we = "jan|feb|mar|apr|may|jun|jul|aug|sept?|oct|nov|dec", K = "(" + Ce + "|jan|feb|mar|apr|may|jun|jul|aug|sept?|oct|nov|dec|i[vx]|vi{0,3}|xi{0,2}|i{1,3})";
		"" + B;
		let q = K + "[ .\\t-]*(?:(3[01]|[0-2]?[0-9])(?:st|nd|rd|th)?)[,.stndrh\\t ]*";
		function J(e, t) {
		...
		let Te = {
			...
			backOrFrontOf: {
				regex: RegExp("^(back|front) of " + B + z + _e + "?", "i"),
				name: "backof | frontof",
				callback(e, t, n, r) {
					let i = +n, a = 15;
			...
			xmlRpc: {
				regex: RegExp("^" + H + U + G + "T(2[0-4]|[01]?[0-9]):([0-5][0-9]):(60|[0-5][0-9])"),
				name: "xmlrpc",
				callback(e, t, n, r, i, a, o) {
					return this.ymd(+t, n - 1, +r) && this.time(+i, +a, +o, 0);
				}
			...
			xmlRpcNoColon: {
				regex: RegExp("^" + H + U + G + "[Tt](2[0-4]|[01]?[0-9])([0-5][0-9])(60|[0-5][0-9])"),
				name: "xmlrpcnocolon",
				callback(e, t, n, r, i, a, o) {
					return this.ymd(+t, n - 1, +r) && this.time(+i, +a, +o, 0);
				}
			...
			dateTextual: {
				regex: RegExp("^" + K + "[ .\\t-]*(?:(3[01]|[0-2]?[0-9])(?:st|nd|rd|th)?)[,.stndrh\\t ]+([0-9]{1,4})", "i"),
				name: "datetextual",
				callback(e, t, n, r) {
			...
			pgTextReverse: {
				regex: RegExp("^(\\d{3,4}|[4-9]\\d|3[2-9])-(" + we + ")-(0[0-9]|[1-2][0-9]|3[01])", "i"),
				name: "pgtextreverse",
				callback(e, t, n, r) {
			...
			pgTextShort: {
				regex: RegExp("^(" + we + ")-(0[0-9]|[1-2][0-9]|3[01])-([0-9]{1,4})", "i"),
				name: "pgtextshort",
				callback(e, t, n, r) {
					return this.ymd(Y(r), X(t), +n);
				}
			...
			relative: {
				regex: RegExp("^([+-]*)[ \\t]*(\\d+)" + z + "((?:second|sec|minute|min|hour|day|fortnight|forthnight|month|year)s?|weeks|sunday|monday|tuesday|wednesday|thursday|friday|saturday|sun|mon|tue|wed|thu|fri|sat|weekdays?|week)", "i"),
				name: "relative",
				callback(e, t, n, r) {
			...
			monthFullOrMonthAbbr: {
				regex: RegExp("^(" + Ce + "|jan|feb|mar|apr|may|jun|jul|aug|sept?|oct|nov|dec)", "i"),
			...
			dateShortWithTimeLong: {
				regex: RegExp("^" + q + "t?(2[0-4]|[01]?[0-9])[:.]([0-5]?[0-9])[:.](60|[0-5]?[0-9])", "i"),
			...
			dateShortWithTimeLong12: {
				regex: RegExp("^" + q + V + "[:.]([0-5]?[0-9])[:.](60|[0-5][0-9])[ \\t]*(?:([ap])\\.?m\\.?([\\t ]|$))", "i"),
			...
			dateShortWithTimeShort: {
				regex: RegExp("^" + q + "t?(2[0-4]|[01]?[0-9])[:.]([0-5]?[0-9])", "i"),
			...
			dateShortWithTimeShort12: {
				regex: RegExp("^" + q + V + "[:.]([0-5][0-9])[ \\t]*(?:([ap])\\.?m\\.?([\\t ]|$))", "i"),
		...
		e.AbstractProvider = I, e.ArrayAdapter = N, e.ArrayProvider = class extends I {
			getFunctions() {
				return [
					pe,
					me,
		...
		}, e.Compiler = A, e.DateProvider = class extends I {
			getFunctions() {
				return [new F("date", function(e, t) {
					let n = "";
					return t && (n = `, ${t}`), `date(${e}${n})`;
				}, function(e, t, n) {
					return ge(t, n);
				}), new F("strtotime", function(e, t) {
					let n = "";
		...
		}, e.ExpressionFunction = F, e.ExpressionLanguage = ne, e.IGNORE_UNKNOWN_FUNCTIONS = 2, e.IGNORE_UNKNOWN_VARIABLES = 1, e.Parser = k, e.StringProvider = class extends I {
			getFunctions() {
				return [
					new F("strtolower", (e) => "strtolower(" + e + ")", (e, t) => function(e) {
						return (e + "").toLowerCase();
					}(t)),
					new F("strtoupper", (e) => "strtoupper(" + e + ")", (e, t) => function(e) {
						return (e + "").toUpperCase();
					}(t)),
					new F("explode", (e, t, n = "null") => `explode(${e}, ${t}, ${n})`, (e, t, n, r = null) => function(...e) {
						let [t, n, r] = e, i = t, a = n;
					...
					new F("strlen", function(e) {
						return `strlen(${e});`;
					}, function(e, t) {
						return function(e) {
							let t = e + "";
							if ((le("unicode.semantics") || "off") === "off") return t.length;
		...
		}, e.default = ne, e.tokenize = o, Object.defineProperty(e, "__esModule", { value: !0 });
	}), function(e) {
...
//#endregion
export { g as a, S as c, C as i, T as n, h as o, N as r, E as s, x as t };
