const i={minHeight:420,modules:[{id:"calculations",type:"field",targets:[{targetType:"field",targetId:"estimateTotal"}],config:{options:{formula:{expression:"a + b",variables:{a:{sourceKey:"fieldA"},b:{sourceKey:"fieldB"}}},formatting:"number",decimals:0}}}],markup:String.raw`
