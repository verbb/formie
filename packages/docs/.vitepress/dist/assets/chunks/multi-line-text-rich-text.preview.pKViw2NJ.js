const e={minHeight:360,modules:[{id:"rich-text",type:"field",targets:[{targetType:"field",targetId:"projectBrief"}],config:{options:{buttons:["bold","italic","ulist","link"]}}}],markup:String.raw`
