...
var i = class i extends n {
	...
	_fromData(t, n, r, i) {
		for (let a of t) {
			let { points: t } = a, o = this._getPointGroupOptions(a);
			if (t.length > 2) for (let r = 0; r < t.length; r += 1) {
				let i = t[r], a = new e(i.x, i.y, i.pressure, i.time);
				r === 0 && this._reset(o);
				let s = this._addPoint(a, o);
				s && n(s, o);
			}
			else t.length === 2 ? (this._reset(o), i(t[0], t[1], o)) : (this._reset(o), r(t[0], o));
		}
	}
