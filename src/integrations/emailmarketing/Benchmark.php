...
class Benchmark extends EmailMarketing
{
    ...
    {
        return Craft::$app->getAssetManager()->getPublishedUrl('@verbb/formie/web/assets/emailmarketing/dist/img/benchmark.svg', true);
    }
    ...
    {
        return Craft::$app->getView()->renderTemplate('formie/integrations/email-marketing/benchmark/_plugin-settings', [
            'integration' => $this,
        ]);
    }
    ...
    {
        return Craft::$app->getView()->renderTemplate('formie/integrations/email-marketing/benchmark/_form-settings', [
            'integration' => $this,
            'form' => $form,
