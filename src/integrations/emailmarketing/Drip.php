...
class Drip extends EmailMarketing
{
    ...
    {
        return Craft::$app->getAssetManager()->getPublishedUrl('@verbb/formie/web/assets/emailmarketing/dist/img/drip.svg', true);
    }
    ...
    {
        return Craft::$app->getView()->renderTemplate('formie/integrations/email-marketing/drip/_plugin-settings', [
            'integration' => $this,
        ]);
    }
    ...
    {
        return Craft::$app->getView()->renderTemplate('formie/integrations/email-marketing/drip/_form-settings', [
            'integration' => $this,
            'form' => $form,
