...
class iContact extends EmailMarketing
{
    ...
    {
        return Craft::$app->getAssetManager()->getPublishedUrl('@verbb/formie/web/assets/emailmarketing/dist/img/icontact.svg', true);
    }
    ...
    {
        return Craft::$app->getView()->renderTemplate('formie/integrations/email-marketing/icontact/_plugin-settings', [
            'integration' => $this,
        ]);
    }
    ...
    {
        return Craft::$app->getView()->renderTemplate('formie/integrations/email-marketing/icontact/_form-settings', [
            'integration' => $this,
            'form' => $form,
