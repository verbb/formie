...
class Moosend extends EmailMarketing
{
    ...
    {
        return Craft::$app->getAssetManager()->getPublishedUrl('@verbb/formie/web/assets/emailmarketing/dist/img/moosend.svg', true);
    }
    ...
    {
        return Craft::$app->getView()->renderTemplate('formie/integrations/email-marketing/moosend/_plugin-settings', [
            'integration' => $this,
        ]);
    }
    ...
    {
        return Craft::$app->getView()->renderTemplate('formie/integrations/email-marketing/moosend/_form-settings', [
            'integration' => $this,
            'form' => $form,
