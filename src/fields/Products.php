    ...
    public function defineFormBuilderGeneralSchema(): array
    {
        ...
        return [
            ...
            SchemaHelper::checkboxSelectField([
                ...
                'instructions' => Craft::t('formie', 'Which sources do you want to select products from?'),
                'name' => 'sources',
                'showAllOption' => true,
                'options' => $options,
                'validation' => 'required',
            ...
            SchemaHelper::elementSelectField([
                ...
                'instructions' => Craft::t('formie', 'Select a default product to be selected.'),
                'name' => 'defaultValue',
    ...
    public function defineFormBuilderSettingsSchema(): array
    {
        return [
            ...
            SchemaHelper::numberField([
                ...
                'instructions' => Craft::t('formie', 'Limit the number of selectable products.'),
                'name' => 'limit',
            ]),
            SchemaHelper::numberField([
                'label' => Craft::t('formie', 'Limit Options'),
                'instructions' => Craft::t('formie', 'Limit the number of available products.'),
                'name' => 'limitOptions',
            ]),
            SchemaHelper::selectField([
                'label' => Craft::t('formie', 'Label Source'),
                'instructions' => Craft::t('formie', 'Select what to use as the label for each product.'),
                'name' => 'labelSource',
                'options' => $this->getLabelSourceOptions(),
            ]),
            SchemaHelper::selectField([
                'label' => Craft::t('formie', 'Options Order'),
                'instructions' => Craft::t('formie', 'Select what order to show products by.'),
                'name' => 'orderBy',
