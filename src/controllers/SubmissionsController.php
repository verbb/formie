...
class SubmissionsController extends Controller
{
    ...
    public function actionSubmit()
    {
        ...
        // Check if we're overriding the incomplete/complete state
        if ((bool)$request->getParam('isIncomplete')) {
            $submission->isIncomplete = true;
            $submission->validateCurrentPageOnly = true;
        }
    ...
    public function actionSubmitUpload()
    {
        ...
        if ($submission->hasErrors()) {
            ...
            // if ($request->getAcceptsJson()) {
                return $this->_returnJsonResponse(false, $submission, $form, null, [
                    'errors' => $errors,
                    // 'errorMessage' => $errorMessage,
                ]);
            // }
        ...
        // if ($request->getAcceptsJson()) {
            return $this->_returnJsonResponse($success, $submission, $form, null);
        // }
