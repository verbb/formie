...
var FormieRecaptchaEnterprise = /*#__PURE__*/function (_FormieCaptchaProvide) {
  _inherits(FormieRecaptchaEnterprise, _FormieCaptchaProvide);

  var _super = _createSuper(FormieRecaptchaEnterprise);
  ...
  function FormieRecaptchaEnterprise() {
    ...
    _this.recaptchaScriptId = 'FORMIE_RECAPTCHA_SCRIPT'; // Fetch and attach the script only once - this is in case there are multiple forms on the page.
    // They all go to a single callback which resolves its loaded state

    if (!document.getElementById(_this.recaptchaScriptId)) {
      var $script = document.createElement('script');
      $script.id = _this.recaptchaScriptId;
      $script.src = "https://www.google.com/recaptcha/enterprise.js?onload=formieRecaptchaOnLoadCallback&render=explicit&hl=".concat(_this.language);
    ...
    _inc_recaptcha__WEBPACK_IMPORTED_MODULE_1__.recaptchaEnterprise.checkRecaptchaLoad(); // We can have multiple captchas per form, so store them and render only when we need
    ...
    _this.form.addEventListener(_this.$form, (0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.eventKey)('onFormieCaptchaValidate', 'RecaptchaEnterprise'), _this.onValidate.bind(_assertThisInitialized(_this)));

    _this.form.addEventListener(_this.$form, (0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.eventKey)('onAfterFormieSubmit', 'RecaptchaEnterprise'), _this.onAfterSubmit.bind(_assertThisInitialized(_this)));
  ...
  _createClass(FormieRecaptchaEnterprise, [{
    ...
    value: function renderCaptcha() {
      ...
      _inc_recaptcha__WEBPACK_IMPORTED_MODULE_1__.recaptchaEnterprise.render(this.createInput(), {
    ...
    value: function onValidate(e) {
      ...
      _inc_recaptcha__WEBPACK_IMPORTED_MODULE_1__.recaptchaEnterprise.execute(this.recaptchaId);
    }
  }, {
    key: "onVerify",
    ...
    value: function onExpired() {
      ...
      _inc_recaptcha__WEBPACK_IMPORTED_MODULE_1__.recaptchaEnterprise.reset(this.recaptchaId);
    }
  }, {
    key: "onError",
