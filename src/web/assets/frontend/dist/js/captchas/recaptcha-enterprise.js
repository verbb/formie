...
var FormieRecaptchaEnterprise = /*#__PURE__*/function (_FormieCaptchaProvide) {
  ...
  function FormieRecaptchaEnterprise() {
    ...
    _this = _callSuper(this, FormieRecaptchaEnterprise, [settings]);
    ...
    _this.type = settings.enterpriseType;
  ...
  _createClass(FormieRecaptchaEnterprise, [{
    ...
    value: function onHide() {
      ...
      this.form.removeEventListener((0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.eventKey)('onFormieCaptchaValidate', 'RecaptchaEnterprise'));
      this.form.removeEventListener((0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.eventKey)('onAfterFormieSubmit', 'RecaptchaEnterprise'));
    }
  }, {
    key: "initCaptcha",
    value: function initCaptcha() {
      ...
      this.form.addEventListener(this.$form, (0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.eventKey)('onFormieCaptchaValidate', 'RecaptchaEnterprise'), this.onValidate.bind(this));
      this.form.addEventListener(this.$form, (0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.eventKey)('onAfterFormieSubmit', 'RecaptchaEnterprise'), this.onAfterSubmit.bind(this));
    }
  }, {
    key: "renderCaptcha",
    value: function renderCaptcha() {
      ...
      var size = this.type === 'checkbox' ? '' : 'invisible';

      // Render the recaptcha
      _inc_recaptcha__WEBPACK_IMPORTED_MODULE_0__.recaptchaEnterprise.render(this.createInput(), {
