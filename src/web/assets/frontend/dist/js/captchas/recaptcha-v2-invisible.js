...
var FormieRecaptchaV2Invisible = /*#__PURE__*/function (_FormieCaptchaProvide) {
  ...
  var _super = _createSuper(FormieRecaptchaV2Invisible);
  ...
  function FormieRecaptchaV2Invisible() {
    ...
    _this.form.addEventListener(_this.$form, (0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.eventKey)('onFormieCaptchaValidate', 'RecaptchaV2Invisible'), _this.onValidate.bind(_assertThisInitialized(_this)));

    _this.form.addEventListener(_this.$form, (0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.eventKey)('onAfterFormieSubmit', 'RecaptchaV2Invisible'), _this.onAfterSubmit.bind(_assertThisInitialized(_this)));
  ...
  _createClass(FormieRecaptchaV2Invisible, [{
    ...
    value: function renderCaptcha() {
      ...
      var hasMultiplePages = this.$form.form.settings.hasMultiplePages; // Get the current page's captcha
    ...
    value: function onValidate(e) {
      ...
      _inc_recaptcha__WEBPACK_IMPORTED_MODULE_1__.recaptcha.execute(this.recaptchaId);
    }
  }, {
    key: "onVerify",
