...
var FormieTurnstile = /*#__PURE__*/function (_FormieCaptchaProvide) {
  ...
  function FormieTurnstile() {
    ...
    _this = _callSuper(this, FormieTurnstile, [settings]);
    ...
    _this.appearance = settings.appearance;
    _this.turnstileScriptId = 'FORMIE_TURNSTILE_SCRIPT';
  ...
  _createClass(FormieTurnstile, [{
    ...
    value: function onHide() {
      ...
      this.form.removeEventListener((0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.eventKey)('onFormieCaptchaValidate', 'Turnstile'));
      this.form.removeEventListener((0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.eventKey)('onAfterFormieSubmit', 'Turnstile'));
    }
  }, {
    key: "initCaptcha",
    value: function initCaptcha() {
      ...
      if (!document.getElementById(this.turnstileScriptId)) {
        ...
        (0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.ensureVariable)('turnstile').then(function () {
          _this2.renderCaptcha();
        });
      }
      ...
      this.form.addEventListener(this.$form, (0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.eventKey)('onFormieCaptchaValidate', 'Turnstile'), this.onValidate.bind(this));
      this.form.addEventListener(this.$form, (0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.eventKey)('onAfterFormieSubmit', 'Turnstile'), this.onAfterSubmit.bind(this));
    }
  }, {
    key: "renderCaptcha",
    value: function renderCaptcha() {
      ...
      _inc_turnstile__WEBPACK_IMPORTED_MODULE_0__.turnstile.render(this.createInput(), {
