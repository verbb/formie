...
var FormieRecaptchaV3 = /*#__PURE__*/function (_FormieCaptchaProvide) {
  _inherits(FormieRecaptchaV3, _FormieCaptchaProvide);

  var _super = _createSuper(FormieRecaptchaV3);
  ...
  function FormieRecaptchaV3() {
    ...
    _this.form.addEventListener(_this.$form, (0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.eventKey)('onFormieCaptchaValidate', 'RecaptchaV3'), _this.onValidate.bind(_assertThisInitialized(_this)));

    _this.form.addEventListener(_this.$form, (0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.eventKey)('onAfterFormieSubmit', 'RecaptchaV3'), _this.onAfterSubmit.bind(_assertThisInitialized(_this)));
