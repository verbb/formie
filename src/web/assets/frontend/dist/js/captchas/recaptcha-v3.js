...
var FormieRecaptchaV3 = /*#__PURE__*/function (_FormieCaptchaProvide) {
  ...
  function FormieRecaptchaV3() {
    ...
    _this = _callSuper(this, FormieRecaptchaV3, [settings]);
  ...
  _createClass(FormieRecaptchaV3, [{
    ...
    value: function onHide() {
      ...
      this.form.removeEventListener((0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.eventKey)('onFormieCaptchaValidate', 'RecaptchaV3'));
      this.form.removeEventListener((0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.eventKey)('onAfterFormieSubmit', 'RecaptchaV3'));
    }
  }, {
    key: "initCaptcha",
    value: function initCaptcha() {
      ...
      this.form.addEventListener(this.$form, (0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.eventKey)('onFormieCaptchaValidate', 'RecaptchaV3'), this.onValidate.bind(this));
      this.form.addEventListener(this.$form, (0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.eventKey)('onAfterFormieSubmit', 'RecaptchaV3'), this.onAfterSubmit.bind(this));
    }
  }, {
    key: "renderCaptcha",
