...
var FormieRecaptchaV2Checkbox = /*#__PURE__*/function (_FormieCaptchaProvide) {
  ...
  function FormieRecaptchaV2Checkbox() {
    ...
    _this = _callSuper(this, FormieRecaptchaV2Checkbox, [settings]);
    ...
    _this.errorMessageClass = _this.form.getClasses('errorMessage');
  ...
  _createClass(FormieRecaptchaV2Checkbox, [{
    ...
    value: function onHide() {
      ...
      this.form.removeEventListener((0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.eventKey)('onBeforeFormieSubmit', 'RecaptchaV2'));
      this.form.removeEventListener((0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.eventKey)('onFormieCaptchaValidate', 'RecaptchaV2'));
      this.form.removeEventListener((0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.eventKey)('onAfterFormieSubmit', 'RecaptchaV2'));
    }
  }, {
    key: "initCaptcha",
    value: function initCaptcha() {
      ...
      this.form.addEventListener(this.$form, (0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.eventKey)('onBeforeFormieSubmit', 'RecaptchaV2'), this.onBeforeSubmit.bind(this));
      this.form.addEventListener(this.$form, (0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.eventKey)('onFormieCaptchaValidate', 'RecaptchaV2'), this.onValidate.bind(this));
      this.form.addEventListener(this.$form, (0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.eventKey)('onAfterFormieSubmit', 'RecaptchaV2'), this.onAfterSubmit.bind(this));
    }
  }, {
    key: "renderCaptcha",
