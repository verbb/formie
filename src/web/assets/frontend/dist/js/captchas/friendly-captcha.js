...
(() => {
/*!*********************************************!*\
  !*** ./src/js/captchas/friendly-captcha.js ***!
  \*********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "FormieFriendlyCaptcha": () => (/* binding */ FormieFriendlyCaptcha)
/* harmony export */ });
...
var FormieFriendlyCaptcha = /*#__PURE__*/function (_FormieCaptchaProvide) {
  _inherits(FormieFriendlyCaptcha, _FormieCaptchaProvide);

  var _super = _createSuper(FormieFriendlyCaptcha);

  function FormieFriendlyCaptcha() {
    var _this;

    var settings = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    _classCallCheck(this, FormieFriendlyCaptcha);

    _this = _super.call(this, settings);
    _this.$form = settings.$form;
    _this.form = _this.$form.form;
    _this.siteKey = settings.siteKey;
    _this.language = settings.language; // We can have multiple captchas per form, so store them and render only when we need

    _this.$placeholders = _this.$form.querySelectorAll('[data-friendly-captcha-placeholder]');
    ...
    _this.form.addEventListener(_this.$form, (0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.eventKey)('onFormieCaptchaValidate', 'FriendlyCaptcha'), _this.onValidate.bind(_assertThisInitialized(_this)));

    _this.form.addEventListener(_this.$form, (0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.eventKey)('onAfterFormieSubmit', 'FriendlyCaptcha'), _this.onAfterSubmit.bind(_assertThisInitialized(_this)));

    return _this;
  }

  _createClass(FormieFriendlyCaptcha, [{
    key: "renderCaptcha",
    value: function renderCaptcha() {
      ...
      var $token = this.$form.querySelector('[name="frc-captcha-solution"]');
      ...
      this.widget = new friendly_challenge__WEBPACK_IMPORTED_MODULE_0__.WidgetInstance(this.createInput(), {
    ...
    value: function onValidate(e) {
      ...
      this.submitHandler = e.detail.submitHandler; // Trigger captcha - unless we've already verified
