  ...
  _createClass(FormieFormTheme, [{
    ...
    value: function addLoading() {
      if (this.$submitBtn) {
        ...
        if (this.settings.loadingIndicator === 'spinner') {
          (0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.addClasses)(this.$submitBtn, this.loadingClass);
        }
    ...
    value: function removeLoading() {
      if (this.$submitBtn) {
        ...
        if (this.settings.loadingIndicator === 'spinner') {
          (0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.removeClasses)(this.$submitBtn, this.loadingClass);
        }
        if (this.settings.loadingIndicator === 'text') {
    ...
    value: function showTabErrors(errors) {
      ...
      Object.keys(errors).forEach(function (pageId, index) {
        ...
        if ($tab) {
          (0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.addClasses)($tab.parentNode, _this4.tabErrorClass);
        }
      });
    }
  }, {
    ...
    value: function removeTabErrors() {
      ...
      $tabs.forEach(function ($tab) {
        (0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.removeClasses)($tab, _this5.tabErrorClass);
      });
    }
  }, {
    key: "beforeSubmit",
      ...
      if (data.nextPageId) {
        $tabs.forEach(function ($tab) {
          ...
          if ($tab.id === "".concat(_this9.tabClass, "-").concat(data.nextPageId)) {
            (0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.addClasses)($tab, _this9.tabActiveClass);
          } else {
            (0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.removeClasses)($tab, _this9.tabActiveClass);
          }
        });
        var isComplete = true;
        $tabs.forEach(function ($tab) {
          ...
          if (isComplete) {
            (0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.addClasses)($tab, _this9.tabCompleteClass);
          } else {
            (0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.removeClasses)($tab, _this9.tabCompleteClass);
          }
        });
...
/* harmony import */ var _minmax__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./minmax */ "./src/js/validator/rules/minmax.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  minmax: _minmax__WEBPACK_IMPORTED_MODULE_3__["default"]
});
...
/***/ "./src/js/validator/rules/minmax.js":
/*!******************************************!*\
  !*** ./src/js/validator/rules/minmax.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var message = function message(_ref2) {
  ...
  if (min !== null && max !== null) {
    return "".concat(label, " must be between ").concat(min, " and ").concat(max, ".");
  }
  if (min !== null) {
    return "".concat(label, " must be no less than ").concat(min, ".");
  }
  if (max !== null) {
    return "".concat(label, " must be no greater than ").concat(max, ".");
  }
  return "".concat(label, " has an invalid value.");
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  rule: rule,
  message: message
...
var FormieValidator = /*#__PURE__*/function () {
  ...
  _createClass(FormieValidator, [{
    ...
    value: function removeError(input) {
      ...
      (0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.removeClasses)(fieldContainer, this.config.fieldContainerErrorClass);
      (0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.removeClasses)(input, this.config.inputErrorClass);
    ...
    value: function showError(input, validatorName, errorMessage) {
      ...
      if (!errorMessages) {
        ...
        (0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.addClasses)(errorMessages, this.config.messagesClass);
      ...
      if (!errorElement) {
        ...
        (0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.addClasses)(_errorElement, this.config.messageClass);
        ...
        var errorKey = "error-".concat(fieldContainer.getAttribute('data-field-handle'));
        if (!this.errorIds[errorKey]) {
          this.errorIds[errorKey] = "".concat(errorKey, "-").concat(Math.random().toString(20).substr(2, 5));
        }
        var errorId = this.errorIds[errorKey];
        ...
        _errorElement.setAttribute('id', errorId);
        _errorElement.setAttribute('aria-live', 'polite');
        _errorElement.setAttribute('aria-atomic', true);
      }

      // Add error classes to field and field container
      (0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.addClasses)(fieldContainer, this.config.fieldContainerErrorClass);
      (0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.addClasses)(input, this.config.inputErrorClass);
...
/***/ "./src/scss/formie-base-layer.scss":
/*!*****************************************!*\
  !*** ./src/scss/formie-base-layer.scss ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/scss/formie-theme-layer.scss":
/*!******************************************!*\
  !*** ./src/scss/formie-theme-layer.scss ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 			"css/formie-theme-layer": 0,
/******/ 			"css/formie-base-layer": 0,
/******/ 			"css/formie-theme": 0,
/******/ 			"css/formie-base": 0,
/******/ 			"css/fields/tags": 0,
/******/ 			"css/fields/stripe": 0
...
/******/ 	__webpack_require__.O(undefined, ["css/fields/phone-country","css/formie-theme-layer","css/formie-base-layer","css/formie-theme","css/formie-base","css/fields/tags","css/fields/stripe"], () => (__webpack_require__("./src/js/formie.js")))
/******/ 	__webpack_require__.O(undefined, ["css/fields/phone-country","css/formie-theme-layer","css/formie-base-layer","css/formie-theme","css/formie-base","css/fields/tags","css/fields/stripe"], () => (__webpack_require__("./src/scss/formie-base.scss")))
/******/ 	__webpack_require__.O(undefined, ["css/fields/phone-country","css/formie-theme-layer","css/formie-base-layer","css/formie-theme","css/formie-base","css/fields/tags","css/fields/stripe"], () => (__webpack_require__("./src/scss/formie-theme.scss")))
/******/ 	__webpack_require__.O(undefined, ["css/fields/phone-country","css/formie-theme-layer","css/formie-base-layer","css/formie-theme","css/formie-base","css/fields/tags","css/fields/stripe"], () => (__webpack_require__("./src/scss/formie-base-layer.scss")))
/******/ 	__webpack_require__.O(undefined, ["css/fields/phone-country","css/formie-theme-layer","css/formie-base-layer","css/formie-theme","css/formie-base","css/fields/tags","css/fields/stripe"], () => (__webpack_require__("./src/scss/formie-theme-layer.scss")))
/******/ 	__webpack_require__.O(undefined, ["css/fields/phone-country","css/formie-theme-layer","css/formie-base-layer","css/formie-theme","css/formie-base","css/fields/tags","css/fields/stripe"], () => (__webpack_require__("./src/scss/fields/phone-country.scss")))
/******/ 	__webpack_require__.O(undefined, ["css/fields/phone-country","css/formie-theme-layer","css/formie-base-layer","css/formie-theme","css/formie-base","css/fields/tags","css/fields/stripe"], () => (__webpack_require__("./src/scss/fields/stripe.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/fields/phone-country","css/formie-theme-layer","css/formie-base-layer","css/formie-theme","css/formie-base","css/fields/tags","css/fields/stripe"], () => (__webpack_require__("./src/scss/fields/tags.scss")))
