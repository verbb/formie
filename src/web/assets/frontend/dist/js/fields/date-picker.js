...
/***/ "../../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[9].oneOf[1].use[1]!../../../../node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[9].oneOf[1].use[2]!../../../../node_modules/flatpickr/dist/flatpickr.min.css":
/*!************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ../../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[9].oneOf[1].use[1]!../../../../node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[9].oneOf[1].use[2]!../../../../node_modules/flatpickr/dist/flatpickr.min.css ***!
  \************************************************************************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _laravel_mix_node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_9_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_9_oneOf_1_use_2_flatpickr_min_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../laravel-mix/node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[9].oneOf[1].use[1]!../../postcss-loader/dist/cjs.js??ruleSet[1].rules[9].oneOf[1].use[2]!./flatpickr.min.css */ "../../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[9].oneOf[1].use[1]!../../../../node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[9].oneOf[1].use[2]!../../../../node_modules/flatpickr/dist/flatpickr.min.css");
...
var update = _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_laravel_mix_node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_9_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_9_oneOf_1_use_2_flatpickr_min_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_laravel_mix_node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_9_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_9_oneOf_1_use_2_flatpickr_min_css__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});
...
(() => {
/*!**************************************!*\
  !*** ./src/js/fields/date-picker.js ***!
  \**************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "FormieDatePicker": () => (/* binding */ FormieDatePicker)
/* harmony export */ });
...
__webpack_require__(/*! flatpickr/dist/flatpickr.min.css */ "../../../../node_modules/flatpickr/dist/flatpickr.min.css"); // A Flatpickr plugin to copy all attributes on the input to the `altInput` for accessibility
  ...
  return function (fp) {
    return {
      onReady: function onReady() {
        var excludedAttributes = ['type', 'name', 'value']; // Copy all attributes from normal input to `altInput` - except some

        fp.input.getAttributeNames().forEach(function (attribute) {
...
var FormieDatePicker = /*#__PURE__*/function () {
  function FormieDatePicker() {
    var settings = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    _classCallCheck(this, FormieDatePicker);
    ...
    this.availableDaysOfWeek = settings.availableDaysOfWeek; // Resolve the correct, full date-time format
    ...
    if (this.getIsDate) {
      ...
      this.dateTimeFormat = "".concat(this.dateFormat, " ").concat(this.timeFormat);
    }

    this.initDatePicker();
  }

  _createClass(FormieDatePicker, [{
    key: "initDatePicker",
    value: function initDatePicker() {
      ...
      var defaultOptions = {
        ...
        onReady: function onReady(dateObj, dateStr, instance) {
          ...
          if (_this.form.formTheme) {
            _this.form.formTheme.updateFormHash();
          }
        },
      ...
      var options = _objectSpread(_objectSpread({}, defaultOptions), this.getDatePickerOptions()); // Emit an "beforeInit" event. This can directly modify the `options` param
      ...
      this.datepicker = (0,flatpickr__WEBPACK_IMPORTED_MODULE_1__["default"])(this.$field, options); // Emit an "afterInit" event
    ...
    value: function loadLocale() {
      ...
      if (!this.locales.includes(this.locale)) {
        ...
        $script.src = "https://npmcdn.com/flatpickr@4.6.9/dist/l10n/".concat(this.locale, ".js");
        $script.defer = false;
        $script.async = false;

        $script.onload = function () {
          _this2.datepicker.set('locale', _this2.locale); // Update the form hash, so we don't get change warnings


          if (_this2.form.formTheme) {
            _this2.form.formTheme.updateFormHash();
          }
        };
    ...
    value: function getDatePickerOptions() {
      var opts = {}; // Format options stored in Formie, ready for JS

      this.datePickerOptions.forEach(function (object) {
    ...
    value: function getDisabledWeekdays(date) {
