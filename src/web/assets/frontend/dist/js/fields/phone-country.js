...
var FormiePhoneCountry = /*#__PURE__*/function () {
  ...
  _createClass(FormiePhoneCountry, [{
    ...
    value: function initValidator() {
      ...
      this.validator = intl_tel_input__WEBPACK_IMPORTED_MODULE_1___default()(this.$field, options);
      ...
      this.form.addEventListener(this.$field, (0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.eventKey)('countrychange'), this.countryChange.bind(this));
    ...
    value: function registerValidation(e) {
      e.validator.addValidator('phoneCountry', function (_ref) {
        ...
        if (input.value.trim() && input.validator) {
          if (input.validator.isValidNumber(false)) {
            var countryData = input.validator.getSelectedCountryData();
            var selectedCountryCode = countryData.iso2;
        ...
        var errorCode = input.validator ? input.validator.getValidationError() : '';
        var errorMessage = errorMap[errorCode] || 'Invalid number';
        return (0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.t)(errorMessage);
      });
    }
  }]);
