...
export class FormieRecaptchaEnterprise extends FormieCaptchaProvider {
    ...
    onHide() {
        ...
        this.form.removeEventListener(eventKey('onFormieCaptchaValidate', 'RecaptchaEnterprise'));
        this.form.removeEventListener(eventKey('onAfterFormieSubmit', 'RecaptchaEnterprise'));
    }
