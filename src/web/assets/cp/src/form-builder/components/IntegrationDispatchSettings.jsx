        ...
        <div className="space-y-6">
            <div>
                ...
                <p className="mt-1 text-sm leading-relaxed text-gray-500">
                    {Craft.t('formie', 'Control the order integrations run in, whether they execute immediately or via the queue, and when email notifications are sent.')}
                </p>
            </div>

            {enabledPayloadIntegrations.length < 2 && (
