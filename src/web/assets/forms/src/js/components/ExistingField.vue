<template>
    <div class="fui-col-6">
        <div class="fui-existing-field" :class="{ 'sel': selected, 'disabled': isDisabled }" @click="click">
            <div class="fui-existing-field-wrap">
                <div class="fui-existing-field-title">
                    {{ label }}
                </div>

                <div class="fui-existing-field-type">
                    {{ fieldtype.label }}
                </div>
            </div>

            <div class="fui-existing-field-right">
                ...
                <div class="fui-existing-field-icon" v-html="icon"></div>
            </div>
        </div>
    </div>
</template>
