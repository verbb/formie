...
//
// CHANGE - this for some bizarre reason causes issues with Formulate and when its used in our
// table field input, wrapping a `FormulateRepeatableProvider`. It works, but adding a new button
// causes a provide/inject error to pop up. This single bit of code is causing that. Maybe
// because this component isn't available globally?
// See https://github.com/SortableJS/Vue.Draggable/pull/852
//
