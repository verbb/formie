...
| --- | --- | --- |
| **Form content** | Labels, placeholders, messages, option labels, notification copy | Form builder (database). Per-site wording via [site overrides](/forms/multi-site-and-translation#content-translation) on multi-site projects. |
...
Use the form builder **site switcher** and [content translation overrides](/forms/multi-site-and-translation#content-translation). This is the supported way to give each Craft site different labels or messages while sharing one form structure.
...
You need French [site overrides](/forms/multi-site-and-translation#example-translating-a-contact-form) in the form builder, not entries in `formie.php`.
