...
Consult the [JS Class](https://github.com/verbb/formie/blob/craft-5/src/web/assets/frontend/src/js/formie-form-base.js) for more on what you have access to.
...
Consult the [JS Class](https://github.com/verbb/formie/blob/craft-5/src/web/assets/frontend/src/js/formie-form-theme.js) for more on what you have access to.
