...
**BYO:** GoCardless redirect flow (billing request / redirect).

No upfront payment input keys. Completion is handled via redirect and webhook; resubmit with the same session when returning to your app.
