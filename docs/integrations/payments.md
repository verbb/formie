...
1. Copy the **Store ID** from Eway and paste in the **Store ID** field in Formie.
1. Copy the **API Token** from Eway and paste in the **API Token** field in Formie.
1. Navigate to **Admin** → **Hosted Tokenization**.
1. Enter the domain for your site.
1. Click the **Create Profile** button.
1. Copy the **Profile ID** from Eway and paste in the **Profile ID** field in Formie.
