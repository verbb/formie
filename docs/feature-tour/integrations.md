...
## Automations
Automations are used to forward on a payload of data to a specified URL. This can be useful to send to submission data to third-parties when a form is submitted. The third-party can then perform any number of actions. Includes Zapier, Make, IFTTT, n8n, and a generic Web Request.

For further detail read the [Automations](docs:integrations/automations) docs.

## Captchas
Captchas are an important part of spam-protection for forms. Includes ReCAPTCHA, Turnstile and more.

For further detail read the [Captcha](docs:integrations/captchas) docs.
...
## Help Desk
Help Desk integrations let you automatically create support tickets from form submissions in platforms like Zendesk and Gorgias. This is ideal for contact, support, or issue-reporting forms that should route directly to your customer service team.

For further detail read the [Help Desk](docs:integrations/help-desk) docs.
...
For further detail read the [Messaging](docs:integrations/messaging) docs.
